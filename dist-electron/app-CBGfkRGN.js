...
var jm = (e, t, r) => t in e ? qm(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r;
var Re = (e, t, r) => jm(e, typeof t != "symbol" ? t + "" : t, r), yc = (e, t, r) => t.has(e) || gc("Cannot " + r);
...
import dn, { BrowserWindow as Wm, ipcMain as wt, shell as Hm, Tray as zm, app as It, nativeImage as bc, Menu as Cd, dialog as wc, screen as Di } from "electron";
import nu, { promises as iu } from "node:fs";
...
function tg() {
  return _c || (_c = 1, function(e, t) {
    (function(r, n) {
      ...
      const pi = Object.getPrototypeOf(Object.getPrototypeOf(async function* () {
      }).prototype);
      class mi {
        constructor(l, d) {
      ...
      const ft = {
        next() {
          return gi(this) ? this._asyncIteratorImpl.next() : m(Po("next"));
        },
        return(o) {
          return gi(this) ? this._asyncIteratorImpl.return(o) : m(Po("return"));
        }
      };
      Object.setPrototypeOf(ft, pi);
      function Ao(o, l) {
        const d = ye(o), w = new mi(d, l), v = Object.create(ft);
      ...
      function gi(o) {
        if (!i(o) || !Object.prototype.hasOwnProperty.call(o, "_asyncIteratorImpl"))
          return !1;
        try {
          return o._asyncIteratorImpl instanceof mi;
        } catch {
          return !1;
        }
      }
      ...
      const yi = Number.isNaN || function(o) {
        return o !== o;
      };
      var mr, yn, bn;
      function Hr(o) {
      ...
      function Do(o) {
        Si(o), o._pendingPullIntos = new Q();
      }
      function Ei(o, l) {
        let d = !1;
        o._state === "closed" && (d = !0);
      ...
      function xo(o) {
        o._queueTotalSize === 0 && o._closeRequested ? (En(o), Oi(o._controlledReadableByteStream)) : Zt(o);
      }
      function Si(o) {
      ...
      function yr(o) {
        for (; o._pendingPullIntos.length > 0; ) {
          ...
          ko(o, l) && (br(o), Ei(o._controlledReadableByteStream, l));
        }
      }
      function Fs(o) {
      ...
      function Ls(o, l, d) {
        ...
        d.bytesFilled -= w, Ei(o._controlledReadableByteStream, d), yr(o);
      }
      function Uo(o, l) {
        const d = o._pendingPullIntos.peek();
        Si(o), o._controlledReadableByteStream._state === "closed" ? Ut(o, d) : Ls(o, l, d), Zt(o);
      }
      function br(o) {
      ...
      function xs(o) {
        ...
        return l._state !== "readable" || o._closeRequested || !o._started ? !1 : !!(pr(l) && Xt(l) > 0 || Ri(l) && Ho(l) > 0 || vi(o) > 0);
      }
      function En(o) {
      ...
      function er(o, l) {
        ...
        if (o._pendingPullIntos.length > 0) {
          ...
          Si(o), j.buffer = gt(j.buffer), j.readerType === "none" && Fo(o, j);
        }
        if (pr(d))
          if (Fs(o), Xt(d) === 0)
            _n(o, O, v, P);
        ...
        else Ri(d) ? (_n(o, O, v, P), yr(o)) : _n(o, O, v, P);
        Zt(o);
      }
      function nt(o, l) {
        const d = o._controlledReadableByteStream;
      ...
      function Pe(o) {
        ...
        return w !== void 0 && o._backpressure && l === "writable" && Ys(w), Xp(o._writableStreamController), d;
      }
      function _e(o) {
        return f((d, w) => {
          const v = {
      ...
      function js(o, l) {
        const d = o._writer;
        d !== void 0 && l !== o._backpressure && (l ? rm(d) : Ys(d)), o._backpressure = l;
      }
      class nr {
        constructor(l) {
         ...
         */
        abort(l = void 0) {
          return Kr(this) ? this._ownerWritableStream === void 0 ? m(Pi("abort")) : Hp(this, l) : m(Jr("abort"));
        }
        /**
        ...
        close() {
          ...
          return l === void 0 ? m(Pi("close")) : Fe(l) ? m(new TypeError("Cannot close an already-closing stream")) : Bu(this);
        }
        /**
        ...
        write(l = void 0) {
          return Kr(this) ? this._ownerWritableStream === void 0 ? m(Pi("write to")) : ju(this, l) : m(Jr("write"));
        }
      }
      ...
      function Gp(o, l) {
        o._closedPromiseState === "pending" ? Gs(o, l) : tm(o, l);
      }
      function Mu(o, l) {
        o._readyPromiseState === "pending" ? Qu(o, l) : nm(o, l);
      }
      function Vp(o) {
        const l = o._ownerWritableStream, d = l._state;
      ...
      function qu(o) {
        ...
        Mu(o, d), Gp(o, d), l._writer = void 0, o._ownerWritableStream = void 0;
      }
      function ju(o, l) {
        const d = o._ownerWritableStream, w = d._writableStreamController, v = Qp(w, l);
        if (d !== o._ownerWritableStream)
          return m(Pi("write to"));
        const P = d._state;
        if (P === "errored")
      ...
      function Ku(o, l, d, w, v, P) {
        ...
        return f((ne, oe) => {
          ...
          if (P !== void 0) {
            if (me = () => {
              const G = P.reason !== void 0 ? P.reason : new lm("Aborted", "AbortError"), le = [];
          ...
          if (or(o, O._closedPromise, (G) => (w ? bt(!0, G) : at(() => Ee(l, G), !0, G), null)), or(l, j._closedPromise, (G) => (v ? bt(!0, G) : at(() => Rt(o, G), !0, G), null)), Ye(o, O._closedPromise, () => (d ? bt() : at(() => zp(j)), null)), Fe(l) || l._state === "closed") {
      ...
      class ir {
        ...
        [Z](l) {
          ...
          if (this._queue.length > 0) {
            const w = wi(this);
            this._closeRequested && this._queue.length === 0 ? (oa(this), Oi(d)) : Ii(this), l._chunkSteps(w);
          } else
            rt(d, l), Ii(this);
        }
        /** @internal */
      ...
      function Ii(o) {
        ...
        o._pulling = !0;
        const d = o._pullAlgorithm();
        E(d, () => (o._pulling = !1, o._pullAgain && (o._pullAgain = !1, Ii(o)), null), (w) => (Ct(o, w), null));
      }
      function Ju(o) {
      ...
      function Zr(o) {
        if (!Dn(o))
          return;
        const l = o._controlledReadableStream;
        o._closeRequested = !0, o._queue.length === 0 && (oa(o), Oi(l));
      }
      function On(o, l) {
        if (!Dn(o))
          return;
      ...
      function Zu(o, l, d, w, v, P, O) {
        ...
        const j = d();
        E(h(j), () => (l._started = !0, Ii(l), null), (J) => (Ct(l, J), null));
      }
      function cm(o, l, d, w) {
      ...
      function fm(o, l) {
        return Jt(o._readableStreamController) ? hm(o) : dm(o);
      }
      function dm(o, l) {
        const d = ye(o);
        ...
        return z = $i(or, Tt, Fn), ne = $i(or, Tt, Rr), A(d._closedPromise, (Ye) => (Ct(z._readableStreamController, Ye), Ct(ne._readableStreamController, Ye), (!P || !O) && oe(void 0), null)), [z, ne];
      }
      function hm(o) {
      ...
      function mm(o) {
        return pm(o) ? ym(o.getReader()) : gm(o);
      }
      function gm(o) {
        let l;
      ...
      function bm(o, l) {
        ...
        return {
          ...
          cancel: v === void 0 ? void 0 : wm(v, d, `${l} has member 'cancel' that`),
          pull: P === void 0 ? void 0 : _m(P, d, `${l} has member 'pull' that`),
          start: O === void 0 ? void 0 : Em(O, d, `${l} has member 'start' that`),
          type: j === void 0 ? void 0 : Sm(j, `${l} has member 'type' that`)
        };
      }
      function wm(o, l, d) {
        return y(o, d), (w) => te(o, l, [w]);
      ...
      function ec(o, l) {
        ...
        return P !== void 0 && Cm(P, `${l} has member 'signal' that`), {
          preventAbort: !!d,
          preventCancel: !!w,
          preventClose: !!v,
          signal: P
      ...
      class We {
        constructor(l = {}, d = {}) {
          l === void 0 ? l = null : F(l, "First parameter");
          const w = Er(d, "Second parameter"), v = bm(l, "First parameter");
        ...
        pipeThrough(l, d = {}) {
          ...
          T(l, 1, "pipeThrough");
          const w = Rm(l, "First parameter"), v = ec(d, "Second parameter");
          if (vr(this))
      ...
      function rc(o, l) {
        ...
        const d = o._reader;
        d !== void 0 && (V(d, l), Nt(d) ? To(d, l) : Ti(d, l));
      }
      function en(o) {
      ...
      function Tm(o, l) {
        ...
        return {
          cancel: d === void 0 ? void 0 : $m(d, o, `${l} has member 'cancel' that`),
          flush: w === void 0 ? void 0 : Am(w, o, `${l} has member 'flush' that`),
          readableType: v,
          start: P === void 0 ? void 0 : Pm(P, o, `${l} has member 'start' that`),
          transform: O === void 0 ? void 0 : Im(O, o, `${l} has member 'transform' that`),
          writableType: j
        };
      }
      function Am(o, l, d) {
      ...
      class ua {
        constructor(l = {}, d = {}, w = {}) {
          l === void 0 && (l = null);
          const v = Er(d, "Second parameter"), P = Er(w, "Third parameter"), O = Tm(l, "First parameter");
          ...
          Om(this, me, z, ne, j, J), Nm(this, O), O.start !== void 0 ? oe(O.start(this._transformStreamController)) : oe(void 0);
        }
        /**
      ...
      function Om(o, l, d, w, v, P) {
        ...
        o._readable = $i(O, ne, oe, v, P), o._backpressure = void 0, o._backpressureChangePromise = void 0, o._backpressureChangePromise_resolve = void 0, ca(o, !0), o._transformStreamController = void 0;
      }
      function cc(o) {
      ...
      function Js(o, l) {
        da(o._transformStreamController), Ai(o._writable._writableStreamController, l), Zs(o);
      }
      function Zs(o) {
      ...
      function Nm(o, l) {
        ...
        }, l.flush !== void 0 ? v = () => l.flush(d) : v = () => h(void 0), l.cancel !== void 0 ? P = (O) => l.cancel(O) : P = () => h(void 0), Dm(o, d, w, v, P);
      }
      function da(o) {
      ...
      function Mm(o, l) {
        ...
        const v = d._cancelAlgorithm(l);
        return da(d), E(v, () => (w._state === "errored" ? Nn(d, w._storedError) : (Ai(w._writableStreamController, l), Zs(o), el(d)), null), (P) => (Ai(w._writableStreamController, P), Zs(o), Nn(d, P), null)), d._finishPromise;
      }
      function ha(o) {
...
const Id = (fn = class {
  ...
  constructor(t = [], r = {}) {
    ...
    for (const a of t) {
      let s;
      ArrayBuffer.isView(a) ? s = new Uint8Array(a.buffer.slice(a.byteOffset, a.byteOffset + a.byteLength)) : a instanceof ArrayBuffer ? s = new Uint8Array(a.slice(0)) : a instanceof fn ? s = a : s = n.encode(`${a}`), Wt(this, ii, ke(this, ii) + (ArrayBuffer.isView(s) ? s.byteLength : s.size)), ke(this, cr).push(s);
    }
...
}, cr = new WeakMap(), co = new WeakMap(), ii = new WeakMap(), rs = new WeakMap(), fn);
...
const Ll = (vd = class {
  ...
  append(...t) {
    tn("append", arguments, 2), ke(this, _t).push(vc(...t));
  }
  delete(t) {
...
class Vi {
  constructor(t, {
    ...
    let n = null;
    t === null ? t = null : $d(t) ? t = He.from(t.toString()) : ja(t) || He.isBuffer(t) || (Ba.isAnyArrayBuffer(t) ? t = He.from(t) : ArrayBuffer.isView(t) ? t = He.from(t.buffer, t.byteOffset, t.byteLength) : t instanceof Gt || (t instanceof Ll ? (t = lg(t), n = t.type.split("=")[1]) : t = He.from(String(t))));
    let i = t;
  ...
  async formData() {
    ...
    const { toFormData: r } = await import("./multipart-parser-43iRJ06K.js");
...
), Od = (e, t) => e === null ? null : typeof e == "string" ? "text/plain;charset=UTF-8" : $d(e) ? "application/x-www-form-urlencoded;charset=UTF-8" : ja(e) ? e.type || null : He.isBuffer(e) || Ba.isAnyArrayBuffer(e) || ArrayBuffer.isView(e) ? null : e instanceof Ll ? `multipart/form-data; boundary=${t[st].boundary}` : e && typeof e.getBoundary == "function" ? `multipart/form-data;boundary=${hg(e)}` : e instanceof Gt ? null : "text/plain;charset=UTF-8", pg = (e) => {
  const { body: t } = e[st];
...
}, xl = typeof Gi.validateHeaderValue == "function" ? Gi.validateHeaderValue : (e, t) => {
  if (/[^\t\u0020-\u007E\u0080-\u00FF]/.test(t)) {
...
class fr extends URLSearchParams {
  ...
  constructor(t) {
    ...
    return r = r.length > 0 ? r.map(([n, i]) => (Da(n), xl(n, String(i)), [String(n).toLowerCase(), String(i)])) : void 0, super(r), new Proxy(this, {
      get(n, i, a) {
        switch (i) {
          case "append":
          case "set":
            return (s, u) => (Da(s), xl(s, String(u)), URLSearchParams.prototype[i].call(
              n,
...
const Le = Symbol("Request internals"), Ni = (e) => typeof e == "object" && typeof e[Le] == "object", Cg = ns(
  () => {
  },
...
class Yi extends Vi {
  constructor(t, r = {}) {
    let n;
    if (Ni(t) ? n = new URL(t.url) : (n = new URL(t), t = {}), n.username !== "" || n.password !== "")
      throw new TypeError(`${n} is an url with embedded credentials.`);
    let i = r.method || t.method || "GET";
    if (/^(delete|get|head|options|post|put)$/i.test(i) && (i = i.toUpperCase()), !Ni(r) && "data" in r && Cg(), (r.body != null || Ni(t) && t.body !== null) && (i === "GET" || i === "HEAD"))
      throw new TypeError("Request with GET/HEAD method cannot have body");
    const a = r.body ? r.body : Ni(t) && t.body !== null ? su(t) : null;
    super(a, {
...
const { stat: zT } = iu, Ag = /* @__PURE__ */ new Set(["data:", "http:", "https:"]);
...
function xg() {
  wt.handle("open-external", (e, t) => Hm.openExternal(t));
}
function Ug(e) {
...
if (!Se[qe]) {
  ...
  kd(Se, Jg), Se.close = function(e) {
    ...
    un(Se[qe]), Rd.equal(Se[qe].length, 0);
  });
}
Ue[qe] || kd(Ue, Se[qe]);
var Ze = lu(Qg(Se));
...
const xd = pn, { checkPath: Ud } = Ld, Bd = (e) => {
  const t = { mode: 511 };
...
function ly(e, t, r) {
  let n;
  const i = r.dereference ? (s) => oi.statSync(s, { bigint: !0 }) : (s) => oi.lstatSync(s, { bigint: !0 }), a = i(e);
  try {
    n = i(t);
  } catch (s) {
...
function jd(e, t, r, n, i) {
  ...
  oi.stat(s, { bigint: !0 }, (u, c) => u ? u.code === "ENOENT" ? i() : i(u) : go(t, c) ? i(new Error(ss(e, r, n))) : jd(e, t, s, n, i));
}
function Wd(e, t, r, n) {
...
const lt = Ze, Xi = ve, fy = Yt.mkdirs, dy = mn.pathExists, hy = qd.utimesMillis, Qi = ci;
function py(e, t, r, n) {
...
var Ay = py;
const ze = Ze, Ki = ve, Py = Yt.mkdirsSync, Iy = qd.utimesMillisSync, Ji = ci;
function $y(e, t, r) {
...
const Jy = Je.fromPromise, th = pn, rh = ve, nh = Yt, ih = us, Fc = Jy(async function(t) {
  let r;
  try {
...
const e0 = Je.fromCallback, oh = ve, Or = Ze, ah = Yt;
function t0(e, t) {
  function r() {
    Or.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const i0 = Je.fromCallback, sh = ve, $r = Ze, lh = Yt, o0 = mn.pathExists, { areIdentical: uh } = ci;
function a0(e, t, r) {
  function n(i, a) {
    $r.link(i, a, (s) => {
      if (s) return r(s);
...
function s0(e, t) {
  ...
  return $r.existsSync(n) || lh.mkdirsSync(n), $r.linkSync(e, t);
}
var l0 = {
  createLink: i0(a0),
  createLinkSync: s0
...
const g0 = Je.fromCallback, fh = ve, Pt = pn, dh = Yt, y0 = dh.mkdirs, b0 = dh.mkdirsSync, hh = d0, w0 = hh.symlinkPaths, _0 = hh.symlinkPathsSync, ph = m0, E0 = ph.symlinkType, S0 = ph.symlinkTypeSync, v0 = mn.pathExists, { areIdentical: mh } = ci;
function C0(e, t, r, n) {
...
const B0 = Je.fromCallback, Wi = Ze, bh = ve, wh = Yt, M0 = mn.pathExists;
function q0(e, t, r, n) {
...
var J0 = Ke;
const Z0 = Ze, Bl = ve, eb = hu.copy, _h = us.remove, tb = Yt.mkdirp, rb = mn.pathExists, Wc = ci;
function nb(e, t, r, n) {
  ...
  Wc.checkPaths(e, t, "move", r, (a, s) => {
    ...
    Wc.checkParentPaths(e, u, t, "move", (g) => {
      ...
      tb(Bl.dirname(t), (f) => f ? n(f) : Hc(e, t, i, c, n));
    });
  });
}
function ib(e) {
...
var ab = nb;
const Eh = Ze, Ml = ve, sb = hu.copySync, Sh = us.removeSync, lb = Yt.mkdirpSync, zc = ci;
function ub(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = zc.checkPathsSync(e, t, "move", r);
  return zc.checkParentPathsSync(e, i, t, "move"), cb(t) || lb(Ml.dirname(t)), fb(e, t, n, a);
}
function cb(e) {
...
var Qe = {}, jl = { exports: {} }, wa = { exports: {} }, ul, Gc;
function wb() {
  if (Gc) return ul;
  Gc = 1;
...
typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? jl.exports = _b() : jl.exports = vb();
var Cb = jl.exports, yo = {};
...
const Ab = mo, Pb = Cb, Ib = Br, $b = po, Ch = ui, Ob = kr, Jc = fi, Db = yo, Fi = (0, Pb.default)("electron-builder");
...
class Ga {
  ...
  doApiRequest(t, r, n, i = 0) {
    return Fi.enabled && Fi(`Request: ${Ya(t)}`), r.createPromise((a, s, u) => {
  ...
  handleResponse(t, r, n, i, a, s, u) {
    var c;
    if (Fi.enabled && Fi(`Response: ${t.statusCode} ${t.statusMessage}, request options: ${Ya(r)}`), t.statusCode === 404) {
...
`));
    ...
    const g = (c = t.statusCode) !== null && c !== void 0 ? c : 0, f = g >= 300 && g < 400, h = ni(t, "location");
    if (f && h != null) {
    ...
    t.on("error", a), t.on("data", (b) => m += b), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const b = ni(t, "content-type"), E = b != null && (Array.isArray(b) ? b.find((C) => C.includes("json")) != null : b.includes("json"));
          a(Wl(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
...
function Lb(e, t) {
  if (!kb(ni(t, "X-Checksum-Sha2"), e.options.sha2, e.callback))
    return;
  const r = [];
  if (e.options.onProgress != null) {
    const s = ni(t, "content-length");
...
si.nil = si.UUID = void 0;
const Ih = mo, $h = fi, Hb = "options.name must be either a string or a Buffer", Zc = (0, Ih.randomBytes)(16);
Zc[0] = Zc[0] | 1;
const La = {}, ue = [];
for (let e = 0; e < 256; e++) {
...
si.nil = new hn("00000000-0000-0000-0000-000000000000");
var bo = {}, Oh = {};
(function(e) {
  (function(t) {
...
var kh = zl, uw = et, Lh = new uw("tag:yaml.org,2002:str", {
  kind: "scalar",
...
}), an = $t, tp = wo, a_ = nw, s_ = vu, Lr = Object.prototype.hasOwnProperty, Xa = 1, rp = 2, np = 3, Qa = 4, gl = 1, l_ = 2, of = 3, u_ = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, c_ = /[\x85\u2028\u2029]/, f_ = /[,\[\]\{\}]/, ip = /^(?:!|!!|![a-z\-]+!)$/i, op = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function af(e) {
...
var lf = {
  ...
  TAG: function(t, r, n) {
    var i, a;
    n.length !== 2 && H(t, "TAG directive accepts exactly two arguments"), i = n[0], a = n[1], ip.test(i) || H(t, "ill-formed tag handle (first argument) of the TAG directive"), Lr.call(t.tagMap, i) && H(t, 'there is a previously declared suffix for "' + i + '" tag handle'), op.test(a) || H(t, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
...
function y_(e, t, r) {
  ...
  if (b = e.input.charCodeAt(e.position), ut(b) || Qn(b) || b === 35 || b === 38 || b === 42 || b === 33 || b === 124 || b === 62 || b === 39 || b === 34 || b === 37 || b === 64 || b === 96 || (b === 63 || b === 45) && (i = e.input.charCodeAt(e.position + 1), ut(i) || r && Qn(i)))
    return !1;
  for (e.kind = "scalar", e.result = "", a = s = e.position, u = !1; b !== 0; ) {
    if (b === 58) {
      if (i = e.input.charCodeAt(e.position + 1), ut(i) || r && Qn(i))
        break;
    } else if (b === 35) {
      if (n = e.input.charCodeAt(e.position - 1), ut(n))
        break;
    } else {
      if (e.position === e.lineStart && hs(e) || r && Qn(b))
        break;
      if (Vt(b))
...
function cf(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = a), c = e.input.charCodeAt(e.position); c !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, H(e, "tab characters must not be used in indentation")), !(c !== 45 || (s = e.input.charCodeAt(e.position + 1), !ut(s)))); ) {
    ...
    if (r = e.line, li(e, t, np, !1, !0), a.push(e.result), $e(e, !0, -1), c = e.input.charCodeAt(e.position), (e.line === r || e.lineIndent > t) && c !== 0)
...
function S_(e, t, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = h), $ = e.input.charCodeAt(e.position); $ !== 0; ) {
    if (!A && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, H(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, ($ === 63 || $ === 58) && ut(n))
      $ === 63 ? (A && (Kn(e, h, m, b, E, null, s, u, c), b = E = C = null), I = !0, A = !0, i = !0) : A ? (A = !1, i = !0) : H(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, $ = n;
    else {
      if (s = e.line, u = e.lineStart, c = e.position, !li(e, r, rp, !1, !0))
        break;
      if (e.line === a) {
        for ($ = e.input.charCodeAt(e.position); cn($); )
          $ = e.input.charCodeAt(++e.position);
        if ($ === 58)
          $ = e.input.charCodeAt(++e.position), ut($) || H(e, "a whitespace character is expected after the key-value separator within a block mapping"), A && (Kn(e, h, m, b, E, null, s, u, c), b = E = C = null), I = !0, A = !1, i = !1, b = e.tag, E = e.result;
        else if (I)
    ...
    if ((e.line === a || e.lineIndent > t) && (A && (s = e.line, u = e.lineStart, c = e.position), li(e, t, Qa, !0, i) && (A ? E = e.result : C = e.result), A || (Kn(e, h, m, b, E, C, s, u, c), b = E = C = null), $e(e, !0, -1), $ = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && $ !== 0)
      H(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return A && Kn(e, h, m, b, E, null, s, u, c), I && (e.tag = g, e.anchor = f, e.kind = "mapping", e.result = h), I;
}
function v_(e) {
  var t, r = !1, n = !1, i, a, s;
...
function C_(e) {
  ...
  for (e.anchor !== null && H(e, "duplication of an anchor property"), r = e.input.charCodeAt(++e.position), t = e.position; r !== 0 && !ut(r) && !Qn(r); )
...
function R_(e) {
  ...
  for (n = e.input.charCodeAt(++e.position), t = e.position; n !== 0 && !ut(n) && !Qn(n); )
...
function T_(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (s = e.input.charCodeAt(e.position)) !== 0 && ($e(e, !0, -1), s = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || s !== 37)); ) {
    ...
    s !== 0 && Cu(e), Lr.call(lf, n) ? lf[n](e, n, i) : Ka(e, 'unknown document directive "' + n + '"');
  }
  if ($e(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, $e(e, !0, -1)) : a && H(e, "directives end mark is expected"), li(e, e.lineIndent - 1, Qa, !1, !0), $e(e, !0, -1), e.checkLineBreaks && c_.test(e.input.slice(t, e.position)) && Ka(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && hs(e)) {
...
Eu.loadAll = A_;
Eu.load = P_;
var cp = {}, ps = $t, _o = wo, I_ = vu, fp = Object.prototype.toString, dp = Object.prototype.hasOwnProperty, Tu = 65279, $_ = 9, to = 10, O_ = 13, D_ = 32, N_ = 33, F_ = 34, Gl = 35, k_ = 37, L_ = 38, x_ = 39, U_ = 42, hp = 44, B_ = 45, Ja = 58, M_ = 61, q_ = 62, j_ = 63, W_ = 64, pp = 91, mp = 93, H_ = 96, gp = 123, z_ = 124, yp = 125, Ge = {};
Ge[0] = "\\0";
Ge[7] = "\\a";
Ge[8] = "\\b";
Ge[9] = "\\t";
...
function hf(e, t, r) {
  ...
  return (
    ...
    (r ? (
      // c = flow-in
      n
    ) : n && e !== hp && e !== pp && e !== mp && e !== gp && e !== yp) && e !== Gl && !(t === Ja && !i) || df(t) && !Za(t) && e === Gl || t === Ja && i
  );
}
function Z_(e) {
  return no(e) && e !== Tu && !Za(e) && e !== B_ && e !== j_ && e !== Ja && e !== hp && e !== pp && e !== mp && e !== gp && e !== yp && e !== Gl && e !== L_ && e !== U_ && e !== N_ && e !== z_ && e !== M_ && e !== q_ && e !== x_ && e !== F_ && e !== k_ && e !== W_ && e !== H_;
}
function eE(e) {
  return !Za(e) && e !== Ja;
}
...
function tE(e, t, r, n, i, a, s, u) {
  ...
  return !h && !m ? C && !s && !i(e) ? wp : a === ro ? Xn : Yl : r > 9 && bp(e) ? Xn : s ? a === ro ? Xn : Yl : m ? Ep : _p;
}
...
function yf(e, t, r, n) {
  ...
  for (s = 0, u = r.length; s < u; s += 1)
    c = r[s], e.replacer && (c = e.replacer.call(r, String(s), c)), (dr(e, t + 1, c, !0, !0, !1, !0) || typeof c > "u" && dr(e, t + 1, null, !0, !0, !1, !0)) && ((!n || i !== "") && (i += Vl(e, t)), e.dump && to === e.dump.charCodeAt(0) ? i += "-" : i += "- ", i += e.dump);
  e.tag = a, e.dump = i || "[]";
}
function aE(e, t, r) {
...
function sE(e, t, r, n) {
  ...
  for (u = 0, c = s.length; u < c; u += 1)
    m = "", (!n || i !== "") && (m += Vl(e, t)), g = s[u], f = r[g], e.replacer && (f = e.replacer.call(r, g, f)), dr(e, t + 1, g, !0, !0, !0) && (h = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, h && (e.dump && to === e.dump.charCodeAt(0) ? m += "?" : m += "? "), m += e.dump, h && (m += Vl(e, t)), dr(e, t + 1, f, !0, h) && (e.dump && to === e.dump.charCodeAt(0) ? m += ":" : m += ": ", m += e.dump, i += m));
  e.tag = a, e.dump = i || "{}";
}
function bf(e, t, r) {
  var n, i, a, s, u, c;
...
const Sa = ys, { MAX_LENGTH: _f, MAX_SAFE_INTEGER: va } = gs, { safeRe: Ca, t: Ra } = Eo, SE = Pu, { compareIdentifiers: Wn } = Rp;
let vE = class Ht {
  constructor(t, r) {
...
var Pp = RS;
const TS = tt, AS = di, { safeRe: Ta, t: Aa } = Eo, PS = (e, t) => {
  if (e instanceof TS)
    return e;
...
function ws() {
  ...
  bl = t;
  const r = Pu, { safeRe: n, t: i } = Eo, a = Pp, s = ys, u = tt, c = Dt();
  return bl;
}
...
var HS = WS;
const wl = tt, zS = Dt(), Pf = bs, GS = (e, t) => {
  e = new zS(e, t);
  let r = new wl("0.0.0");
...
var QS = XS;
const KS = tt, Ip = ws(), { ANY: JS } = Ip, ZS = Dt(), ev = _s, If = bs, $f = $u, tv = Du, rv = Ou, nv = (e, t, r, n) => {
...
var uv = lv;
const Of = Dt(), cv = (e, t, r) => (e = new Of(e, r), t = new Of(t, r), e.intersects(t, r));
var fv = cv;
const dv = _s, hv = Ot;
var pv = (e, t, r) => {
  const n = [];
...
const Df = Dt(), Fu = ws(), { ANY: _l } = Fu, Li = _s, ku = Ot, mv = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  for (const b of n) {
    if (i && !Li(b, String(i), r) || a && !Li(b, String(a), r))
      return null;
    for (const E of t)
      if (!Li(b, String(E), r))
        return !1;
    ...
    if (f = f || b.operator === ">" || b.operator === ">=", g = g || b.operator === "<" || b.operator === "<=", i) {
      if (m && b.semver.prerelease && b.semver.prerelease.length && b.semver.major === m.major && b.semver.minor === m.minor && b.semver.patch === m.patch && (m = !1), b.operator === ">" || b.operator === ">=") {
        if (u = Ff(i, b, r), u === b && u !== i)
          return !1;
      } else if (i.operator === ">=" && !Li(i.semver, String(b), r))
        return !1;
    }
    if (a) {
      if (h && b.semver.prerelease && b.semver.prerelease.length && b.semver.major === h.major && b.semver.minor === h.minor && b.semver.patch === h.patch && (h = !1), b.operator === "<" || b.operator === "<=") {
        if (c = kf(a, b, r), c === b && c !== a)
          return !1;
      } else if (a.operator === "<=" && !Li(a.semver, String(b), r))
        return !1;
    }
...
var bv = mv;
const El = Eo, Lf = gs, wv = tt, xf = Rp, _v = di, Ev = AE, Sv = $E, vv = DE, Cv = FE, Rv = xE, Tv = ME, Av = WE, Pv = GE, Iv = Ot, $v = QE, Ov = ZE, Dv = Iu, Nv = nS, Fv = aS, kv = bs, Lv = $u, xv = Tp, Uv = Ap, Bv = Ou, Mv = Du, qv = Pp, jv = IS, Wv = ws(), Hv = Dt(), zv = _s, Gv = LS, Vv = MS, Yv = HS, Xv = VS, Qv = QS, Kv = Nu, Jv = av, Zv = uv, eC = fv, tC = pv, rC = bv;
var $p = {
  parse: _v,
  valid: Ev,
  clean: Sv,
...
(function(e, t) {
  ...
  var Is = Array.prototype, To = Function.prototype, Qt = Object.prototype, pi = p["__core-js_shared__"], mi = To.toString, ft = Qt.hasOwnProperty, Ao = function() {
    var _ = /[^.]+$/.exec(pi && pi.keys && pi.keys.IE_PROTO || "");
    return _ ? "Symbol(src)_1." + _ : "";
  }(), gi = Qt.toString, Po = RegExp(
    "^" + mi.call(ft).replace(ee, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), yi = se ? p.Buffer : void 0, mr = p.Symbol, yn = p.Uint8Array, bn = Qt.propertyIsEnumerable, Hr = Is.splice, Ft = mr ? mr.toStringTag : void 0, gt = Object.getOwnPropertySymbols, kt = yi ? yi.isBuffer : void 0, Io = Nt(Object.keys, Object), gr = _r(p, "DataView"), zr = _r(p, "Map"), Gr = _r(p, "Promise"), wn = _r(p, "Set"), bi = _r(p, "WeakMap"), Vr = _r(Object, "create"), $s = rr(gr), Os = rr(zr), $o = rr(Gr), wi = rr(wn), _i = rr(bi), Oo = mr ? mr.prototype : void 0, yt = Oo ? Oo.valueOf : void 0;
  function Lt(_) {
  ...
  dt.prototype.clear = Zt, dt.prototype.delete = Do, dt.prototype.get = Ei, dt.prototype.has = No, dt.prototype.set = _n;
  function xt(_) {
    var R = -1, k = _ == null ? 0 : _.length;
    for (this.clear(); ++R < k; ) {
      var W = _[R];
  ...
  xt.prototype.clear = Fo, xt.prototype.delete = ko, xt.prototype.get = Lo, xt.prototype.has = xo, xt.prototype.set = Si;
  function yr(_) {
    var R = -1, k = _ == null ? 0 : _.length;
  ...
  function vi(_, R, k, W, he) {
    return _ === R ? !0 : _ == null || R == null || !Qr(_) && !Qr(R) ? _ !== _ && R !== R : vn(_, R, k, W, vi, he);
  }
  function vn(_, R, k, W, he, K) {
    ...
    if (Ie && !Me)
      return K || (K = new Ut()), de || Xo(_) ? Mo(_, R, k, W, he, K) : Ci(_, R, Pe, k, W, he, K);
    if (!(k & i)) {
  ...
  function Rn(_, R) {
    var k = _.__data__;
    return Ri(R) ? k[typeof R == "string" ? "string" : "hash"] : k.map;
  }
  function _r(_, R) {
    var k = pr(_, R);
  ...
  (gr && Bt(new gr(new ArrayBuffer(1))) != X || zr && Bt(new zr()) != C || Gr && Bt(Gr.resolve()) != M || wn && Bt(new wn()) != ae || bi && Bt(new bi()) != re) && (Bt = function(_) {
...
const iC = mo, oC = Br, Uf = nC, nn = Mr, zi = ve;
class aC {
  constructor(t) {
  ...
  async validateDownloadedPath(t, r, n, i) {
    if (this.versionInfo != null && this.file === t && this.fileInfo != null)
      return Uf(this.versionInfo, r) && Uf(this.fileInfo.info, n.info) && await (0, nn.pathExists)(t) ? t : null;
...
function IC(e, t, r) {
  ...
  return [Kl(`${e.pathname.replace(new RegExp(TC(r), "g"), t)}.blockmap`, e), n];
}
var De = {};
...
Ur.computeReleaseNotes = Lp;
const lr = Be, Jn = $p, xC = ui, Zn = Et, Jl = De, Al = /\/tag\/([^/]+)$/;
class kp extends Jl.Provider {
  constructor(t, r, n) {
    super({
      ...n,
      /* because GitHib uses S3 */
      isUseMultipleRangeRequest: !1
    }), this.options = t, this.baseUrl = (0, Zn.newBaseUrl)((0, lr.githubUrl)(t, r));
    const i = r === "github.com" ? "api.github.com" : r;
    this.baseApiUrl = (0, Zn.newBaseUrl)((0, lr.githubUrl)(t, i));
  }
...
class UC extends kp {
  ...
  async getLatestVersion() {
    var t, r, n, i, a;
    const s = new lr.CancellationToken(), u = await this.httpRequest((0, Zn.newUrlFromBase)(`${this.basePath}.atom`, this.baseUrl), {
      accept: "application/xml, application/atom+xml, text/xml, */*"
    }, s), c = (0, lr.parseXml)(u);
    let g = c.element("entry", !1, "No published versions on GitHub"), f = null;
    try {
      if (this.updater.allowPrerelease) {
        const A = ((t = this.updater) === null || t === void 0 ? void 0 : t.channel) || ((r = Jn.prerelease(this.updater.currentVersion)) === null || r === void 0 ? void 0 : r[0]) || null;
        if (A === null)
          ...
          for (const I of c.getElements("entry")) {
            ...
            if ($ === null)
              continue;
            const M = $[1], x = ((n = Jn.prerelease(M)) === null || n === void 0 ? void 0 : n[0]) || null, te = !A || ["alpha", "beta"].includes(A), ae = x !== null && !["alpha", "beta"].includes(String(x));
...
${u}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    let h, m = "", b = "";
    const E = async (A) => {
      m = (0, Zn.getChannelFilename)(A), b = (0, Zn.newUrlFromBase)(this.getBaseDownloadPath(String(f), m), this.baseUrl);
    ...
    try {
      let A = this.channel;
      this.updater.allowPrerelease && (!((i = Jn.prerelease(f)) === null || i === void 0) && i[0]) && (A = this.getCustomChannelName(String((a = Jn.prerelease(f)) === null || a === void 0 ? void 0 : a[0]))), h = await E(A);
    } catch (A) {
      if (this.updater.allowPrerelease)
  ...
  async getLatestTagName(t) {
    const r = this.options, n = r.host == null || r.host === "github.com" ? (0, Zn.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl) : new xC.URL(`${this.computeGithubBasePath(`/repos/${r.owner}/${r.repo}/releases`)}/latest`, this.baseApiUrl);
    try {
...
const Hn = Be, MC = je, qC = ve, Yf = ui, Xf = Et, jC = Ur, WC = De;
class HC extends jC.BaseGitHubProvider {
  ...
  async getLatestVersion() {
    const t = new Hn.CancellationToken(), r = (0, Xf.getChannelFilename)(this.getDefaultChannelName()), n = await this.getLatestVersionInfo(t), i = n.assets.find((u) => u.name === r);
    if (i == null)
...
Ss.createClient = XC;
const Pa = Be, zC = vs, Qf = vo, GC = Ur, VC = Cs, YC = Rs;
function xp(e) {
...
function QC(e, t, r) {
  ...
  for (let C = 0; C < f.checksums.length; E += f.sizes[C], C++) {
    ...
    $ != null && b.get(I) !== A && (r.warn(`Checksum ("${I}") matches, but size differs (old: ${b.get(I)}, new: ${A})`), $ = void 0), $ === void 0 ? (h++, a != null && a.kind === sn.DOWNLOAD && a.end === E ? a.end += A : (a = {
      ...
      // oldBlocks: null,
    }, Kf(a, u, I, C))) : a != null && a.kind === sn.COPY && a.end === $ ? a.end += A : (a = {
      kind: sn.COPY,
      start: $,
      end: $ + A
      // oldBlocks: [checksum]
...
hi.copyData = Up;
const Ia = Be, ZC = Br, eR = po, tR = gn, Zf = Buffer.from(`\r
\r
`);
var Pr;
(function(e) {
...
As.checkIsRangesSupported = eu;
const Zl = Be, ed = hi, td = gn;
...
const xi = Be, $l = Mr, sR = Br, lR = hi, uR = ui, $a = gn, rd = As, cR = Ps;
class fR {
  ...
  createRequestOptions() {
    ...
    return (0, xi.configureRequestUrl)(this.options.newUrl, t), (0, xi.configureRequestOptions)(t), t;
  }
  doDownload(t, r) {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, u) => {
      ...
      const f = new xi.DigestTransform(this.blockAwareFileInfo.sha512);
      ...
      A.redirect = "manual", b = (I) => {
        ...
        const ae = this.httpExecutor.createRequest(A, (Q) => {
          ...
          }), Q.statusCode >= 400 && u((0, xi.createHttpError)(Q)), Q.pipe(m, {
            end: !1
          }), Q.once("end", () => {
        ...
        ae.on("redirect", (Q, Ne, S) => {
          this.logger.info(`Redirect to ${dR(S)}`), C = S, (0, xi.configureRequestUrl)(new uR.URL(C), A), ae.followRedirect();
...
const Xe = Be, mR = mo, gR = os, yR = Td, zn = Mr, bR = je, Ol = ms, rn = ve, on = $p, id = So, wR = Es, od = Op, _R = vo, Dl = Ss, ER = Pd, SR = Et, vR = Ts, Gn = qr;
...
async function $R(e) {
  ...
  try {
    ...
    return await (0, Vn.read)(t, i, 0, i.length, r - n.length - i.length), await (0, Vn.close)(t), Mp(i);
  } catch (r) {
...
const sd = Be, ld = is, OR = Mr, DR = Br, Ui = ve, NR = hr, FR = Ro, kR = De, ud = qr;
class LR extends NR.BaseUpdater {
  ...
  doInstall(t) {
    ...
    (0, DR.unlinkSync)(r);
    let n;
    const i = Ui.basename(r), a = this.installerPath;
    if (a == null)
      return this.dispatchError(new Error("No valid update available, can't quit and install")), !1;
    Ui.basename(a) === i || !/\d+\.\d+\.\d+/.test(i) ? n = r : n = Ui.join(Ui.dirname(r), Ui.basename(a)), (0, ld.execFileSync)("mv", ["-f", a, n]), n !== r && this.emit("appimage-filename-updated", n);
    const s = {
      ...process.env,
...
const hd = Be, Nl = Mr, GR = Br, pd = ve, VR = Zm, YR = Fr, XR = De, md = is, gd = mo;
...
const Oa = Be, wd = ve, tT = hr, rT = Ro, _d = qr, nT = De, iT = Mr, oT = Uu, Ed = ui;
...
let Yn = null, Ir = !1;
function sT() {
  const t = It.isPackaged ? ln.join(process.resourcesPath, "assets", "icon.ico") : ln.join(process.cwd(), "public", "icon.ico");
  return nu.existsSync(t) ? t : (console.warn("[Tray] icon not found at:", t), console.warn("[Tray] resourcesPath:", process.resourcesPath), console.warn("[Tray] cwd:", process.cwd()), "");
}
function lT(e) {
  let t = bc.createFromPath(e);
  if (!t.isEmpty()) return t;
  try {
    const r = nu.readFileSync(e);
    if (t = bc.createFromBuffer(r), !t.isEmpty()) return t;
  } catch (r) {
    console.warn("[Tray] readFileSync failed:", r);
  }
  return console.warn("[Tray] nativeImage empty for:", e), t;
}
function jp(e) {
  if (Yn) return;
  const t = sT();
  ...
  Yn = new zm(r), Yn.setToolTip("LoL Skin Picker");
  const n = () => {
    const s = e();
    ...
    Ir = !0, Fd.autoUpdater.checkForUpdates().catch((s) => {
      wc.showErrorBox("Update error", (s == null ? void 0 : s.message) ?? String(s)), Ir = !1;
    });
  }, a = () => {
  ...
  Yn.on("click", n), Yn.on("double-click", n), a(), jp.refresh = a;
}
function uT() {
...
const Wp = Qm(It.getPath("userData"), "settings.json");
async function cT() {
  try {
    return JSON.parse(await iu.readFile(Wp, "utf-8"));
  } catch {
    return {};
  }
}
async function fT(e) {
  try {
    await iu.writeFile(Wp, JSON.stringify(e, null, 2), "utf-8");
  } catch {
  }
}
if (!It.isPackaged) {
...
const tu = new kl(), ru = new Ig(), xa = new Dg();
function dT(e, t, r) {
  const n = e.workArea, i = Math.floor(n.x + (n.width - t) / 2), a = Math.floor(n.y + (n.height - r) / 2);
  return { x: i, y: a };
}
async function hT() {
  const e = await cT(), t = Di.getAllDisplays(), r = 900, n = 645, i = t.find((f) => f.id === e.displayId) ?? Di.getDisplayNearestPoint(Di.getCursorScreenPoint()) ?? Di.getPrimaryDisplay(), a = await Ng(), { x: s, y: u } = dT(i, r, n);
  a.setBounds({ x: s, y: u, width: r, height: n }), Cd.setApplicationMenu(null), jp(ti);
  let c = null;
  const g = () => {
    const f = ti();
    if (!f) return;
    const h = Di.getDisplayMatching(f.getBounds());
    fT({ displayId: h.id }).catch(() => {
    });
  };
  a.on("move", () => {
...
function pT() {
  tu.on("status", (e, t) => {
    var r, n, i;
    (r = ti()) == null || r.webContents.send("lcu-status", e), e === "connected" && t ? ((n = ti()) == null || n.show(), ru.setCreds(t), xa.setCreds(t), xa.start()) : (ru.stop(), xa.stop(), (i = ti()) == null || i.hide());
  });
}
It.whenReady().then(async () => {
  await hT(), Ug({ lcu: tu, gameflow: ru, skins: xa, getWin: ti }), pT(), uT(), tu.start();
});
