...
var ke = (e, t, r) => (bc(e, t, "read from private field"), r ? r.call(e) : t.get(e)), Tr = (e, t, r) => t.has(e) ? yc("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), Wt = (e, t, r, n) => (bc(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r);
import hn, { BrowserWindow as jm, ipcMain as wt, shell as Wm, nativeImage as Hm, Tray as zm, app as It, Menu as Cd, dialog as wc, screen as Oi } from "electron";
...
import Bn from "node:zlib";
import Gt, { PassThrough as Ua, pipeline as Mn } from "node:stream";
...
function tg() {
  return _c || (_c = 1, function(e, t) {
    (function(r, n) {
      ...
      const Gr = (wn = (mr = Symbol.asyncIterator) !== null && mr !== void 0 ? mr : (bn = Symbol.for) === null || bn === void 0 ? void 0 : bn.call(Symbol, "Symbol.asyncIterator")) !== null && wn !== void 0 ? wn : "@@asyncIterator";
      function _n(o, l = "sync", d) {
        if (d === void 0)
          if (l === "async") {
            if (d = gr(o, Gr), d === void 0) {
              const P = gr(o, Symbol.iterator), O = _n(o, "sync", P);
              return zr(O);
            }
          } else
      ...
      function xo(o) {
        o._queueTotalSize === 0 && o._closeRequested ? (Sn(o), $i(o._controlledReadableByteStream)) : Zt(o);
      }
      function Ei(o) {
      ...
      function er(o, l) {
        ...
        else Ci(d) ? (En(o, O, v, P), yr(o)) : En(o, O, v, P);
        Zt(o);
      }
      function nt(o, l) {
        const d = o._controlledReadableByteStream;
        d._state === "readable" && (Do(o), yt(o), Sn(o), nc(d, l));
      }
      function wr(o, l) {
      ...
      function qo(o, l) {
        ...
        return {
          mode: d === void 0 ? void 0 : Tn(d, `${l} has member 'mode' that`)
        };
      }
      function Tn(o, l) {
        if (o = `${o}`, o !== "byob")
      ...
      class Mt {
         ...
         */
        get closed() {
          return tr(this) ? this._closedPromise : m(An("closed"));
        }
        /**
         * If the reader is active, behaves the same as {@link ReadableStream.cancel | stream.cancel(reason)}.
         */
        cancel(l = void 0) {
          return tr(this) ? this._ownerReadableStream === void 0 ? m(B("cancel")) : L(this, l) : m(An("cancel"));
        }
        read(l, d = {}) {
          if (!tr(this))
            return m(An("read"));
      ...
      function W(o, l, d, w, v = 1, P = () => 1) {
        ...
        he(O);
        const j = Object.create(On.prototype);
      ...
      class nr {
        ...
        close() {
          ...
          return l === void 0 ? m(Ai("close")) : Fe(l) ? m(new TypeError("Cannot close an already-closing stream")) : Mu(this);
        }
        /**
        ...
        write(l = void 0) {
          return Kr(this) ? this._ownerWritableStream === void 0 ? m(Ai("write to")) : Wu(this, l) : m(Jr("write"));
        }
      }
      ...
      Object.defineProperties(On.prototype, {
        ...
        signal: { enumerable: !0 },
        error: { enumerable: !0 }
      }), typeof Symbol.toStringTag == "symbol" && Object.defineProperty(On.prototype, Symbol.toStringTag, {
        value: "WritableStreamDefaultController",
        configurable: !0
      });
      function Ws(o) {
        return !i(o) || !Object.prototype.hasOwnProperty.call(o, "_controlledWritableStream") ? !1 : o instanceof On;
      }
      ...
      function Vp(o, l, d, w) {
        const v = Object.create(On.prototype);
        let P, O, j, J;
      ...
      function Ju(o, l, d, w, v, P) {
        ...
        return f((ne, oe) => {
          ...
          function at(G, le, be) {
            ...
            function ht() {
              return E(G(), () => ar(le, be), (Ln) => ar(!0, Ln)), null;
            }
          }
          function bt(G, le) {
      ...
      function Zu(o) {
        ...
        return !Nn(o) || !o._started ? !1 : !!(vr(l) && Xt(l) > 0 || Qs(o) > 0);
      }
      function oa(o) {
      ...
      function fm(o, l) {
          ...
          return w ? (v = !0, h(void 0)) : (w = !0, Wr(d, {
            _chunkSteps: (at) => {
              M(() => {
                v = !1;
                const bt = at, ar = at;
                P || Dn(z._readableStreamController, bt), O || Dn(ne._readableStreamController, ar), w = !1, v && Tt();
              });
            },
            _closeSteps: () => {
        ...
        return z = Ii(or, Tt, kn), ne = Ii(or, Tt, Rr), A(d._closedPromise, (Ye) => (Ct(z._readableStreamController, Ye), Ct(ne._readableStreamController, Ye), (!P || !O) && oe(void 0), null)), [z, ne];
      }
      function dm(o) {
        ...
        function kn() {
          tr(l) && (D(l), l = ye(o), Tt(l)), Wr(l, {
              ...
              M(() => {
                ...
                if (!P && !O)
                  try {
                    ...
                    nt(z._readableStreamController, Ln), nt(ne._readableStreamController, Ln), oe(Rt(o, Ln));
                    return;
                  }
            ...
            _closeSteps: () => {
              d = !1, P || Yr(z._readableStreamController), O || Yr(ne._readableStreamController), z._readableStreamController._pendingPullIntos.length > 0 && Cn(z._readableStreamController, 0), ne._readableStreamController._pendingPullIntos.length > 0 && Cn(ne._readableStreamController, 0), (!P || !O) && oe(void 0);
            },
            _errorSteps: () => {
              d = !1;
            }
          ...
          zo(l, G, 1, {
            _chunkSteps: (xn) => {
              M(() => {
                ...
                const Un = le ? O : P;
                if (le ? P : O)
                  Un || Rn(be._readableStreamController, xn);
                else {
                  let gc;
                  try {
                    gc = $o(xn);
                  ...
                  Un || Rn(be._readableStreamController, xn), er(ht._readableStreamController, gc);
                }
                d = !1, w ? or() : v && Ye();
              });
            },
            _closeSteps: (xn) => {
              d = !1;
              const Un = le ? O : P, pa = le ? P : O;
              Un || Yr(be._readableStreamController), pa || Yr(ht._readableStreamController), xn !== void 0 && (Un || Rn(be._readableStreamController, xn), !pa && ht._readableStreamController._pendingPullIntos.length > 0 && Cn(ht._readableStreamController, 0)), (!Un || !pa) && oe(void 0);
            },
            _errorSteps: () => {
              d = !1;
            }
        ...
        function or() {
          if (d)
            return w = !0, h(void 0);
          d = !0;
          const G = vn(z._readableStreamController);
          return G === null ? kn() : Rr(G._view, !1), h(void 0);
        }
        function Ye() {
          if (d)
            return v = !0, h(void 0);
          d = !0;
          const G = vn(ne._readableStreamController);
          return G === null ? kn() : Rr(G._view, !0), h(void 0);
        }
        function at(G) {
          if (P = !0, j = G, O) {
        ...
        return z = rc(ar, or, at), ne = rc(ar, Ye, bt), Tt(l), [z, ne];
      }
      function hm(o) {
        ...
        function v() {
          ...
          return I(j, (J) => {
            ...
            if (Vr(J))
              ...
              const ne = $s(J);
              Dn(l._readableStreamController, ne);
            }
          });
        }
        function P(O) {
        ...
        function w() {
          ...
          return I(P, (O) => {
            ...
            if (O.done)
              ...
              const j = O.value;
              Dn(l._readableStreamController, j);
            }
          });
        }
        function v(P) {
      ...
      class We {
        ...
        pipeTo(l, d = {}) {
          ...
          return vr(this) ? m(new TypeError("ReadableStream.prototype.pipeTo cannot be used on a locked ReadableStream")) : de(l) ? m(new TypeError("ReadableStream.prototype.pipeTo cannot be used on a locked WritableStream")) : Ju(this, l, w.preventClose, w.preventAbort, w.preventCancel, w.signal);
        }
        /**
      ...
      class ua {
        constructor(l = {}, d = {}, w = {}) {
          ...
          const j = qt(P, 0), J = Pn(P), z = qt(v, 1), ne = Pn(v);
          let oe;
          const me = f((Tt) => {
            oe = Tt;
          });
      ...
      function Lm(o, l) {
        ...
        return da(d), E(v, () => (w._state === "errored" ? Fn(d, w._storedError) : (Ct(w._readableStreamController, l), el(d)), null), (P) => (Ct(w._readableStreamController, P), Fn(d, P), null)), d._finishPromise;
      }
      function xm(o) {
        ...
        return da(l), E(w, () => (d._state === "errored" ? Fn(l, d._storedError) : (Zr(d._readableStreamController), el(l)), null), (v) => (Ct(d._readableStreamController, v), Fn(l, v), null)), l._finishPromise;
      }
      function Um(o) {
      ...
      function Bm(o, l) {
        ...
        const v = d._cancelAlgorithm(l);
        return da(d), E(v, () => (w._state === "errored" ? Fn(d, w._storedError) : (Ti(w._writableStreamController, l), Zs(o), el(d)), null), (P) => (Ti(w._writableStreamController, P), Zs(o), Fn(d, P), null)), d._finishPromise;
      }
      function ha(o) {
...
const Id = (dn = class {
  ...
  constructor(t = [], r = {}) {
    ...
    for (const a of t) {
      let s;
      ArrayBuffer.isView(a) ? s = new Uint8Array(a.buffer.slice(a.byteOffset, a.byteOffset + a.byteLength)) : a instanceof ArrayBuffer ? s = new Uint8Array(a.slice(0)) : a instanceof dn ? s = a : s = n.encode(`${a}`), Wt(this, ni, ke(this, ni) + (ArrayBuffer.isView(s) ? s.byteLength : s.size)), ke(this, cr).push(s);
    }
  ...
  slice(t = 0, r = this.size, n = "") {
    ...
    const h = new dn([], { type: String(n).toLowerCase() });
...
}, cr = new WeakMap(), co = new WeakMap(), ni = new WeakMap(), rs = new WeakMap(), dn);
...
class Vi {
  constructor(t, {
    ...
    let n = null;
    t === null ? t = null : $d(t) ? t = He.from(t.toString()) : ja(t) || He.isBuffer(t) || (Ba.isAnyArrayBuffer(t) ? t = He.from(t) : ArrayBuffer.isView(t) ? t = He.from(t.buffer, t.byteOffset, t.byteLength) : t instanceof Gt || (t instanceof xl ? (t = lg(t), n = t.type.split("=")[1]) : t = He.from(String(t))));
    let i = t;
  ...
  async formData() {
    ...
    const { toFormData: r } = await import("./multipart-parser-CD6LeogZ.js");
...
function Sg(e, { referrerURLCallback: t, referrerOriginCallback: r } = {}) {
  ...
  switch (n) {
    ...
    case "unsafe-url":
      return a;
    case "strict-origin":
      return qn(a) && !qn(u) ? "no-referrer" : s.toString();
    case "strict-origin-when-cross-origin":
      return a.origin === u.origin ? a : qn(a) && !qn(u) ? "no-referrer" : s;
    case "same-origin":
      return a.origin === u.origin ? a : "no-referrer";
    case "origin-when-cross-origin":
      return a.origin === u.origin ? a : s;
    case "no-referrer-when-downgrade":
      return qn(a) && !qn(u) ? "no-referrer" : a;
    default:
...
async function ur(e, t) {
  return new Promise((r, n) => {
    ...
    m.on("error", (E) => {
      ...
      const M = {
        flush: Bn.Z_SYNC_FLUSH,
        finishFlush: Bn.Z_SYNC_FLUSH
      };
      if ($ === "gzip" || $ === "x-gzip") {
        A = Mn(A, Bn.createGunzip(M), (x) => {
          x && n(x);
        }), g = new pt(A, I), r(g);
        return;
      }
      if ($ === "deflate" || $ === "x-deflate") {
        const x = Mn(E, new Ua(), (te) => {
          te && n(te);
        });
        x.once("data", (te) => {
          (te[0] & 15) === 8 ? A = Mn(A, Bn.createInflate(), (ae) => {
            ae && n(ae);
          }) : A = Mn(A, Bn.createInflateRaw(), (ae) => {
            ae && n(ae);
          }), g = new pt(A, I), r(g);
        }), x.once("end", () => {
          g || (g = new pt(A, I), r(g));
      ...
      if ($ === "br") {
        A = Mn(A, Bn.createBrotliDecompress(), (x) => {
          x && n(x);
        }), g = new pt(A, I), r(g);
        return;
      }
...
var cn = Kg;
ga.debuglog ? cn = ga.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (cn = function() {
...
if (!Se[qe]) {
  ...
  kd(Se, Jg), Se.close = function(e) {
    ...
    cn(Se[qe]), Rd.equal(Se[qe].length, 0);
  });
}
Ue[qe] || kd(Ue, Se[qe]);
var Ze = lu(Qg(Se));
...
function lu(e) {
  ...
  function r(S, re, Z) {
    ...
    function X(ce, L, D, B) {
      return t(ce, L, function(N) {
        N && (N.code === "EMFILE" || N.code === "ENFILE") ? jn([X, [ce, L, D], N, B || Date.now(), Date.now()]) : typeof D == "function" && D.apply(this, arguments);
      });
    }
  }
  var n = e.writeFile;
  ...
  function i(S, re, Z, X) {
    ...
    function ce(L, D, B, N, q) {
      return n(L, D, B, function(U) {
        U && (U.code === "EMFILE" || U.code === "ENFILE") ? jn([ce, [L, D, B, N], U, q || Date.now(), Date.now()]) : typeof N == "function" && N.apply(this, arguments);
      });
    }
  }
  var a = e.appendFile;
  ...
  function h(S, re, Z) {
    ...
    function ce(L, D, B, N) {
      return function(q, U) {
        q && (q.code === "EMFILE" || q.code === "ENFILE") ? jn([
          X,
          [L, D, B],
          q,
          N || Date.now(),
...
function jn(e) {
  cn("ENQUEUE", e[0].name, e[1]), Se[qe].push(e), uu();
}
var ya;
function Ac() {
...
function uu() {
  if (clearTimeout(ya), ya = void 0, Se[qe].length !== 0) {
    ...
    if (i === void 0)
      cn("RETRY", t.name, r), t.apply(null, r);
      ...
      u >= g ? (cn("RETRY", t.name, r), t.apply(null, r.concat([i]))) : Se[qe].push(e);
    }
...
const xd = mn, { checkPath: Ud } = Ld, Bd = (e) => {
  const t = { mode: 511 };
...
function jd(e, t, r, n, i) {
  ...
  ii.stat(s, { bigint: !0 }, (u, c) => u ? u.code === "ENOENT" ? i() : i(u) : go(t, c) ? i(new Error(ss(e, r, n))) : jd(e, t, s, n, i));
}
function Wd(e, t, r, n) {
...
const lt = Ze, Xi = ve, fy = Yt.mkdirs, dy = gn.pathExists, hy = qd.utimesMillis, Qi = ui;
function py(e, t, r, n) {
...
var Ay = py;
const ze = Ze, Ki = ve, Py = Yt.mkdirsSync, Iy = qd.utimesMillisSync, Ji = ui;
function $y(e, t, r) {
...
const Jy = Je.fromPromise, th = mn, rh = ve, nh = Yt, ih = us, Fc = Jy(async function(t) {
  let r;
  try {
...
const i0 = Je.fromCallback, sh = ve, $r = Ze, lh = Yt, o0 = gn.pathExists, { areIdentical: uh } = ui;
function a0(e, t, r) {
  function n(i, a) {
    $r.link(i, a, (s) => {
      if (s) return r(s);
...
const Dr = ve, ji = Ze, u0 = gn.pathExists;
function c0(e, t, r) {
  if (Dr.isAbsolute(e))
...
const g0 = Je.fromCallback, fh = ve, Pt = mn, dh = Yt, y0 = dh.mkdirs, b0 = dh.mkdirsSync, hh = d0, w0 = hh.symlinkPaths, _0 = hh.symlinkPathsSync, ph = m0, E0 = ph.symlinkType, S0 = ph.symlinkTypeSync, v0 = gn.pathExists, { areIdentical: mh } = ui;
function C0(e, t, r, n) {
...
const B0 = Je.fromCallback, Wi = Ze, bh = ve, wh = Yt, M0 = gn.pathExists;
function q0(e, t, r, n) {
...
var J0 = Ke;
const Z0 = Ze, Ml = ve, eb = hu.copy, _h = us.remove, tb = Yt.mkdirp, rb = gn.pathExists, Wc = ui;
function nb(e, t, r, n) {
...
var ab = nb;
const Eh = Ze, ql = ve, sb = hu.copySync, Sh = us.removeSync, lb = Yt.mkdirpSync, zc = ui;
function ub(e, t, r) {
  r = r || {};
...
const Ab = mo, Pb = Cb, Ib = Br, $b = po, Ch = li, Ob = kr, Jc = ci, Db = yo, Ni = (0, Pb.default)("electron-builder");
...
const Ih = mo, $h = ci, Hb = "options.name must be either a string or a Buffer", Zc = (0, Ih.randomBytes)(16);
Zc[0] = Zc[0] | 1;
const La = {}, ue = [];
for (let e = 0; e < 256; e++) {
...
function zb(e, t, r, n, i = Hi.ASCII) {
  ...
  switch (i) {
    case Hi.BINARY:
      ...
      break;
    case Hi.OBJECT:
      u[6] = u[6] & 15 | r, u[8] = u[8] & 63 | 128, c = new pn(u);
      break;
    default:
...
ai.nil = new pn("00000000-0000-0000-0000-000000000000");
var bo = {}, Oh = {};
(function(e) {
  (function(t) {
...
function y_(e, t, r) {
  ...
  for (e.kind = "scalar", e.result = "", a = s = e.position, u = !1; b !== 0; ) {
    ...
    u && (Nr(e, a, s, !1), Ru(e, e.line - c), a = s = e.position, u = !1), fn(b) || (s = e.position + 1), b = e.input.charCodeAt(++e.position);
  }
...
`);
    ...
    for (n ? fn(h) ? (g = !0, e.result += an.repeat(`
...
function cf(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = a), c = e.input.charCodeAt(e.position); c !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, H(e, "tab characters must not be used in indentation")), !(c !== 45 || (s = e.input.charCodeAt(e.position + 1), !ut(s)))); ) {
    ...
    if (r = e.line, si(e, t, np, !1, !0), a.push(e.result), $e(e, !0, -1), c = e.input.charCodeAt(e.position), (e.line === r || e.lineIndent > t) && c !== 0)
...
function S_(e, t, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = h), $ = e.input.charCodeAt(e.position); $ !== 0; ) {
    if (!A && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, H(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, ($ === 63 || $ === 58) && ut(n))
      ...
      if (s = e.line, u = e.lineStart, c = e.position, !si(e, r, rp, !1, !0))
        break;
      if (e.line === a) {
        for ($ = e.input.charCodeAt(e.position); fn($); )
    ...
    if ((e.line === a || e.lineIndent > t) && (A && (s = e.line, u = e.lineStart, c = e.position), si(e, t, Qa, !0, i) && (A ? E = e.result : C = e.result), A || (Kn(e, h, m, b, E, C, s, u, c), b = E = C = null), $e(e, !0, -1), $ = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && $ !== 0)
...
Eu.loadAll = A_;
Eu.load = P_;
var cp = {}, ps = $t, _o = wo, I_ = vu, fp = Object.prototype.toString, dp = Object.prototype.hasOwnProperty, Tu = 65279, $_ = 9, to = 10, O_ = 13, D_ = 32, N_ = 33, F_ = 34, Vl = 35, k_ = 37, L_ = 38, x_ = 39, U_ = 42, hp = 44, B_ = 45, Ja = 58, M_ = 61, q_ = 62, j_ = 63, W_ = 64, pp = 91, mp = 93, H_ = 96, gp = 123, z_ = 124, yp = 125, Ge = {};
Ge[0] = "\\0";
Ge[7] = "\\a";
Ge[8] = "\\b";
Ge[9] = "\\t";
...
function tE(e, t, r, n, i, a, s, u) {
  ...
  return !h && !m ? C && !s && !i(e) ? wp : a === ro ? Xn : Xl : r > 9 && bp(e) ? Xn : s ? a === ro ? Xn : Xl : m ? Ep : _p;
}
...
const Sa = ys, { MAX_LENGTH: _f, MAX_SAFE_INTEGER: va } = gs, { safeRe: Ca, t: Ra } = Eo, SE = Pu, { compareIdentifiers: Hn } = Rp;
let vE = class Ht {
  constructor(t, r) {
  ...
  compareMain(t) {
    return t instanceof Ht || (t = new Ht(t, this.options)), Hn(this.major, t.major) || Hn(this.minor, t.minor) || Hn(this.patch, t.patch);
  }
  comparePre(t) {
  ...
  inc(t, r, n) {
    ...
    switch (t) {
      ...
      case "pre": {
        ...
        if (r) {
          let a = [r, i];
          n === !1 && (a = [r]), Hn(this.prerelease[0], r) === 0 ? isNaN(this.prerelease[1]) && (this.prerelease = a) : this.prerelease = a;
        }
        break;
      }
      default:
...
const Df = Dt(), Fu = ws(), { ANY: _l } = Fu, ki = _s, ku = Ot, mv = (e, t, r = {}) => {
  if (e === t)
    return !0;
...
var bv = mv;
const El = Eo, Lf = gs, wv = tt, xf = Rp, _v = fi, Ev = AE, Sv = $E, vv = DE, Cv = FE, Rv = xE, Tv = ME, Av = WE, Pv = GE, Iv = Ot, $v = QE, Ov = ZE, Dv = Iu, Nv = nS, Fv = aS, kv = bs, Lv = $u, xv = Tp, Uv = Ap, Bv = Ou, Mv = Du, qv = Pp, jv = IS, Wv = ws(), Hv = Dt(), zv = _s, Gv = LS, Vv = MS, Yv = HS, Xv = VS, Qv = QS, Kv = Nu, Jv = av, Zv = uv, eC = fv, tC = pv, rC = bv;
var $p = {
  parse: _v,
  valid: Ev,
  clean: Sv,
...
(function(e, t) {
  ...
  ), gi = se ? p.Buffer : void 0, mr = p.Symbol, bn = p.Uint8Array, wn = Qt.propertyIsEnumerable, Hr = Is.splice, Ft = mr ? mr.toStringTag : void 0, gt = Object.getOwnPropertySymbols, kt = gi ? gi.isBuffer : void 0, Io = Nt(Object.keys, Object), gr = _r(p, "DataView"), zr = _r(p, "Map"), Gr = _r(p, "Promise"), _n = _r(p, "Set"), yi = _r(p, "WeakMap"), Vr = _r(Object, "create"), $s = rr(gr), Os = rr(zr), $o = rr(Gr), bi = rr(_n), wi = rr(yi), Oo = mr ? mr.prototype : void 0, yt = Oo ? Oo.valueOf : void 0;
  function Lt(_) {
  ...
  dt.prototype.clear = Zt, dt.prototype.delete = Do, dt.prototype.get = _i, dt.prototype.has = No, dt.prototype.set = En;
  function xt(_) {
    var R = -1, k = _ == null ? 0 : _.length;
    for (this.clear(); ++R < k; ) {
      var W = _[R];
  ...
  function ko(_) {
    var R = Tn(this, _).delete(_);
    return this.size -= R ? 1 : 0, R;
  }
  function Lo(_) {
    return Tn(this, _).get(_);
  }
  function xo(_) {
    return Tn(this, _).has(_);
  }
  function Ei(_, R) {
    var k = Tn(this, _), W = k.size;
  ...
  Ut.prototype.clear = Ls, Ut.prototype.delete = Uo, Ut.prototype.get = br, Ut.prototype.has = xs, Ut.prototype.set = Sn;
  function Yr(_, R) {
    var k = qt(_), W = !k && An(_), he = !k && !W && Er(_), K = !k && !W && !he && Xo(_), de = k || W || he || K, Ee = de ? rt(_.length, String) : [], Pe = Ee.length;
    for (var _e in _)
  ...
  function Si(_, R, k, W, he) {
    return _ === R ? !0 : _ == null || R == null || !Qr(_) && !Qr(R) ? _ !== _ && R !== R : Cn(_, R, k, W, Si, he);
  }
  function Cn(_, R, k, W, he, K) {
  ...
  function vi(_, R, k, W, he, K, de) {
    switch (k) {
      ...
      case Z:
        return !(_.byteLength != R.byteLength || !K(new bn(_), new bn(R)));
      case f:
      case h:
      case A:
        return Ri(+_, +R);
  ...
  function Xr(_, R, k, W, he, K) {
    ...
    if (ot && !jt) {
      var In = _.constructor, $n = R.constructor;
      In != $n && "constructor" in _ && "constructor" in R && !(typeof In == "function" && In instanceof In && typeof $n == "function" && $n instanceof $n) && (ot = !1);
    }
  ...
  (gr && Bt(new gr(new ArrayBuffer(1))) != X || zr && Bt(new zr()) != C || Gr && Bt(Gr.resolve()) != M || _n && Bt(new _n()) != ae || yi && Bt(new yi()) != re) && (Bt = function(_) {
  ...
  var An = vn(/* @__PURE__ */ function() {
    return arguments;
  }()) ? vn : function(_) {
    return Qr(_) && ft.call(_, "callee") && !wn.call(_, "callee");
  }, qt = Array.isArray;
  function Pn(_) {
...
(function(e) {
  ...
  function r() {
    return hn.session.fromPartition(e.NET_SESSION_NAME, {
      cache: !1
    });
  }
...
const lr = Be, Jn = $p, xC = li, Zn = Et, Zl = De, Al = /\/tag\/([^/]+)$/;
...
const zn = Be, MC = je, qC = ve, Yf = li, Xf = Et, jC = Ur, WC = De;
class HC extends jC.BaseGitHubProvider {
  ...
  async getLatestVersion() {
    const t = new zn.CancellationToken(), r = (0, Xf.getChannelFilename)(this.getDefaultChannelName()), n = await this.getLatestVersionInfo(t), i = n.assets.find((u) => u.name === r);
    if (i == null)
      throw (0, zn.newError)(`Cannot find ${r} in the release ${n.html_url || n.name}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND");
    const a = new Yf.URL(i.url);
    let s;
    try {
      s = (0, MC.load)(await this.httpRequest(a, this.configureHeaders("application/octet-stream"), t));
    } catch (u) {
      throw u instanceof zn.HttpError && u.statusCode === 404 ? (0, zn.newError)(`Cannot find ${r} in the latest release artifacts (${a}): ${u.stack || u.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : u;
    }
  ...
  resolveFiles(t) {
    return (0, WC.getFileList)(t).map((r) => {
      ...
      if (i == null)
        throw (0, zn.newError)(`Cannot find asset "${n}" in: ${JSON.stringify(t.assets, null, 2)}`, "ERR_UPDATER_ASSET_NOT_FOUND");
      return {
...
yn.computeOperations = QC;
var sn;
(function(e) {
  e[e.COPY = 0] = "COPY", e[e.DOWNLOAD = 1] = "DOWNLOAD";
})(sn || (yn.OperationKind = sn = {}));
function QC(e, t, r) {
...
di.copyData = Up;
const Ia = Be, ZC = Br, eR = po, tR = yn, Zf = Buffer.from(`\r
\r
`);
var Pr;
(function(e) {
...
const Li = Be, $l = Mr, sR = Br, lR = di, uR = li, $a = yn, rd = As, cR = Ps;
class fR {
...
const Xe = Be, mR = mo, gR = os, yR = Td, Gn = Mr, bR = je, Ol = ms, rn = ve, on = $p, id = So, wR = Es, od = Op, _R = vo, Dl = Ss, ER = Pd, SR = Et, vR = Ts, Vn = qr;
class xu extends yR.EventEmitter {
  ...
  dispatchUpdateDownloaded(t) {
    this.emit(Vn.UPDATE_DOWNLOADED, t);
  }
  async loadUpdateConfig() {
    return this._appUpdateConfigPath == null && (this._appUpdateConfigPath = this.app.appUpdateConfigPath), (0, bR.load)(await (0, Gn.readFile)(this._appUpdateConfigPath, "utf-8"));
  }
  ...
  async getOrCreateStagingUserId() {
    ...
    try {
      const n = await (0, Gn.readFile)(t, "utf-8");
      if (Xe.UUID.check(n))
        return n;
  ...
  async executeDownload(t) {
    ...
    this.listenerCount(Vn.DOWNLOAD_PROGRESS) > 0 && (n.onProgress = ($) => this.emit(Vn.DOWNLOAD_PROGRESS, $));
    ...
    await (0, Gn.mkdir)(g, { recursive: !0 });
    const f = u();
    let h = rn.join(g, f);
    ...
    }), await (0, Gn.unlink)(h).catch(() => {
    })), I = await (0, id.createTempUpdateFile)(`temp-${f}`, g, E);
    try {
      await t.task(I, n, m, A), await (0, Xe.retry)(() => (0, Gn.rename)(I, h), 60, 500, 0, 0, ($) => $ instanceof Error && /^EBUSY:/.test($.message));
    } catch ($) {
  ...
  async differentialDownloadInstaller(t, r, n, i, a) {
    try {
      ...
      this.listenerCount(Vn.DOWNLOAD_PROGRESS) > 0 && (c.onProgress = (f) => this.emit(Vn.DOWNLOAD_PROGRESS, f));
...
class TR extends RR.AppUpdater {
  ...
  quitAndInstall(t = !1, r = !1) {
    this._logger.info("Install on explicit quitAndInstall"), this.install(t, t ? r : this.autoRunAppAfterInstall) ? setImmediate(() => {
      hn.autoUpdater.emit("before-quit-for-update"), this.app.quit();
...
async function $R(e) {
  const t = await (0, Yn.open)(e, "r");
  try {
    const r = (await (0, Yn.fstat)(t)).size, n = Buffer.allocUnsafe(4);
    await (0, Yn.read)(t, n, 0, n.length, r - n.length);
    const i = Buffer.allocUnsafe(n.readUInt32BE(0));
    return await (0, Yn.read)(t, i, 0, i.length, r - n.length - i.length), await (0, Yn.close)(t), Mp(i);
  } catch (r) {
    throw await (0, Yn.close)(t), r;
  }
}
Object.defineProperty(io, "__esModule", { value: !0 });
io.AppImageUpdater = void 0;
const sd = Be, ld = is, OR = Mr, DR = Br, xi = ve, NR = hr, FR = Ro, kR = De, ud = qr;
class LR extends NR.BaseUpdater {
  ...
  doInstall(t) {
    ...
    if (a == null)
      return this.dispatchError(new Error("No valid update available, can't quit and install")), !1;
    xi.basename(a) === i || !/\d+\.\d+\.\d+/.test(i) ? n = r : n = xi.join(xi.dirname(r), xi.basename(a)), (0, ld.execFileSync)("mv", ["-f", a, n]), n !== r && this.emit("appimage-filename-updated", n);
    const s = {
      ...process.env,
...
class QR extends YR.AppUpdater {
  constructor(t, r) {
    super(t, r), this.nativeUpdater = hn.autoUpdater, this.squirrelDownloadedUpdate = !1, this.nativeUpdater.on("error", (n) => {
...
const Oa = Be, wd = ve, tT = hr, rT = Ro, _d = qr, nT = De, iT = Mr, oT = Uu, Ed = li;
class aT extends tT.BaseUpdater {
  ...
  doInstall(t) {
    ...
    return t.isAdminRightsRequired ? (this._logger.info("isAdminRightsRequired is set to true, run installer using elevate.exe"), a(), !0) : (this.spawnLog(r, n).catch((s) => {
      const u = s.code;
      this._logger.info(`Cannot run installer: error code: ${u}, error message: "${s.message}", will be executed again using elevate if EACCES, and will try to use electron.shell.openItem if ENOENT`), u === "UNKNOWN" || u === "EACCES" ? a() : u === "ENOENT" ? hn.shell.openPath(r).catch((c) => this.dispatchError(c)) : this.dispatchError(s);
    }), !0);
  }
...
function Bu(e) {
  ...
  Ui.on("click", n), Ui.on("double-click", n), a(), Bu.refresh = a;
}
function lT() {
...
async function dT() {
  ...
  a.setBounds({ x: s, y: u, width: r, height: n }), Cd.setApplicationMenu(null), Bu(un);
  let c = null;
  const g = () => {
    const f = un();
    if (!f) return;
...
function hT() {
  ru.on("status", (e, t) => {
    var r, n, i;
    (r = un()) == null || r.webContents.send("lcu-status", e), e === "connected" && t ? ((n = un()) == null || n.show(), nu.setCreds(t), xa.setCreds(t), xa.start()) : (nu.stop(), xa.stop(), (i = un()) == null || i.hide());
  });
}
It.whenReady().then(async () => {
  await dT(), Bu(un), Ug({ lcu: ru, gameflow: nu, skins: xa, getWin: un }), hT(), lT(), ru.start();
});
