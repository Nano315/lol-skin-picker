...
import require$$1$4, { app, ipcMain, screen, BrowserWindow, Menu, nativeImage, Tray, dialog } from "electron";
...
class Body {
  ...
  async formData() {
    ...
    const { toFormData } = await import("./multipart-parser-BnUfK1mf.js");
