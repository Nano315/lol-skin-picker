...
import { nativeImage, Tray, ipcMain, app, BrowserWindow, Menu } from "electron";
...
class Body {
  ...
  async formData() {
    ...
    const { toFormData } = await import("./multipart-parser-D3tSEEeq.js");
...
function createWindow() {
  ...
  const trayIcon2 = nativeImage.createFromPath(resolveAsset("icon.ico"));
  tray = new Tray(trayIcon2);
