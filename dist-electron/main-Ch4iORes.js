...
class Body {
  ...
  async formData() {
    ...
    const { toFormData } = await import("./multipart-parser-B8tgAgF5.js");
...
async function pollGameflow() {
  ...
  try {
    ...
    if (txt !== gameflowPhase) {
      gameflowPhase = txt;
      win == null ? void 0 : win.webContents.send("gameflow-phase", gameflowPhase);
    }
  } catch {
    stopPolling();
    setDisconnected();
...
function startPolling() {
  ...
  gameflowTimer = setInterval(pollGameflow, 2e3);
}
...
function setDisconnected() {
  if (lcuStatus !== "disconnected") {
    ...
    win == null ? void 0 : win.webContents.send("lcu-status", lcuStatus);
    win == null ? void 0 : win.webContents.send("gameflow-phase", gameflowPhase);
  }
}
function watchLcu() {
