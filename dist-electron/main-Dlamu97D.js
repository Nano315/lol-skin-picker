...
import require$$1$4, { app, ipcMain, BrowserWindow, Menu, nativeImage, Tray } from "electron";
...
class Body {
  ...
  async formData() {
    ...
    const { toFormData } = await import("./multipart-parser-DvtupC1i.js");
...
async function createWindow() {
  const resolveAsset = (p) => app.isPackaged ? join(process.resourcesPath, "assets", p) : join(__dirname, "..", "public", p);
