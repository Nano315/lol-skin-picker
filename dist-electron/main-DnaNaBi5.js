...
const _LcuWatcher = class _LcuWatcher extends EventEmitter {
  ...
  tick() {
    ...
    if (((_a2 = this.creds) == null ? void 0 : _a2.port) !== parsed.port || ((_b2 = this.creds) == null ? void 0 : _b2.password) !== parsed.password || ((_c2 = this.creds) == null ? void 0 : _c2.protocol) !== parsed.protocol) {
      this.creds = parsed;
      this.emit("status", "connected", parsed);
    }
  }
  toConnected(c) {
  ...
  readLockfile() {
    for (const p of _LcuWatcher.LOCKFILES) {
      try {
...
__publicField(_LcuWatcher, "LOCKFILES", [
...
class Body {
  ...
  async formData() {
    ...
    const { toFormData } = await import("./multipart-parser-BoAw3SRa.js");
...
gameflow.on("phase", (phase) => {
  ...
  if (phase === "ChampSelect") skins.start();
  else skins.stop();
});
skins.on("skins", (list) => {
