...
import { ipcMain as ie, app as ln, BrowserWindow as ja, Menu as Ma, nativeImage as Ua, Tray as Na } from "electron";
  ...
  return Fo || (Fo = 1, function(a, o) {
    (function(n, s) {
      ...
      Object.defineProperties(Ce.prototype, {
        ...
        closed: { enumerable: !0 }
      }), c(Ce.prototype.cancel, "cancel"), c(Ce.prototype.read, "read"), c(Ce.prototype.releaseLock, "releaseLock"), typeof Symbol.toStringTag == "symbol" && Object.defineProperty(Ce.prototype, Symbol.toStringTag, {
      ...
      class En {
        ...
        _nextSteps() {
          ...
          return at(t, {
            _chunkSteps: (d) => {
              this._ongoingPromise = void 0, de(() => r({ value: d, done: !1 }));
            },
            _closeSteps: () => {
              this._ongoingPromise = void 0, this._isFinished = !0, ce(t), r({ value: void 0, done: !0 });
            },
            _errorSteps: (d) => {
              this._ongoingPromise = void 0, this._isFinished = !0, ce(t), i(d);
            }
          }), l;
        }
        _returnSteps(t) {
          ...
          if (!this._preventCancel) {
            const i = gr(r, t);
            return ce(r), z(i, () => ({ value: t, done: !0 }));
          }
          return ce(r), g({ value: t, done: !0 });
        }
      }
      const vn = {
        next() {
      ...
      }), c(pe.prototype.close, "close"), c(pe.prototype.enqueue, "enqueue"), c(pe.prototype.error, "error"), typeof Symbol.toStringTag == "symbol" && Object.defineProperty(pe.prototype, Symbol.toStringTag, {
      ...
      function ci(e, t, r, i) {
        const l = e._controlledReadableByteStream, f = t.constructor, d = fi(f), { byteOffset: p, byteLength: C } = t, y = r * d;
        let P;
        try {
          P = me(t.buffer);
        } catch (A) {
      ...
      function Vn(e, t, r, i, l, f, d) {
        t._controlledReadableByteStream = e, t._pullAgain = !1, t._pulling = !1, t._byobRequest = null, t._queue = t._queueTotalSize = void 0, Ee(t), t._closeRequested = !1, t._started = !1, t._strategyHWM = f, t._pullAlgorithm = i, t._cancelAlgorithm = l, t._autoAllocateChunkSize = d, t._pendingPullIntos = new U(), e._readableStreamController = t;
        const p = r();
      ...
      Object.defineProperties(ve.prototype, {
        ...
        releaseLock: { enumerable: !0 },
        closed: { enumerable: !0 }
      }), c(ve.prototype.cancel, "cancel"), c(ve.prototype.read, "read"), c(ve.prototype.releaseLock, "releaseLock"), typeof Symbol.toStringTag == "symbol" && Object.defineProperty(ve.prototype, Symbol.toStringTag, {
      ...
      function Zn(e, t, r, i) {
        ...
        l._disturbed = !0, l._state === "errored" ? i._errorSteps(l._storedError) : ci(l._readableStreamController, t, r, i);
      }
      function Ri(e) {
        ce(e);
        const t = new TypeError("Reader was released");
      ...
      function Ti(e, t) {
        ...
        return {
          ...
          write: d === void 0 ? void 0 : ki(d, e, `${t} has member 'write' that`),
          type: f
        };
      }
      function Pi(e, t, r) {
      ...
      Object.defineProperties(ke.prototype, {
        ...
        locked: { enumerable: !0 }
      }), c(ke.prototype.abort, "abort"), c(ke.prototype.close, "close"), c(ke.prototype.getWriter, "getWriter"), typeof Symbol.toStringTag == "symbol" && Object.defineProperty(ke.prototype, Symbol.toStringTag, {
      ...
      function Wi(e, t, r, i, l = 1, f = () => 1) {
        const d = Object.create(ke.prototype);
        eo(d);
        const p = Object.create(Ye.prototype);
        return so(d, p, e, t, r, i, l, f), d;
      }
      function eo(e) {
      ...
      class be {
         ...
         */
        abort(t = void 0) {
          return Le(this) ? this._ownerWritableStream === void 0 ? m(ct("abort")) : Mi(this, t) : m(De("abort"));
        }
        /**
        ...
        close() {
          ...
          return t === void 0 ? m(ct("close")) : se(t) ? m(new TypeError("Cannot close an already-closing stream")) : ro(this);
        }
        /**
        ...
        write(t = void 0) {
          return Le(this) ? this._ownerWritableStream === void 0 ? m(ct("write to")) : io(this, t) : m(De("write"));
        }
      }
      Object.defineProperties(be.prototype, {
        ...
        desiredSize: { enumerable: !0 },
        ready: { enumerable: !0 }
      }), c(be.prototype.abort, "abort"), c(be.prototype.close, "close"), c(be.prototype.releaseLock, "releaseLock"), c(be.prototype.write, "write"), typeof Symbol.toStringTag == "symbol" && Object.defineProperty(be.prototype, Symbol.toStringTag, {
      ...
      function so(e, t, r, i, l, f, d, p) {
        t._controlledWritableStream = e, e._writableStreamController = t, t._queue = void 0, t._queueTotalSize = void 0, Ee(t), t._abortReason = void 0, t._abortController = Ii(), t._started = !1, t._strategySizeAlgorithm = p, t._strategyHWM = d, t._writeAlgorithm = i, t._closeAlgorithm = l, t._abortAlgorithm = f;
        const C = xr(t);
        Ur(e, C);
        const y = r(), P = g(y);
      ...
      function Hi(e, t, r, i) {
        ...
        }, t.write !== void 0 ? d = (y) => t.write(y, l) : d = () => g(void 0), t.close !== void 0 ? p = () => t.close() : p = () => g(void 0), t.abort !== void 0 ? C = (y) => t.abort(y) : C = () => g(void 0), so(e, l, f, d, p, C, r, i);
      }
      function Dt(e) {
      ...
      function po(e, t, r, i, l, f) {
        ...
        return w((P, E) => {
          ...
          if (ge(e, d._closedPromise, (R) => (i ? X(!0, R) : H(() => $t(t, R), !0, R), null)), ge(t, p._closedPromise, (R) => (l ? X(!0, R) : H(() => re(e, R), !0, R), null)), N(e, d._closedPromise, () => (r ? X() : H(() => Ui(p)), null)), se(t) || t._state === "closed") {
          ...
          function _e(R, v) {
            return oo(p), ce(d), f !== void 0 && f.removeEventListener("abort", A), R ? E(v) : P(void 0), null;
          }
        });
      }
      class ye {
      ...
      Object.defineProperties(ye.prototype, {
        ...
        error: { enumerable: !0 },
        desiredSize: { enumerable: !0 }
      }), c(ye.prototype.close, "close"), c(ye.prototype.enqueue, "enqueue"), c(ye.prototype.error, "error"), typeof Symbol.toStringTag == "symbol" && Object.defineProperty(ye.prototype, Symbol.toStringTag, {
      ...
      function yo(e, t, r, i, l, f, d) {
        t._controlledReadableStream = e, t._queue = void 0, t._queueTotalSize = void 0, Ee(t), t._started = !1, t._closeRequested = !1, t._pullAgain = !1, t._pulling = !1, t._strategySizeAlgorithm = d, t._strategyHWM = f, t._pullAlgorithm = i, t._cancelAlgorithm = l, e._readableStreamController = t;
        const p = r();
      ...
      function sa(e, t, r, i) {
        ...
        let f, d, p;
        t.start !== void 0 ? f = () => t.start(l) : f = () => {
        }, t.pull !== void 0 ? d = () => t.pull(l) : d = () => g(void 0), t.cancel !== void 0 ? p = (C) => t.cancel(C) : p = () => g(void 0), yo(e, l, f, d, p, r, i);
      }
      function Vt(e) {
      ...
      function ua(e, t) {
          ...
          return i ? (l = !0, g(void 0)) : (i = !0, at(r, {
            _chunkSteps: (H) => {
              de(() => {
                l = !1;
                const X = H, _e = H;
                f || Ge(y._readableStreamController, X), d || Ge(P._readableStreamController, _e), i = !1, l && ne();
              });
            },
            _closeSteps: () => {
        ...
        return y = mt(ge, ne, Ke), P = mt(ge, ne, We), q(r._closedPromise, (N) => (te(y._readableStreamController, N), te(P._readableStreamController, N), (!f || !d) && E(void 0), null)), [y, P];
      }
      function fa(e) {
        ...
        function ne(R) {
          q(R._closedPromise, (v) => (R !== t || (K(y._readableStreamController, v), K(P._readableStreamController, v), (!f || !d) && E(void 0)), null));
        }
        function Ke() {
          $e(t) && (ce(t), t = xe(e), ne(t)), at(t, {
            _chunkSteps: (v) => {
              de(() => {
                i = !1, l = !1;
                const I = v;
                ...
                f || It(y._readableStreamController, I), d || It(P._readableStreamController, G), r = !1, i ? ge() : l && N();
              });
            },
            _closeSteps: () => {
              r = !1, f || lt(y._readableStreamController), d || lt(P._readableStreamController), y._readableStreamController._pendingPullIntos.length > 0 && Wt(y._readableStreamController, 0), P._readableStreamController._pendingPullIntos.length > 0 && Wt(P._readableStreamController, 0), (!f || !d) && E(void 0);
            },
            _errorSteps: () => {
              r = !1;
            }
      ...
      function ca(e) {
        return da(e) ? ma(e.getReader()) : ha(e);
      }
      function ha(e) {
        let t;
      ...
      function pa(e, t) {
        ...
        return {
          ...
          start: d === void 0 ? void 0 : ga(d, r, `${t} has member 'start' that`),
      ...
      function mt(e, t, r, i = 1, l = () => 1) {
        ...
        Jr(f);
        const d = Object.create(ye.prototype);
        return yo(f, d, e, t, r, i, l), f;
      }
      function _o(e, t, r) {
      ...
      function Ca(e, t) {
        ...
        return {
          ...
          transform: d === void 0 ? void 0 : Ea(d, e, `${t} has member 'transform' that`),
          writableType: p
        };
      }
      function Ta(e, t, r) {
      ...
      class Gt {
        constructor(t = {}, r = {}, i = {}) {
          t === void 0 && (t = null);
          const l = Ft(r, "Second parameter"), f = Ft(i, "Third parameter"), d = Ca(t, "First parameter");
          ...
          ka(this, A, y, P, p, C), Ba(this, d), d.start !== void 0 ? E(d.start(this._transformStreamController)) : E(void 0);
        }
        /**
      ...
      Object.defineProperties(Ie.prototype, {
        ...
        desiredSize: { enumerable: !0 }
      }), c(Ie.prototype.enqueue, "enqueue"), c(Ie.prototype.error, "error"), c(Ie.prototype.terminate, "terminate"), typeof Symbol.toStringTag == "symbol" && Object.defineProperty(Ie.prototype, Symbol.toStringTag, {
      ...
      function Ba(e, t) {
        ...
        t.transform !== void 0 ? i = (d) => t.transform(d, r) : i = (d) => {
          try {
            return Bo(r, d), g(void 0);
          } catch (p) {
            return m(p);
          }
        }, t.flush !== void 0 ? l = () => t.flush(r) : l = () => g(void 0), t.cancel !== void 0 ? f = (d) => t.cancel(d) : f = () => g(void 0), Aa(e, r, i, l, f);
      }
      function Kt(e) {
  ...
  for (const n of a)
    if ("stream" in n)
      ...
      if (o) {
        ...
        for (; s !== u; ) {
          const h = Math.min(u - s, $o), c = n.buffer.slice(s, s + h);
      ...
      for (; s !== u.size; ) {
        const c = await u.slice(s, Math.min(u.size, s + $o)).arrayBuffer();
        s += c.byteLength, yield new Uint8Array(c);
      }
    }
}
...
const No = (Ne = class {
  ...
  constructor(o = [], n = {}) {
    ...
    for (const h of o) {
      let c;
      ArrayBuffer.isView(h) ? c = new Uint8Array(h.buffer.slice(h.byteOffset, h.byteOffset + h.byteLength)) : h instanceof ArrayBuffer ? c = new Uint8Array(h.slice(0)) : h instanceof Ne ? c = h : c = s.encode(`${h}`), le(this, it, $(this, it) + (ArrayBuffer.isView(c) ? c.byteLength : c.size)), $(this, we).push(c);
    }
    le(this, cr, `${n.endings === void 0 ? "transparent" : n.endings}`);
  ...
  slice(o = 0, n = this.size, s = "") {
    ...
    const S = Math.max(c - h, 0), T = $(this, we), b = [];
    let w = 0;
    for (const m of T) {
      if (w >= S)
        break;
...
}, we = new WeakMap(), wt = new WeakMap(), it = new WeakMap(), cr = new WeakMap(), Ne);
...
class _t {
  constructor(o, {
    ...
    j.isBuffer(o) ? u = fe.Readable.from(o) : ur(o) && (u = fe.Readable.from(o.stream())), this[V] = {
      ...
      const c = h instanceof mr ? h : new ue(`Invalid response body while trying to fetch ${this.url}: ${h.message}`, "system", h);
      this[V].error = c;
    });
  }
  get body() {
  ...
  async formData() {
    ...
    const { toFormData: n } = await import("./multipart-parser-CneY5rfk.js");
...
), Ho = (a, o) => a === null ? null : typeof a == "string" ? "text/plain;charset=UTF-8" : xo(a) ? "application/x-www-form-urlencoded;charset=UTF-8" : ur(a) ? a.type || null : j.isBuffer(a) || ar.isAnyArrayBuffer(a) || ArrayBuffer.isView(a) ? null : a instanceof fn ? `multipart/form-data; boundary=${o[V].boundary}` : a && typeof a.getBoundary == "function" ? `multipart/form-data;boundary=${ds(a)}` : a instanceof fe ? null : "text/plain;charset=UTF-8", cs = (a) => {
  const { body: o } = a[V];
...
class St extends _t {
  constructor(o, n = {}) {
    ...
    const c = new Re(n.headers || o.headers || {});
...
async function Se(a, o) {
  return new Promise((n, s) => {
    const u = new St(a, o), { parsedURL: h, options: c } = Cs(u);
...
class vs extends hn {
  ...
  async poll() {
    ...
    try {
      const S = (await Se(h, { headers: { Authorization: `Basic ${c}` } }).then(
        (T) => T.text()
      )).replace(/"/g, "");
...
async function ks() {
  if (cn.size) return;
  (await Se("https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/champion-summary.json").then((n) => n.json())).forEach((n) => cn.set(n.id, n.alias));
}
class As extends hn {
  constructor() {
    super(...arguments);
  ...
  getSelection() {
    return {
      ...
      championAlias: cn.get(this.currentChampion) ?? "",
...
const Bs = Va(import.meta.url), nr = xa(Bs);
let B = null;
...
function Is() {
  ...
  const a = Ua.createFromPath(
    tr(nr, "../public/icon.ico")
  );
  sn = new Na(a), sn.setToolTip("LoL Skin Picker"), sn.on("double-click", () => B.isVisible() ? B.hide() : B.show()), process.env.VITE_DEV_SERVER_URL ? B.loadURL(process.env.VITE_DEV_SERVER_URL) : B.loadFile(tr(nr, "../renderer/index.html")), pn.start();
}
