...
import require$$1$4, { app, ipcMain, shell, screen, BrowserWindow, Menu, nativeImage, Tray, dialog } from "electron";
...
class Body {
  ...
  async formData() {
    ...
    const { toFormData } = await import("./multipart-parser-BcsdPIVP.js");
...
class GameflowWatcher extends EventEmitter {
  constructor() {
    super(...arguments);
    __publicField(this, "creds", null);
    __publicField(this, "timer", null);
...
class ChampionSkinWatcher extends EventEmitter {
  constructor() {
    super(...arguments);
    __publicField(this, "creds", null);
  ...
  async refreshSkinsAndMaybeApply() {
    ...
    if (this.autoRollEnabled && this.currentChampion !== this.lastAppliedChampion && owned.length) {
      ...
      const finalId = pickedSkin.chromas.length ? pickedSkin.chromas[Math.floor(Math.random() * pickedSkin.chromas.length)].id : pickedSkin.id;
      await this.applySkin(finalId);
...
gameflow.on("phase", (phase) => {
  win == null ? void 0 : win.webContents.send("gameflow-phase", phase);
});
skins.on(
  "skins",
  (list) => {
    win == null ? void 0 : win.webContents.send("owned-skins", list);
  }
  // ← cast ajouté
);
skins.on("selection", (sel) => win == null ? void 0 : win.webContents.send("selection", sel));
skins.on("icon", (id) => {
  win == null ? void 0 : win.webContents.send("summoner-icon", id);
});
function setupTray(resolveAsset) {
...
async function createWindow() {
  const resolveAsset = (relPath) => app.isPackaged ? join(process.resourcesPath, relPath) : join(__dirname, "..", "public", relPath);
  ...
  win.on("show", () => {
    var _a2;
    return (_a2 = setupTray.refresh) == null ? void 0 : _a2.call(setupTray);
  });
  win.on("hide", () => {
    var _a2;
    return (_a2 = setupTray.refresh) == null ? void 0 : _a2.call(setupTray);
...
function initAutoUpdate() {
  ...
  main$1.autoUpdater.on("download-progress", (p) => {
  ...
  main$1.autoUpdater.on("update-downloaded", (info) => {
    if (manualUpdateRequested) {
      ...
      dialog.showMessageBox({
        ...
        if (response === 0) main$1.autoUpdater.quitAndInstall();
      });
    } else {
