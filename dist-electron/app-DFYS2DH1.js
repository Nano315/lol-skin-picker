...
var Re = (e, t, r) => qm(e, typeof t != "symbol" ? t + "" : t, r), yc = (e, t, r) => t.has(e) || gc("Cannot " + r);
var ke = (e, t, r) => (yc(e, t, "read from private field"), r ? r.call(e) : t.get(e)), Tr = (e, t, r) => t.has(e) ? gc("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), Wt = (e, t, r, n) => (yc(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r);
import dn, { BrowserWindow as jm, ipcMain as wt, shell as Wm, nativeImage as Hm, Tray as zm, app as It, Menu as vd, dialog as bc, screen as Oi } from "electron";
...
import Un from "node:zlib";
import Gt, { PassThrough as Ua, pipeline as Bn } from "node:stream";
...
import ln, { join as Qm } from "node:path";
import Br from "fs";
...
function tg() {
  return wc || (wc = 1, function(e, t) {
    (function(r, n) {
      ...
      class ct {
        constructor(l) {
          if (T(l, 1, "ReadableStreamDefaultReader"), mt(l, "First parameter"), vr(l))
         ...
         */
        get closed() {
          return Nt(this) ? this._closedPromise : m(Qt("closed"));
        }
        /**
         * If the reader is active, behaves the same as {@link ReadableStream.cancel | stream.cancel(reason)}.
         */
        cancel(l = void 0) {
          return Nt(this) ? this._ownerReadableStream === void 0 ? m(B("cancel")) : L(this, l) : m(Qt("cancel"));
        }
        /**
      ...
      const ft = {
        next() {
          return mi(this) ? this._asyncIteratorImpl.next() : m(Po("next"));
        },
        return(o) {
          return mi(this) ? this._asyncIteratorImpl.return(o) : m(Po("return"));
        }
      };
      Object.setPrototypeOf(ft, hi);
      function Ao(o, l) {
        const d = ye(o), w = new pi(d, l), v = Object.create(ft);
      ...
      function mi(o) {
        if (!i(o) || !Object.prototype.hasOwnProperty.call(o, "_asyncIteratorImpl"))
          return !1;
        try {
          return o._asyncIteratorImpl instanceof pi;
        } catch {
          return !1;
        }
      }
      ...
      const gi = Number.isNaN || function(o) {
        return o !== o;
      };
      var mr, yn, bn;
      function Hr(o) {
      ...
      function Ft(o, l, d, w, v) {
        new Uint8Array(o).set(new Uint8Array(d, w, v), l);
      }
      let gt = (o) => (typeof o.transfer == "function" ? gt = (l) => l.transfer() : typeof structuredClone == "function" ? gt = (l) => structuredClone(l, { transfer: [l] }) : gt = (l) => l, gt(o)), kt = (o) => (typeof o.detached == "boolean" ? kt = (l) => l.detached : kt = (l) => l.byteLength === 0, kt(o));
      function Io(o, l, d) {
        if (o.slice)
          return o.slice(l, d);
        const w = d - l, v = new ArrayBuffer(w);
        return Ft(v, 0, o, l, w), v;
      }
      function gr(o, l) {
        const d = o[l];
        if (d != null) {
      ...
      const Gr = (bn = (mr = Symbol.asyncIterator) !== null && mr !== void 0 ? mr : (yn = Symbol.for) === null || yn === void 0 ? void 0 : yn.call(Symbol, "Symbol.asyncIterator")) !== null && bn !== void 0 ? bn : "@@asyncIterator";
      function wn(o, l = "sync", d) {
        if (d === void 0)
          if (l === "async") {
            if (d = gr(o, Gr), d === void 0) {
              const P = gr(o, Symbol.iterator), O = wn(o, "sync", P);
              return zr(O);
            }
          } else
            d = gr(o, Symbol.iterator);
        if (d === void 0)
      ...
      function Os(o) {
        return !(typeof o != "number" || gi(o) || o < 0);
      }
      function $o(o) {
      ...
      function Ds(o) {
        return Lt(o.constructor);
      }
      function Ns(o) {
        return Lt(o) ? 1 : o.BYTES_PER_ELEMENT;
      }
      class Kt {
        constructor() {
        ...
        respondWithNewView(l) {
          ...
          Cn(this._associatedReadableByteStreamController, l);
        }
      }
      Object.defineProperties(Kt.prototype, {
        ...
        view: { enumerable: !0 }
      }), s(Kt.prototype.respond, "respond"), s(Kt.prototype.respondWithNewView, "respondWithNewView"), typeof Symbol.toStringTag == "symbol" && Object.defineProperty(Kt.prototype, Symbol.toStringTag, {
      ...
      function dt(o) {
        return !i(o) || !Object.prototype.hasOwnProperty.call(o, "_associatedReadableByteStreamController") ? !1 : o instanceof Kt;
      }
      function Zt(o) {
        if (!xs(o))
          return;
        ...
        E(d, () => (o._pulling = !1, o._pullAgain && (o._pullAgain = !1, Zt(o)), null), (w) => (nt(o, w), null));
      }
      function Do(o) {
        Ei(o), o._pendingPullIntos = new Q();
      }
      function _i(o, l) {
        let d = !1;
        o._state === "closed" && (d = !0);
        const w = No(l);
        l.readerType === "default" ? jr(o, w, d) : Bt(o, w, d);
      }
      function No(o) {
      ...
      function Fo(o, l) {
        l.bytesFilled > 0 && xt(o, l.buffer, l.byteOffset, l.bytesFilled), br(o);
      }
      function ko(o, l) {
        ...
        for (; v > 0; ) {
          ...
          Ft(l.buffer, oe, z.buffer, z.byteOffset, ne), z.byteLength === ne ? J.shift() : (z.byteOffset += ne, z.byteLength -= ne), o._queueTotalSize -= ne, Lo(o, ne, l), v -= ne;
        }
        return P;
      }
      function Lo(o, l, d) {
      ...
      function xo(o) {
        o._queueTotalSize === 0 && o._closeRequested ? (En(o), $i(o._controlledReadableByteStream)) : Zt(o);
      }
      function Ei(o) {
      ...
      function yr(o) {
        for (; o._pendingPullIntos.length > 0; ) {
          ...
          ko(o, l) && (br(o), _i(o._controlledReadableByteStream, l));
        }
      }
      function Fs(o) {
      ...
      function ks(o, l, d, w) {
        ...
        o._pendingPullIntos.push(oe), Wo(v, w), Zt(o);
      }
      function Ut(o, l) {
      ...
      function Ls(o, l, d) {
        ...
        d.bytesFilled -= w, _i(o._controlledReadableByteStream, d), yr(o);
      }
      function Uo(o, l) {
        const d = o._pendingPullIntos.peek();
        Ei(o), o._controlledReadableByteStream._state === "closed" ? Ut(o, d) : Ls(o, l, d), Zt(o);
      }
      function br(o) {
      ...
      function xs(o) {
        ...
        return l._state !== "readable" || o._closeRequested || !o._started ? !1 : !!(pr(l) && Xt(l) > 0 || Ci(l) && Ho(l) > 0 || Si(o) > 0);
      }
      function En(o) {
      ...
      function er(o, l) {
        ...
        if (o._pendingPullIntos.length > 0) {
          ...
          Ei(o), j.buffer = gt(j.buffer), j.readerType === "none" && Fo(o, j);
        }
        if (pr(d))
          if (Fs(o), Xt(d) === 0)
            _n(o, O, v, P);
        ...
        else Ci(d) ? (_n(o, O, v, P), yr(o)) : _n(o, O, v, P);
        Zt(o);
      }
      function nt(o, l) {
        const d = o._controlledReadableByteStream;
        d._state === "readable" && (Do(o), yt(o), En(o), rc(d, l));
      }
      function wr(o, l) {
      ...
      function Sn(o) {
        if (o._byobRequest === null && o._pendingPullIntos.length > 0) {
          const l = o._pendingPullIntos.peek(), d = new Uint8Array(l.buffer, l.byteOffset + l.bytesFilled, l.byteLength - l.bytesFilled), w = Object.create(Kt.prototype);
      ...
      function Bo(o, l, d, w, v, P, O) {
        ...
        const j = d();
        E(h(j), () => (l._started = !0, Zt(l), null), (J) => (nt(l, J), null));
      }
      function Us(o, l, d) {
      ...
      function qo(o, l) {
        ...
        return {
          mode: d === void 0 ? void 0 : Rn(d, `${l} has member 'mode' that`)
        };
      }
      function Rn(o, l) {
        if (o = `${o}`, o !== "byob")
      ...
      function Ci(o) {
        const l = o._reader;
        return !(l === void 0 || !tr(l));
      }
      class Mt {
        constructor(l) {
          if (T(l, 1, "ReadableStreamBYOBReader"), mt(l, "First parameter"), vr(l))
            throw new TypeError("This stream has already been locked for exclusive reading by another reader");
          if (!Jt(l._readableStreamController))
         ...
         */
        get closed() {
          return tr(this) ? this._closedPromise : m(Tn("closed"));
        }
        /**
         * If the reader is active, behaves the same as {@link ReadableStream.cancel | stream.cancel(reason)}.
         */
        cancel(l = void 0) {
          return tr(this) ? this._ownerReadableStream === void 0 ? m(B("cancel")) : L(this, l) : m(Tn("cancel"));
        }
        read(l, d = {}) {
          if (!tr(this))
            return m(Tn("read"));
        ...
        releaseLock() {
          ...
          this._ownerReadableStream !== void 0 && rr(this);
        }
      }
      Object.defineProperties(Mt.prototype, {
        ...
        releaseLock: { enumerable: !0 },
        closed: { enumerable: !0 }
      }), s(Mt.prototype.cancel, "cancel"), s(Mt.prototype.read, "read"), s(Mt.prototype.releaseLock, "releaseLock"), typeof Symbol.toStringTag == "symbol" && Object.defineProperty(Mt.prototype, Symbol.toStringTag, {
        value: "ReadableStreamBYOBReader",
        configurable: !0
      });
      function tr(o) {
        return !i(o) || !Object.prototype.hasOwnProperty.call(o, "_readIntoRequests") ? !1 : o instanceof Mt;
      }
      function zo(o, l, d, w) {
      ...
      function Go(o, l) {
        ...
        return {
          ...
          start: v === void 0 ? void 0 : Qr(v, o, `${l} has member 'start' that`),
      ...
      class R {
        constructor(l = {}, d = {}) {
          ...
          const w = Er(d, "Second parameter"), v = Go(l, "First parameter");
          if (he(this), v.type !== void 0)
            throw new RangeError("Invalid type is specified");
          const O = An(w), j = qt(w, 1);
          Vp(this, v, j, O);
        }
        /**
      ...
      function Ve(o, l) {
        ...
        const w = o._writer;
        w !== void 0 && Mu(w, l), !Ko(o) && d._started && Ie(o);
      }
      function Ie(o) {
      ...
      class nr {
        constructor(l) {
          ...
          const d = l._state;
          if (d === "writable")
            !Fe(l) && l._backpressure ? na(this) : Xu(this), ra(this);
          else if (d === "erroring")
         ...
         */
        get closed() {
          return Kr(this) ? this._closedPromise : m(Jr("closed"));
        }
        /**
         ...
         */
        get ready() {
          return Kr(this) ? this._readyPromise : m(Jr("ready"));
        }
        /**
         * If the reader is active, behaves the same as {@link WritableStream.abort | stream.abort(reason)}.
         */
        abort(l = void 0) {
          return Kr(this) ? this._ownerWritableStream === void 0 ? m(Ai("abort")) : Wp(this, l) : m(Jr("abort"));
        }
        /**
        ...
        close() {
          ...
          return l === void 0 ? m(Ai("close")) : Fe(l) ? m(new TypeError("Cannot close an already-closing stream")) : Bu(this);
        }
        /**
        ...
        releaseLock() {
          if (!Kr(this))
            throw Jr("releaseLock");
          this._ownerWritableStream !== void 0 && qu(this);
        }
        write(l = void 0) {
          return Kr(this) ? this._ownerWritableStream === void 0 ? m(Ai("write to")) : ju(this, l) : m(Jr("write"));
        }
      }
      Object.defineProperties(nr.prototype, {
        ...
        desiredSize: { enumerable: !0 },
        ready: { enumerable: !0 }
      }), s(nr.prototype.abort, "abort"), s(nr.prototype.close, "close"), s(nr.prototype.releaseLock, "releaseLock"), s(nr.prototype.write, "write"), typeof Symbol.toStringTag == "symbol" && Object.defineProperty(nr.prototype, Symbol.toStringTag, {
        value: "WritableStreamDefaultWriter",
        configurable: !0
      });
      function Kr(o) {
        return !i(o) || !Object.prototype.hasOwnProperty.call(o, "_ownerWritableStream") ? !1 : o instanceof nr;
      }
      function Wp(o, l) {
      ...
      function Hp(o) {
        ...
        return Fe(l) || d === "closed" ? h(void 0) : d === "errored" ? m(l._storedError) : Bu(o);
      }
      function zp(o, l) {
        o._closedPromiseState === "pending" ? Gs(o, l) : em(o, l);
      }
      function Mu(o, l) {
        o._readyPromiseState === "pending" ? Qu(o, l) : rm(o, l);
      }
      function Gp(o) {
        const l = o._ownerWritableStream, d = l._state;
        return d === "errored" || d === "erroring" ? null : d === "closed" ? 0 : zu(l._writableStreamController);
      }
      function qu(o) {
      ...
      class $n {
        ...
        error(l = void 0) {
          if (!Ws(this))
            throw zs("error");
          this._controlledWritableStream._state === "writable" && Gu(this, l);
        }
        /** @internal */
        [Ne](l) {
      ...
      function Vp(o, l, d, w) {
        ...
        }, l.write !== void 0 ? O = (z) => l.write(z, v) : O = () => h(void 0), l.close !== void 0 ? j = () => l.close() : j = () => h(void 0), l.abort !== void 0 ? J = (z) => l.abort(z) : J = () => h(void 0), Hu(o, v, P, O, j, J, d, w);
      }
      function Zo(o) {
      ...
      function Ti(o, l) {
        o._controlledWritableStream._state === "writable" && Gu(o, l);
      }
      function Kp(o) {
        const l = o._controlledWritableStream;
        Pn(l), bi(o);
        const d = o._closeAlgorithm();
        Zo(o), E(d, () => (jt(l), null), (w) => (vt(l, w), null));
      }
      function Jp(o, l) {
      ...
      function Ku(o, l, d, w, v, P) {
        ...
        return f((ne, oe) => {
          ...
          if (or(o, O._closedPromise, (G) => (w ? bt(!0, G) : at(() => Ee(l, G), !0, G), null)), or(l, j._closedPromise, (G) => (v ? bt(!0, G) : at(() => Rt(o, G), !0, G), null)), Ye(o, O._closedPromise, () => (d ? bt() : at(() => Hp(j)), null)), Fe(l) || l._state === "closed") {
          ...
          function at(G, le, be) {
            if (J)
              return;
            J = !0, l._state === "writable" && !Fe(l) ? C(Rr(), ht) : ht();
            function ht() {
              return E(G(), () => ar(le, be), (kn) => ar(!0, kn)), null;
            }
          }
          function bt(G, le) {
            J || (J = !0, l._state === "writable" && !Fe(l) ? C(Rr(), () => ar(G, le)) : ar(G, le));
          }
          function ar(G, le) {
            return qu(j), D(O), P !== void 0 && P.removeEventListener("abort", me), G ? oe(le) : ne(void 0), null;
          }
        });
      }
      class ir {
        ...
        [Z](l) {
          ...
          if (this._queue.length > 0) {
            const w = bi(this);
            this._closeRequested && this._queue.length === 0 ? (oa(this), $i(d)) : Pi(this), l._chunkSteps(w);
          } else
            rt(d, l), Pi(this);
        }
        /** @internal */
      ...
      Object.defineProperties(ir.prototype, {
        ...
        error: { enumerable: !0 },
        desiredSize: { enumerable: !0 }
      }), s(ir.prototype.close, "close"), s(ir.prototype.enqueue, "enqueue"), s(ir.prototype.error, "error"), typeof Symbol.toStringTag == "symbol" && Object.defineProperty(ir.prototype, Symbol.toStringTag, {
        value: "ReadableStreamDefaultController",
        configurable: !0
      });
      function ia(o) {
        return !i(o) || !Object.prototype.hasOwnProperty.call(o, "_controlledReadableStream") ? !1 : o instanceof ir;
      }
      function Pi(o) {
        if (!Ju(o))
          return;
        ...
        o._pulling = !0;
        const d = o._pullAlgorithm();
        E(d, () => (o._pulling = !1, o._pullAgain && (o._pullAgain = !1, Pi(o)), null), (w) => (Ct(o, w), null));
      }
      function Ju(o) {
        const l = o._controlledReadableStream;
        return !Dn(o) || !o._started ? !1 : !!(vr(l) && Xt(l) > 0 || Qs(o) > 0);
      }
      function oa(o) {
      ...
      function Zr(o) {
        if (!Dn(o))
          return;
        const l = o._controlledReadableStream;
        o._closeRequested = !0, o._queue.length === 0 && (oa(o), $i(l));
      }
      function On(o, l) {
        if (!Dn(o))
          return;
      ...
      function Ct(o, l) {
        const d = o._controlledReadableStream;
        d._state === "readable" && (yt(o), oa(o), rc(d, l));
      }
      function Qs(o) {
      ...
      function Zu(o, l, d, w, v, P, O) {
        ...
        const j = d();
        E(h(j), () => (l._started = !0, Pi(l), null), (J) => (Ct(l, J), null));
      }
      function um(o, l, d, w) {
        const v = Object.create(ir.prototype);
        let P, O, j;
        l.start !== void 0 ? P = () => l.start(v) : P = () => {
        }, l.pull !== void 0 ? O = () => l.pull(v) : O = () => h(void 0), l.cancel !== void 0 ? j = (J) => l.cancel(J) : j = () => h(void 0), Zu(o, v, P, O, j, d, w);
      }
      function aa(o) {
        return new TypeError(`ReadableStreamDefaultController.prototype.${o} can only be used on a ReadableStreamDefaultController`);
      }
      function cm(o, l) {
        return Jt(o._readableStreamController) ? dm(o) : fm(o);
      }
      function fm(o, l) {
        const d = ye(o);
        ...
        function Tt() {
          return w ? (v = !0, h(void 0)) : (w = !0, Wr(d, {
            _chunkSteps: (at) => {
              M(() => {
                v = !1;
                const bt = at, ar = at;
                P || On(z._readableStreamController, bt), O || On(ne._readableStreamController, ar), w = !1, v && Tt();
              });
            },
            _closeSteps: () => {
              w = !1, P || Zr(z._readableStreamController), O || Zr(ne._readableStreamController), (!P || !O) && oe(void 0);
            },
            _errorSteps: () => {
              w = !1;
            }
        ...
        return z = Ii(or, Tt, Fn), ne = Ii(or, Tt, Rr), A(d._closedPromise, (Ye) => (Ct(z._readableStreamController, Ye), Ct(ne._readableStreamController, Ye), (!P || !O) && oe(void 0), null)), [z, ne];
      }
      function dm(o) {
              ...
              M(() => {
                ...
                if (!P && !O)
                  try {
                    ...
                    nt(z._readableStreamController, kn), nt(ne._readableStreamController, kn), oe(Rt(o, kn));
                    return;
                  }
                P || er(z._readableStreamController, be), O || er(ne._readableStreamController, ht), d = !1, w ? or() : v && Ye();
              });
            },
            _closeSteps: () => {
              d = !1, P || Yr(z._readableStreamController), O || Yr(ne._readableStreamController), z._readableStreamController._pendingPullIntos.length > 0 && vn(z._readableStreamController, 0), ne._readableStreamController._pendingPullIntos.length > 0 && vn(ne._readableStreamController, 0), (!P || !O) && oe(void 0);
            },
            _errorSteps: () => {
              d = !1;
            }
          ...
          zo(l, G, 1, {
            _chunkSteps: (Ln) => {
              M(() => {
                ...
                const xn = le ? O : P;
                if (le ? P : O)
                  xn || Cn(be._readableStreamController, Ln);
                else {
                  let mc;
                  try {
                    mc = $o(Ln);
                  ...
                  xn || Cn(be._readableStreamController, Ln), er(ht._readableStreamController, mc);
                }
                d = !1, w ? or() : v && Ye();
              });
            },
            _closeSteps: (Ln) => {
              d = !1;
              const xn = le ? O : P, pa = le ? P : O;
              xn || Yr(be._readableStreamController), pa || Yr(ht._readableStreamController), Ln !== void 0 && (xn || Cn(be._readableStreamController, Ln), !pa && ht._readableStreamController._pendingPullIntos.length > 0 && vn(ht._readableStreamController, 0)), (!xn || !pa) && oe(void 0);
            },
            _errorSteps: () => {
              d = !1;
            }
        ...
        function or() {
          if (d)
            return w = !0, h(void 0);
          d = !0;
          const G = Sn(z._readableStreamController);
          return G === null ? Fn() : Rr(G._view, !1), h(void 0);
        }
        function Ye() {
          if (d)
            return v = !0, h(void 0);
          d = !0;
          const G = Sn(ne._readableStreamController);
          return G === null ? Fn() : Rr(G._view, !0), h(void 0);
        }
        function at(G) {
          if (P = !0, j = G, O) {
            const le = Hr([j, J]), be = Rt(o, le);
            oe(be);
          }
          return me;
        }
        ...
        return z = tc(ar, or, at), ne = tc(ar, Ye, bt), Tt(l), [z, ne];
      }
      function hm(o) {
      ...
      function mm(o) {
        ...
        function v() {
          ...
          return I(j, (J) => {
            ...
            if (Vr(J))
              Zr(l._readableStreamController);
            else {
              const ne = $s(J);
              On(l._readableStreamController, ne);
            }
          });
        }
        function P(O) {
        ...
        function w() {
          ...
          return I(P, (O) => {
            ...
            if (O.done)
              ...
              const j = O.value;
              On(l._readableStreamController, j);
            }
          });
        }
        function v(P) {
      ...
      class We {
        constructor(l = {}, d = {}) {
          l === void 0 ? l = null : F(l, "First parameter");
          const w = Er(d, "Second parameter"), v = ym(l, "First parameter");
         ...
         */
        cancel(l = void 0) {
          return Sr(this) ? vr(this) ? m(new TypeError("Cannot cancel a stream that already has a reader")) : Rt(this, l) : m(en("cancel"));
        }
        getReader(l = void 0) {
          if (!Sr(this))
            throw en("getReader");
        ...
        pipeThrough(l, d = {}) {
          if (!Sr(this))
            throw en("pipeThrough");
          T(l, 1, "pipeThrough");
          const w = Cm(l, "First parameter"), v = ec(d, "Second parameter");
          if (vr(this))
            throw new TypeError("ReadableStream.prototype.pipeThrough cannot be used on a locked ReadableStream");
          if (de(w.writable))
            throw new TypeError("ReadableStream.prototype.pipeThrough cannot be used on a locked WritableStream");
          const P = Ku(this, w.writable, v.preventClose, v.preventAbort, v.preventCancel, v.signal);
          return $(P), w.readable;
        }
        pipeTo(l, d = {}) {
          if (!Sr(this))
          ...
          let w;
          try {
            w = ec(d, "Second parameter");
          } catch (v) {
            return m(v);
          }
          return vr(this) ? m(new TypeError("ReadableStream.prototype.pipeTo cannot be used on a locked ReadableStream")) : de(l) ? m(new TypeError("ReadableStream.prototype.pipeTo cannot be used on a locked WritableStream")) : Ku(this, l, w.preventClose, w.preventAbort, w.preventCancel, w.signal);
        }
        /**
      ...
      Object.defineProperties(We, {
        ...
        configurable: !0
      }), Object.defineProperty(We.prototype, Gr, {
        value: We.prototype.values,
        writable: !0,
        configurable: !0
      });
      function Ii(o, l, d, w = 1, v = () => 1) {
        const P = Object.create(We.prototype);
        Ks(P);
        const O = Object.create(ir.prototype);
        return Zu(P, O, o, l, d, w, v), P;
      }
      function tc(o, l, d) {
      ...
      function rc(o, l) {
        ...
        const d = o._reader;
        d !== void 0 && (V(d, l), Nt(d) ? To(d, l) : Ri(d, l));
      }
      function en(o) {
      ...
      const ic = (o) => o.byteLength;
      s(ic, "size");
      class sa {
        constructor(l) {
          T(l, 1, "ByteLengthQueuingStrategy"), l = nc(l, "First parameter"), this._byteLengthQueuingStrategyHighWaterMark = l.highWaterMark;
        }
        /**
      ...
      class la {
        constructor(l) {
          T(l, 1, "CountQueuingStrategy"), l = nc(l, "First parameter"), this._countQueuingStrategyHighWaterMark = l.highWaterMark;
        }
        /**
         * Returns the high water mark provided to the constructor.
         */
      ...
      class ua {
        constructor(l = {}, d = {}, w = {}) {
          l === void 0 && (l = null);
          const v = Er(d, "Second parameter"), P = Er(w, "Third parameter"), O = Rm(l, "First parameter");
          if (O.readableType !== void 0)
            throw new RangeError("Invalid readableType specified");
          if (O.writableType !== void 0)
            throw new RangeError("Invalid writableType specified");
          const j = qt(P, 0), J = An(P), z = qt(v, 1), ne = An(v);
          let oe;
          const me = f((Tt) => {
            oe = Tt;
          });
      ...
      function $m(o, l, d, w, v, P) {
        ...
        o._readable = Ii(O, ne, oe, v, P), o._backpressure = void 0, o._backpressureChangePromise = void 0, o._backpressureChangePromise_resolve = void 0, ca(o, !0), o._transformStreamController = void 0;
      }
      function cc(o) {
      ...
      function Js(o, l) {
        da(o._transformStreamController), Ti(o._writable._writableStreamController, l), Zs(o);
      }
      function Zs(o) {
      ...
      function Dm(o, l) {
        const d = Object.create(Cr.prototype);
        let w, v, P;
        l.transform !== void 0 ? w = (O) => l.transform(O, d) : w = (O) => {
          try {
            return dc(d, O), h(void 0);
          } catch (j) {
            return m(j);
          }
      ...
      function Nm(o, l) {
        fc(o._controlledTransformStream, l);
      }
      function hc(o, l) {
        const d = o._transformAlgorithm(l);
        return I(d, void 0, (w) => {
          throw fc(o._controlledTransformStream, w), w;
        });
      }
      function Fm(o) {
      ...
      function Lm(o, l) {
        ...
        return da(d), E(v, () => (w._state === "errored" ? Nn(d, w._storedError) : (Ct(w._readableStreamController, l), el(d)), null), (P) => (Ct(w._readableStreamController, P), Nn(d, P), null)), d._finishPromise;
      }
      function xm(o) {
        ...
        return da(l), E(w, () => (d._state === "errored" ? Nn(l, d._storedError) : (Zr(d._readableStreamController), el(l)), null), (v) => (Ct(d._readableStreamController, v), Nn(l, v), null)), l._finishPromise;
      }
      function Um(o) {
      ...
      function Bm(o, l) {
        ...
        const v = d._cancelAlgorithm(l);
        return da(d), E(v, () => (w._state === "errored" ? Nn(d, w._storedError) : (Ti(w._writableStreamController, l), Zs(o), el(d)), null), (P) => (Ti(w._writableStreamController, P), Zs(o), Nn(d, P), null)), d._finishPromise;
      }
      function ha(o) {
  ...
  for (const r of e)
    if ("stream" in r)
      ...
      if (t) {
        ...
        for (; n !== i; ) {
          const a = Math.min(i - n, _c), s = r.buffer.slice(n, n + a);
      ...
      for (; n !== i.size; ) {
        const s = await i.slice(n, Math.min(i.size, n + _c)).arrayBuffer();
        n += s.byteLength, yield new Uint8Array(s);
      }
    }
}
...
const Pd = (fn = class {
  ...
  constructor(t = [], r = {}) {
    ...
    for (const a of t) {
      let s;
      ArrayBuffer.isView(a) ? s = new Uint8Array(a.buffer.slice(a.byteOffset, a.byteOffset + a.byteLength)) : a instanceof ArrayBuffer ? s = new Uint8Array(a.slice(0)) : a instanceof fn ? s = a : s = n.encode(`${a}`), Wt(this, ni, ke(this, ni) + (ArrayBuffer.isView(s) ? s.byteLength : s.size)), ke(this, cr).push(s);
    }
    Wt(this, rs, `${r.endings === void 0 ? "transparent" : r.endings}`);
    const i = r.type === void 0 ? "" : String(r.type);
    Wt(this, co, /^[\x20-\x7E]*$/.test(i) ? i : "");
  }
  /**
  ...
  async text() {
    ...
    let r = "";
    for await (const n of rl(ke(this, cr), !1))
  ...
  slice(t = 0, r = this.size, n = "") {
    ...
    const u = Math.max(s - a, 0), c = ke(this, cr), g = [];
    let f = 0;
    for (const m of c) {
      if (f >= u)
        break;
    ...
    const h = new fn([], { type: String(n).toLowerCase() });
    return Wt(h, ni, u), Wt(h, cr, g), h;
  }
...
}, cr = new WeakMap(), co = new WeakMap(), ni = new WeakMap(), rs = new WeakMap(), fn);
...
const ng = (Ed = class extends Ma {
  ...
  constructor(r, n, i = {}) {
    ...
    Number.isNaN(a) || Wt(this, fo, a), Wt(this, ho, String(n));
  }
  get name() {
    return ke(this, ho);
  }
...
}, fo = new WeakMap(), ho = new WeakMap(), Ed), ig = ng;
/*! formdata-polyfill. MIT License. Jimmy Wärting <https://jimmy.warting.se/opensource> */
var { toStringTag: qi, iterator: og, hasInstance: ag } = Symbol, Ec = Math.random, sg = "append,set,get,getAll,delete,keys,values,entries,forEach,constructor".split(","), Sc = (e, t, r) => (e += "", /^(Blob|File)$/.test(t && t[qi]) ? [(r = r !== void 0 ? r + "" : t[qi] == "File" ? t.name : "blob", e), t.name !== r || t[qi] == "blob" ? new ig([t], r, t) : t] : [e, t + ""]), nl = (e, t) => (t ? e : e.replace(/\r?\n|\r/g, `\r
`)).replace(/\n/g, "%0A").replace(/\r/g, "%0D").replace(/"/g, "%22"), tn = (e, t, r) => {
  if (t.length < r)
...
const xl = (Sd = class {
  ...
  append(...t) {
    tn("append", arguments, 2), ke(this, _t).push(Sc(...t));
  }
  delete(t) {
    tn("delete", arguments, 1), t += "", Wt(this, _t, ke(this, _t).filter(([r]) => r !== t));
  }
  get(t) {
    tn("get", arguments, 1), t += "";
    for (var r = ke(this, _t), n = r.length, i = 0; i < n; i++) if (r[i][0] === t) return r[i][1];
    return null;
  }
  getAll(t, r) {
    return tn("getAll", arguments, 1), r = [], t += "", ke(this, _t).forEach((n) => n[0] === t && r.push(n[1])), r;
  }
  has(t) {
    return tn("has", arguments, 1), t += "", ke(this, _t).some((r) => r[0] === t);
  }
  forEach(t, r) {
    tn("forEach", arguments, 1);
    for (var [n, i] of this) t.call(r, i, n, this);
  }
  set(...t) {
    tn("set", arguments, 2);
    var r = [], n = !0;
    t = Sc(...t), ke(this, _t).forEach((i) => {
      i[0] === t[0] ? n && (n = !r.push(t)) : r.push(i);
    }), n && r.push(t), Wt(this, _t, r);
  }
  *entries() {
    yield* ke(this, _t);
  }
...
function lg(e, t = Ma) {
  var r = `${Ec()}${Ec()}`.replace(/\./g, "").slice(-28).padStart(32, "-"), n = [], i = `--${r}\r
...
const qa = Symbol.toStringTag, Id = (e) => typeof e == "object" && typeof e.append == "function" && typeof e.delete == "function" && typeof e.get == "function" && typeof e.getAll == "function" && typeof e.has == "function" && typeof e.set == "function" && typeof e.sort == "function" && e[qa] === "URLSearchParams", ja = (e) => e && typeof e == "object" && typeof e.arrayBuffer == "function" && typeof e.type == "string" && typeof e.stream == "function" && typeof e.constructor == "function" && /^(Blob|File)$/.test(e[qa]), ug = (e) => typeof e == "object" && (e[qa] === "AbortSignal" || e[qa] === "EventTarget"), cg = (e, t) => {
  const r = new URL(t).hostname, n = new URL(e).hostname;
  return r === n || r.endsWith(`.${n}`);
}, fg = (e, t) => {
  const r = new URL(t).protocol, n = new URL(e).protocol;
  return r === n;
}, dg = Vm(Gt.pipeline), st = Symbol("Body internals");
class Vi {
  constructor(t, {
    size: r = 0
  } = {}) {
    let n = null;
    t === null ? t = null : Id(t) ? t = He.from(t.toString()) : ja(t) || He.isBuffer(t) || (Ba.isAnyArrayBuffer(t) ? t = He.from(t) : ArrayBuffer.isView(t) ? t = He.from(t.buffer, t.byteOffset, t.byteLength) : t instanceof Gt || (t instanceof xl ? (t = lg(t), n = t.type.split("=")[1]) : t = He.from(String(t))));
    let i = t;
    He.isBuffer(t) ? i = Gt.Readable.from(t) : ja(t) && (i = Gt.Readable.from(t.stream())), this[st] = {
      body: t,
      stream: i,
      boundary: n,
      disturbed: !1,
      error: null
    }, this.size = r, t instanceof Gt && t.on("error", (a) => {
      const s = a instanceof as ? a : new zt(`Invalid response body while trying to fetch ${this.url}: ${a.message}`, "system", a);
      this[st].error = s;
    });
  }
  get body() {
  ...
  async formData() {
    ...
    const { toFormData: r } = await import("./multipart-parser-i7cyLqrG.js");
  ...
  try {
    for await (const i of t) {
      if (e.size > 0 && n + i.length > e.size) {
        const a = new zt(`content size at ${e.url} over limit: ${e.size}`, "max-size");
        throw t.destroy(a), a;
      }
      n += i.length, r.push(i);
    }
  } catch (i) {
    throw i instanceof as ? i : new zt(`Invalid response body while trying to fetch ${e.url}: ${i.message}`, "system", i);
  }
  if (t.readableEnded === !0 || t._readableState.ended === !0)
    try {
      return r.every((i) => typeof i == "string") ? He.from(r.join("")) : He.concat(r, n);
    } catch (i) {
      throw new zt(`Could not create Buffer from response body for ${e.url}: ${i.message}`, "system", i);
    }
  else
    throw new zt(`Premature close of server response while trying to fetch ${e.url}`);
}
const su = (e, t) => {
  let r, n, { body: i } = e[st];
  if (e.bodyUsed)
    throw new Error("cannot clone body after it is used");
  return i instanceof Gt && typeof i.getBoundary != "function" && (r = new Ua({ highWaterMark: t }), n = new Ua({ highWaterMark: t }), i.pipe(r), i.pipe(n), e[st].stream = r, i = n), i;
}, hg = ns(
  (e) => e.getBoundary(),
  "form-data doesn't follow the spec and requires special treatment. Use alternative package",
  "https://github.com/node-fetch/node-fetch/issues/1167"
), $d = (e, t) => e === null ? null : typeof e == "string" ? "text/plain;charset=UTF-8" : Id(e) ? "application/x-www-form-urlencoded;charset=UTF-8" : ja(e) ? e.type || null : He.isBuffer(e) || Ba.isAnyArrayBuffer(e) || ArrayBuffer.isView(e) ? null : e instanceof xl ? `multipart/form-data; boundary=${t[st].boundary}` : e && typeof e.getBoundary == "function" ? `multipart/form-data;boundary=${hg(e)}` : e instanceof Gt ? null : "text/plain;charset=UTF-8", pg = (e) => {
  const { body: t } = e[st];
...
const yg = /* @__PURE__ */ new Set([301, 302, 303, 307, 308]), Od = (e) => yg.has(e), At = Symbol("Response internals");
class pt extends Vi {
...
function Sg(e, { referrerURLCallback: t, referrerOriginCallback: r } = {}) {
  ...
  switch (n) {
    ...
    case "unsafe-url":
      return a;
    case "strict-origin":
      return Mn(a) && !Mn(u) ? "no-referrer" : s.toString();
    case "strict-origin-when-cross-origin":
      return a.origin === u.origin ? a : Mn(a) && !Mn(u) ? "no-referrer" : s;
    case "same-origin":
      return a.origin === u.origin ? a : "no-referrer";
    case "origin-when-cross-origin":
      return a.origin === u.origin ? a : s;
    case "no-referrer-when-downgrade":
      return Mn(a) && !Mn(u) ? "no-referrer" : a;
    default:
...
const Le = Symbol("Request internals"), Di = (e) => typeof e == "object" && typeof e[Le] == "object", Cg = ns(
  () => {
  },
...
class Yi extends Vi {
  constructor(t, r = {}) {
    let n;
    if (Di(t) ? n = new URL(t.url) : (n = new URL(t), t = {}), n.username !== "" || n.password !== "")
      throw new TypeError(`${n} is an url with embedded credentials.`);
    let i = r.method || t.method || "GET";
    if (/^(delete|get|head|options|post|put)$/i.test(i) && (i = i.toUpperCase()), !Di(r) && "data" in r && Cg(), (r.body != null || Di(t) && t.body !== null) && (i === "GET" || i === "HEAD"))
      throw new TypeError("Request with GET/HEAD method cannot have body");
    const a = r.body ? r.body : Di(t) && t.body !== null ? su(t) : null;
    super(a, {
...
const Rg = (e) => {
  const { parsedURL: t } = e[Le], r = new fr(e[Le].headers);
...
async function ur(e, t) {
  return new Promise((r, n) => {
    ...
    const f = () => {
      ...
      n(E), i.body && i.body instanceof Gt.Readable && i.body.destroy(E), !(!g || !g.body) && g.body.emit("error", E);
    };
    if (c && c.aborted) {
      f();
      return;
    ...
    m.on("error", (E) => {
      n(new zt(`request to ${i.url} failed, reason: ${E.message}`, "system", E)), b();
    }), Pg(m, (E) => {
      ...
      if (Od(E.statusCode)) {
        ...
        try {
          ...
          if (i.redirect !== "manual") {
            n(new zt(`uri requested responds with an invalid redirect URL: ${x}`, "invalid-redirect")), b();
            return;
          }
        }
        switch (i.redirect) {
          case "error":
            n(new zt(`uri requested responds with a redirect, redirect mode is set to error: ${i.url}`, "no-redirect")), b();
            return;
          case "manual":
            break;
          case "follow": {
            ...
            if (i.counter >= i.follow) {
              n(new zt(`maximum redirect reached at: ${i.url}`, "max-redirect")), b();
              return;
            }
            const ae = {
            ...
            if (E.statusCode !== 303 && i.body && t.body instanceof Gt.Readable) {
              n(new zt("Cannot follow redirect with body being a readable stream", "unsupported-redirect")), b();
              return;
            }
            ...
            const Q = vg(C);
            Q && (ae.referrerPolicy = Q), r(ur(new Yi(te, ae))), b();
            return;
          }
          default:
      ...
      const M = {
        flush: Un.Z_SYNC_FLUSH,
        finishFlush: Un.Z_SYNC_FLUSH
      };
      if ($ === "gzip" || $ === "x-gzip") {
        A = Bn(A, Un.createGunzip(M), (x) => {
          x && n(x);
        }), g = new pt(A, I), r(g);
        return;
      }
      if ($ === "deflate" || $ === "x-deflate") {
        const x = Bn(E, new Ua(), (te) => {
          te && n(te);
        });
        x.once("data", (te) => {
          (te[0] & 15) === 8 ? A = Bn(A, Un.createInflate(), (ae) => {
            ae && n(ae);
          }) : A = Bn(A, Un.createInflateRaw(), (ae) => {
            ae && n(ae);
          }), g = new pt(A, I), r(g);
        }), x.once("end", () => {
          g || (g = new pt(A, I), r(g));
      ...
      if ($ === "br") {
        A = Bn(A, Un.createBrotliDecompress(), (x) => {
          x && n(x);
        }), g = new pt(A, I), r(g);
        return;
      }
...
async function $g() {
  if (Bl.size) return;
  (await ur("https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/champion-summary.json").then((r) => r.json())).forEach((r) => Bl.set(r.id, r.alias));
}
function Og(e) {
  return Bl.get(e) ?? "";
}
...
async function Ng() {
  if (sr = new jm({
    ...
    show: !1,
    webPreferences: {
      preload: ln.join(__dirname, "..", "..", "preload", "index.js"),
      contextIsolation: !0,
      nodeIntegration: !1,
      sandbox: !0
    }
  }), process.env.VITE_DEV_SERVER_URL)
    await sr.loadURL(process.env.VITE_DEV_SERVER_URL);
  else {
    const e = ln.join(process.cwd(), "dist");
    await sr.loadFile(ln.join(e, "index.html"));
  }
  return sr.once("ready-to-show", () => sr == null ? void 0 : sr.show()), sr;
}
function Fg(e) {
...
var Ar = Km, Bg = process.cwd, Na = null, Mg = process.env.GRACEFUL_FS_PLATFORM || process.platform;
...
if (typeof process.chdir == "function") {
  var Cc = process.chdir;
  process.chdir = function(e) {
    Na = null, Cc.call(process, e);
  }, Object.setPrototypeOf && Object.setPrototypeOf(process.chdir, Cc);
}
var qg = jg;
function jg(e) {
  ...
  function t(f) {
    f.lchmod = function(h, m, b) {
      ...
      var b = f.openSync(h, Ar.O_WRONLY | Ar.O_SYMLINK, m), E = !0, C;
      try {
  ...
  function r(f) {
    Ar.hasOwnProperty("O_SYMLINK") && f.futimes ? (f.lutimes = function(h, m, b, E) {
      f.open(h, Ar.O_SYMLINK, function(C, A) {
        if (C) {
          E && E(C);
          return;
        }
      ...
      var E = f.openSync(h, Ar.O_SYMLINK), C, A = !0;
      try {
...
function Hg(e) {
  ...
  function r(n, i) {
    ...
    Rc.call(this), this.path = n, this.fd = null, this.writable = !0, this.flags = "w", this.encoding = "binary", this.mode = 438, this.bytesWritten = 0, i = i || {};
...
var Se = Br, Yg = qg, Xg = Wg, Qg = zg, ga = au, qe, Wa;
...
var un = Kg;
ga.debuglog ? un = ga.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (un = function() {
...
if (!Se[qe]) {
  var Jg = Ue[qe] || [];
  Fd(Se, Jg), Se.close = function(e) {
    function t(r, n) {
      return e.call(Se, r, function(i) {
        i || Tc(), typeof n == "function" && n.apply(this, arguments);
      });
    }
...
function lu(e) {
  ...
  function r(S, re, Z) {
    ...
    function X(ce, L, D, B) {
      return t(ce, L, function(N) {
        N && (N.code === "EMFILE" || N.code === "ENFILE") ? qn([X, [ce, L, D], N, B || Date.now(), Date.now()]) : typeof D == "function" && D.apply(this, arguments);
      });
    }
  }
  var n = e.writeFile;
  ...
  function i(S, re, Z, X) {
    ...
    function ce(L, D, B, N, q) {
      return n(L, D, B, function(U) {
        U && (U.code === "EMFILE" || U.code === "ENFILE") ? qn([ce, [L, D, B, N], U, q || Date.now(), Date.now()]) : typeof N == "function" && N.apply(this, arguments);
      });
    }
  }
  var a = e.appendFile;
  ...
  function h(S, re, Z) {
    ...
    function ce(L, D, B, N) {
      return function(q, U) {
        q && (q.code === "EMFILE" || q.code === "ENFILE") ? qn([
          X,
          [L, D, B],
          q,
          N || Date.now(),
...
function qn(e) {
  un("ENQUEUE", e[0].name, e[1]), Se[qe].push(e), uu();
}
var ya;
function Tc() {
...
function uu() {
  if (clearTimeout(ya), ya = void 0, Se[qe].length !== 0) {
    ...
    if (i === void 0)
      ...
      u >= g ? (un("RETRY", t.name, r), t.apply(null, r.concat([i]))) : Se[qe].push(e);
    }
...
const Ld = pn, { checkPath: xd } = kd, Ud = (e) => {
  const t = { mode: 511 };
  return typeof e == "number" ? e : { ...t, ...e }.mode;
};
cu.makeDir = async (e, t) => (xd(e), Ld.mkdir(e, {
  mode: Ud(t),
  recursive: !0
}));
cu.makeDirSync = (e, t) => (xd(e), Ld.mkdirSync(e, {
  mode: Ud(t),
  recursive: !0
}));
...
const ii = pn, xe = ve, ay = au;
function sy(e, t, r) {
  const n = r.dereference ? (i) => ii.stat(i, { bigint: !0 }) : (i) => ii.lstat(i, { bigint: !0 });
  return Promise.all([
    n(e),
    n(t).catch((i) => {
...
function ly(e, t, r) {
  let n;
  const i = r.dereference ? (s) => ii.statSync(s, { bigint: !0 }) : (s) => ii.lstatSync(s, { bigint: !0 }), a = i(e);
  try {
    n = i(t);
  } catch (s) {
...
function qd(e, t, r, n, i) {
  ...
  ii.stat(s, { bigint: !0 }, (u, c) => u ? u.code === "ENOENT" ? i() : i(u) : go(t, c) ? i(new Error(ss(e, r, n))) : qd(e, t, s, n, i));
}
function jd(e, t, r, n) {
...
const lt = Ze, Xi = ve, fy = Yt.mkdirs, dy = mn.pathExists, hy = Md.utimesMillis, Qi = ui;
function py(e, t, r, n) {
  typeof r == "function" && !n ? (n = r, r = {}) : typeof r == "function" && (r = { filter: r }), n = n || function() {
    ...
    Qi.checkParentPaths(e, s, t, "copy", (c) => c ? n(c) : r.filter ? Wd(Ac, u, e, t, r, n) : Ac(u, e, t, r, n));
  });
}
...
function my(e, t, r, n, i) {
  return n.filter ? Wd(Ha, e, t, r, n, i) : Ha(e, t, r, n, i);
}
...
function gy(e, t, r, n, i, a) {
  return t ? yy(e, r, n, i, a) : Hd(e, r, n, i, a);
}
function yy(e, t, r, n, i) {
  if (n.overwrite)
    lt.unlink(r, (a) => a ? i(a) : Hd(e, t, r, n, i));
...
function by(e, t, r, n) {
  return wy(e) ? _y(r, e, (i) => i ? n(i) : Pc(e, t, r, n)) : Pc(e, t, r, n);
}
function wy(e) {
  return (e & 128) === 0;
}
...
function Sy(e, t, r, n, i, a) {
  return t ? zd(r, n, i, a) : vy(e.mode, r, n, i, a);
}
function vy(e, t, r, n, i) {
  lt.mkdir(r, (a) => {
    if (a) return i(a);
    zd(t, r, n, (s) => s ? i(s) : ls(r, e, i));
  });
}
function zd(e, t, r, n) {
  lt.readdir(e, (i, a) => i ? n(i) : Gd(a, e, t, r, n));
}
...
function Cy(e, t, r, n, i, a) {
  ...
  Qi.checkPaths(s, u, "copy", i, (c, g) => {
    if (c) return a(c);
    const { destStat: f } = g;
    my(f, s, u, i, (h) => h ? a(h) : Gd(e, r, n, i, a));
  });
}
...
var Ay = py;
const ze = Ze, Ki = ve, Py = Yt.mkdirsSync, Iy = Md.utimesMillisSync, Ji = ui;
function $y(e, t, r) {
...
function Oy(e, t, r, n) {
  ...
  return ze.existsSync(i) || Py(i), Vd(e, t, r, n);
}
function Dy(e, t, r, n) {
...
function Ny(e, t, r, n, i) {
  return t ? Fy(e, r, n, i) : Yd(e, r, n, i);
}
function Fy(e, t, r, n) {
  if (n.overwrite)
    return ze.unlinkSync(r), Yd(e, t, r, n);
  if (n.errorOnExist)
...
function By(e, t, r, n, i) {
  return t ? Xd(r, n, i) : My(e.mode, r, n, i);
}
function My(e, t, r, n) {
  return ze.mkdirSync(r), Xd(t, r, n), du(r, e);
}
function Xd(e, t, r) {
...
const Ic = Ze, Qd = ve, ge = Cd, Zi = process.platform === "win32";
function Kd(e) {
  [
    "unlink",
    "chmod",
    ...
    e[r] = e[r] || Ic[r], r = r + "Sync", e[r] = e[r] || Ic[r];
  }), e.maxBusyTries = e.maxBusyTries || 3;
}
function pu(e, t, r) {
  let n = 0;
  typeof t == "function" && (r = t, t = {}), ge(e, "rimraf: missing path"), ge.strictEqual(typeof e, "string", "rimraf: path should be a string"), ge.strictEqual(typeof r, "function", "rimraf: callback function required"), ge(t, "rimraf: invalid options argument provided"), ge.strictEqual(typeof t, "object", "rimraf: options should be object"), Kd(t), $c(e, t, function i(a) {
    if (a) {
      if ((a.code === "EBUSY" || a.code === "ENOTEMPTY" || a.code === "EPERM") && n < t.maxBusyTries) {
        n++;
        const s = n * 100;
        return setTimeout(() => $c(e, t, i), s);
      }
    ...
    t.unlink(e, (a) => {
      if (a) {
        if (a.code === "ENOENT")
          return r(null);
        if (a.code === "EPERM")
          return Zi ? Oc(e, t, a, r) : Fa(e, t, a, r);
        if (a.code === "EISDIR")
          return Fa(e, t, a, r);
      }
      return r(a);
...
function Jd(e, t) {
  let r;
  t = t || {}, Kd(t), ge(e, "rimraf: missing path"), ge.strictEqual(typeof e, "string", "rimraf: path should be a string"), ge(t, "rimraf: missing options"), ge.strictEqual(typeof t, "object", "rimraf: options should be object");
  try {
    r = t.lstatSync(e);
  } catch (n) {
    if (n.code === "ENOENT")
      return;
    n.code === "EPERM" && Zi && Dc(e, t, n);
  }
  try {
...
function Vy(e, t) {
  if (ge(e), ge(t), t.readdirSync(e).forEach((r) => Jd(Qd.join(e, r), t)), Zi) {
    const r = Date.now();
    do
      try {
...
var Yy = pu;
pu.sync = Jd;
const za = Ze, Xy = Je.fromCallback, Zd = Yy;
function Qy(e, t) {
...
const Jy = Je.fromPromise, eh = pn, th = ve, rh = Yt, nh = us, Nc = Jy(async function(t) {
  let r;
  try {
...
const e0 = Je.fromCallback, ih = ve, Or = Ze, oh = Yt;
function t0(e, t) {
  function r() {
    Or.writeFile(e, "", (n) => {
      if (n) return t(n);
  ...
  Or.stat(e, (n, i) => {
    ...
    Or.stat(a, (s, u) => {
      ...
      u.isDirectory() ? r() : Or.readdir(a, (c) => {
        if (c) return t(c);
      });
    });
  });
...
function r0(e) {
  ...
  try {
    Or.statSync(r).isDirectory() || Or.readdirSync(r);
  } catch (n) {
...
const i0 = Je.fromCallback, ah = ve, $r = Ze, sh = Yt, o0 = mn.pathExists, { areIdentical: lh } = ui;
function a0(e, t, r) {
  function n(i, a) {
    $r.link(i, a, (s) => {
      if (s) return r(s);
...
function s0(e, t) {
  ...
  return $r.existsSync(n) || sh.mkdirsSync(n), $r.linkSync(e, t);
}
var l0 = {
  createLink: i0(a0),
  createLinkSync: s0
};
const Dr = ve, ji = Ze, u0 = mn.pathExists;
function c0(e, t, r) {
  if (Dr.isAbsolute(e))
...
const g0 = Je.fromCallback, ch = ve, Pt = pn, fh = Yt, y0 = fh.mkdirs, b0 = fh.mkdirsSync, dh = d0, w0 = dh.symlinkPaths, _0 = dh.symlinkPathsSync, hh = m0, E0 = hh.symlinkType, S0 = hh.symlinkTypeSync, v0 = mn.pathExists, { areIdentical: ph } = ui;
function C0(e, t, r, n) {
...
const { createFile: Lc, createFileSync: xc } = n0, { createLink: Uc, createLinkSync: Bc } = l0, { createSymlink: Mc, createSymlinkSync: qc } = T0;
var A0 = {
  // file
  createFile: Lc,
  createFileSync: xc,
...
const cs = Je, { stringify: mh, stripBom: gh } = mu;
async function $0(e, t = {}) {
  typeof t == "string" && (t = { encoding: t });
  const r = t.fs || oi, n = "throws" in t ? t.throws : !0;
...
const B0 = Je.fromCallback, Wi = Ze, yh = ve, bh = Yt, M0 = mn.pathExists;
function q0(e, t, r, n) {
...
function j0(e, ...t) {
  ...
  bh.mkdirsSync(r), Wi.writeFileSync(e, ...t);
}
var gu = {
  outputFile: B0(q0),
  outputFileSync: j0
...
var J0 = Ke;
const Z0 = Ze, Ml = ve, eb = hu.copy, wh = us.remove, tb = Yt.mkdirp, rb = mn.pathExists, jc = ui;
function nb(e, t, r, n) {
  typeof r == "function" && (n = r, r = {}), r = r || {};
  const i = r.overwrite || r.clobber || !1;
  jc.checkPaths(e, t, "move", r, (a, s) => {
    if (a) return n(a);
    const { srcStat: u, isChangingCase: c = !1 } = s;
    jc.checkParentPaths(e, u, t, "move", (g) => {
      if (g) return n(g);
      if (ib(t)) return Wc(e, t, i, c, n);
      tb(Ml.dirname(t), (f) => f ? n(f) : Wc(e, t, i, c, n));
    });
  });
}
function ib(e) {
...
function Wc(e, t, r, n, i) {
  ...
  if (r)
    return wh(t, (a) => a ? i(a) : sl(e, t, r, i));
...
var ab = nb;
const _h = Ze, ql = ve, sb = hu.copySync, Eh = us.removeSync, lb = Yt.mkdirpSync, Hc = ui;
function ub(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = Hc.checkPathsSync(e, t, "move", r);
  return Hc.checkParentPathsSync(e, i, t, "move"), cb(t) || lb(ql.dirname(t)), fb(e, t, n, a);
}
function cb(e) {
...
function fb(e, t, r, n) {
  ...
  if (r)
    return Eh(t), ll(e, t, r);
  if (_h.existsSync(t)) throw new Error("dest already exists.");
  return ll(e, t, r);
}
function ll(e, t, r) {
  try {
...
kr.CancellationToken = yb;
class jl extends Error {
  constructor() {
    super("cancelled");
  }
}
kr.CancellationError = jl;
var ci = {};
...
var Qe = {}, Wl = { exports: {} }, wa = { exports: {} }, ul, zc;
function wb() {
  if (zc) return ul;
  zc = 1;
...
var _a = { exports: {} }, fl, Yc;
function Eb() {
  return Yc || (Yc = 1, fl = (e, t = process.argv) => {
...
function Sb() {
  if (Xc) return dl;
  Xc = 1;
  const e = os, t = Td, r = Eb(), { env: n } = process;
  let i;
...
Qe.parseJson = Fb;
Qe.configureRequestOptionsFromUrl = Ch;
Qe.configureRequestUrl = bu;
Qe.safeGetHeader = ri;
Qe.configureRequestOptions = Va;
Qe.safeStringifyJson = Ya;
const Ab = mo, Pb = Cb, Ib = Br, $b = po, vh = li, Ob = kr, Kc = ci, Db = yo, Ni = (0, Pb.default)("electron-builder");
...
class Ga {
  ...
  doApiRequest(t, r, n, i = 0) {
    return Ni.enabled && Ni(`Request: ${Ya(t)}`), r.createPromise((a, s, u) => {
  ...
  handleResponse(t, r, n, i, a, s, u) {
    var c;
    if (Ni.enabled && Ni(`Response: ${t.statusCode} ${t.statusMessage}, request options: ${Ya(r)}`), t.statusCode === 404) {
...
`));
    ...
    const g = (c = t.statusCode) !== null && c !== void 0 ? c : 0, f = g >= 300 && g < 400, h = ri(t, "location");
    if (f && h != null) {
    ...
    t.on("error", a), t.on("data", (b) => m += b), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const b = ri(t, "content-type"), E = b != null && (Array.isArray(b) ? b.find((C) => C.includes("json")) != null : b.includes("json"));
          a(Hl(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
...
class zl extends $b.Transform {
  ...
  validate() {
    if (this._actual == null)
      throw (0, Kc.newError)("Not finished yet", "ERR_STREAM_NOT_FINISHED");
    if (this._actual !== this.expected)
      throw (0, Kc.newError)(`${this.algorithm} checksum mismatch, expected ${this.expected}, got ${this._actual}`, "ERR_CHECKSUM_MISMATCH");
    return null;
  }
}
...
function Lb(e, t) {
  if (!kb(ri(t, "X-Checksum-Sha2"), e.options.sha2, e.callback))
    return;
  const r = [];
  if (e.options.onProgress != null) {
    const s = ri(t, "content-length");
...
ai.nil = ai.UUID = void 0;
const Ph = mo, Ih = ci, Hb = "options.name must be either a string or a Buffer", Jc = (0, Ph.randomBytes)(16);
Jc[0] = Jc[0] | 1;
const La = {}, ue = [];
for (let e = 0; e < 256; e++) {
...
function zb(e, t, r, n, i = Hi.ASCII) {
  ...
  if (typeof e != "string" && !Buffer.isBuffer(e))
    throw (0, Ih.newError)(Hb, "ERR_INVALID_UUID_NAME");
  ...
  switch (i) {
    case Hi.BINARY:
      ...
      break;
    case Hi.OBJECT:
      u[6] = u[6] & 15 | r, u[8] = u[8] & 63 | 128, c = new hn(u);
      break;
    default:
...
ai.nil = new hn("00000000-0000-0000-0000-000000000000");
var bo = {}, $h = {};
(function(e) {
  (function(t) {
    ...
    function ie(y, p) {
      if (y.opt.xmlns) {
        ...
        for (var pe = 0, we = y.attribList.length; pe < we; pe++) {
          var Oe = y.attribList[pe], Ae = Oe[0], mt = Oe[1], ye = U(Ae, !0), rt = ye.prefix, jr = ye.local, Xt = rt === "" ? "" : F.ns[rt] || "", pr = {
            name: Ae,
            value: mt,
            prefix: rt,
            local: jr,
          ...
          rt && rt !== "xmlns" && !Xt && (N(y, "Unbound namespace prefix: " + JSON.stringify(rt)), pr.uri = rt), y.tag.attributes[Ae] = pr, X(y, "onattribute", pr);
        }
...
class Oh {
  ...
  getElements(t, r = !1) {
    return this.elements === null ? [] : this.elements.filter((n) => ef(n, t, r));
  }
...
function rw(e, t) {
  ...
  for (c = 1; c <= t.linesBefore && !(s - c < 0); c++)
    g = hl(
      ...
      h
    ), u = Bi.repeat(" ", t.indent) + pl((e.line - c + 1).toString(), f) + " | " + g.str + `
` + u;
  for (g = hl(e.buffer, n[s], i[s], e.position, h), u += Bi.repeat(" ", t.indent) + pl((e.line + 1).toString(), f) + " | " + g.str + `
`, u += Bi.repeat("-", t.indent + f + 3 + g.pos) + `^
...
Gl.prototype.extend = function(t) {
  ...
  return i.implicit = (this.implicit || []).concat(r), i.explicit = (this.explicit || []).concat(n), i.compiledImplicit = rf(i, "implicit"), i.compiledExplicit = rf(i, "explicit"), i.compiledTypeMap = lw(i.compiledImplicit, i.compiledExplicit), i;
};
var Fh = Gl, uw = et, kh = new uw("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: function(e) {
    return e !== null ? e : "";
  }
}), cw = et, Lh = new cw("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: function(e) {
    return e !== null ? e : [];
  }
}), fw = et, xh = new fw("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
var Bh = new hw("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: pw,
  construct: mw,
  predicate: gw,
...
var Mh = new yw("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: bw,
  construct: ww,
  predicate: _w,
...
var qh = new Sw("tag:yaml.org,2002:int", {
  kind: "scalar",
  resolve: Tw,
  construct: Aw,
  predicate: Pw,
...
var Wh = new Iw("tag:yaml.org,2002:float", {
  kind: "scalar",
  resolve: Ow,
  construct: Dw,
  predicate: kw,
...
var Yh = new Lw("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: xw,
  construct: Uw,
  instanceOf: Date,
...
var Xh = new Mw("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: qw
...
var Qh = new jw("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: Ww,
  construct: Hw,
  predicate: Gw,
...
var Kh = new Vw("tag:yaml.org,2002:omap", {
  kind: "sequence",
  resolve: Qw,
  construct: Kw
...
var Jh = new Jw("tag:yaml.org,2002:pairs", {
  kind: "sequence",
  resolve: e_,
  construct: t_
...
var Zh = new r_("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: i_,
  construct: o_
}), vu = zh.extend({
...
}), an = $t, ep = wo, a_ = nw, s_ = vu, Lr = Object.prototype.hasOwnProperty, Xa = 1, tp = 2, rp = 3, Qa = 4, gl = 1, l_ = 2, nf = 3, u_ = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, c_ = /[\x85\u2028\u2029]/, f_ = /[,\[\]\{\}]/, np = /^(?:!|!!|![a-z\-]+!)$/i, ip = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function of(e) {
...
function sp(e, t) {
  ...
  return r.snippet = a_(r), new ep(t, r);
}
function H(e, t) {
  throw sp(e, t);
}
...
var sf = {
  ...
  TAG: function(t, r, n) {
    var i, a;
    n.length !== 2 && H(t, "TAG directive accepts exactly two arguments"), i = n[0], a = n[1], np.test(i) || H(t, "ill-formed tag handle (first argument) of the TAG directive"), Lr.call(t.tagMap, i) && H(t, 'there is a previously declared suffix for "' + i + '" tag handle'), ip.test(a) || H(t, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
...
function lf(e, t, r, n) {
  ...
  for (an.isObject(r) || H(e, "cannot merge mappings; the provided source object is unacceptable"), i = Object.keys(r), s = 0, u = i.length; s < u; s += 1)
    a = i[s], Lr.call(t, a) || (t[a] = r[a], n[a] = !0);
}
function Qn(e, t, r, n, i, a, s, u, c) {
  var g, f;
  if (Array.isArray(i))
    for (i = Array.prototype.slice.call(i), g = 0, f = i.length; g < f; g += 1)
      Array.isArray(i[g]) && H(e, "nested arrays are not supported inside keys"), typeof i == "object" && of(i[g]) === "[object Object]" && (i[g] = "[object Object]");
  if (typeof i == "object" && of(i) === "[object Object]" && (i = "[object Object]"), i = String(i), t === null && (t = {}), n === "tag:yaml.org,2002:merge")
    if (Array.isArray(a))
    ...
    !e.json && !Lr.call(r, i) && Lr.call(t, i) && (e.line = s || e.line, e.lineStart = u || e.lineStart, e.position = c || e.position, H(e, "duplicated mapping key")), i === "__proto__" ? Object.defineProperty(t, i, {
      configurable: !0,
      enumerable: !0,
      writable: !0,
      value: a
...
function y_(e, t, r) {
  ...
  if (b = e.input.charCodeAt(e.position), ut(b) || Xn(b) || b === 35 || b === 38 || b === 42 || b === 33 || b === 124 || b === 62 || b === 39 || b === 34 || b === 37 || b === 64 || b === 96 || (b === 63 || b === 45) && (i = e.input.charCodeAt(e.position + 1), ut(i) || r && Xn(i)))
    return !1;
  for (e.kind = "scalar", e.result = "", a = s = e.position, u = !1; b !== 0; ) {
    if (b === 58) {
      if (i = e.input.charCodeAt(e.position + 1), ut(i) || r && Xn(i))
        break;
    } else if (b === 35) {
      if (n = e.input.charCodeAt(e.position - 1), ut(n))
        break;
    } else {
      if (e.position === e.lineStart && hs(e) || r && Xn(b))
        break;
      if (Vt(b))
    ...
    u && (Nr(e, a, s, !1), Ru(e, e.line - c), a = s = e.position, u = !1), cn(b) || (s = e.position + 1), b = e.input.charCodeAt(++e.position);
  }
  return Nr(e, a, s, !1), e.result ? !0 : (e.kind = h, e.result = m, !1);
}
function b_(e, t) {
  var r, n, i;
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (Nr(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        n = e.position, e.position++, i = e.position;
      else
        return !0;
    else Vt(r) ? (Nr(e, n, i, !0), Ru(e, $e(e, !1, t)), n = i = e.position) : e.position === e.lineStart && hs(e) ? H(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
...
function w_(e, t) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (u = e.input.charCodeAt(e.position)) !== 0; ) {
    if (u === 34)
      return Nr(e, r, e.position, !0), e.position++, !0;
    if (u === 92) {
      if (Nr(e, r, e.position, !0), u = e.input.charCodeAt(++e.position), Vt(u))
        $e(e, !1, t);
      else if (u < 256 && op[u])
      ...
      r = n = e.position;
    } else Vt(u) ? (Nr(e, r, n, !0), Ru(e, $e(e, !1, t)), r = n = e.position) : e.position === e.lineStart && hs(e) ? H(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
...
function E_(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; h !== 0; )
    if (h = e.input.charCodeAt(++e.position), h === 43 || h === 45)
      gl === i ? i = h === 43 ? nf : l_ : H(e, "repeat of a chomping mode identifier");
    else if ((f = p_(h)) >= 0)
  ...
  for (; h !== 0; ) {
    ...
    if (!s && e.lineIndent > u && (u = e.lineIndent), Vt(h)) {
      c++;
      continue;
    }
    if (e.lineIndent < u) {
      i === nf ? e.result += an.repeat(`
`, a ? 1 + c : c) : i === gl && a && (e.result += `
`);
      break;
    }
    for (n ? cn(h) ? (g = !0, e.result += an.repeat(`
`, a ? 1 + c : c)) : g ? (g = !1, e.result += an.repeat(`
`, c + 1)) : c === 0 ? a && (e.result += " ") : e.result += an.repeat(`
`, c) : e.result += an.repeat(`
`, a ? 1 + c : c), a = !0, s = !0, c = 0, r = e.position; !Vt(h) && h !== 0; )
      h = e.input.charCodeAt(++e.position);
    Nr(e, r, e.position, !1);
  }
  return !0;
...
function uf(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = a), c = e.input.charCodeAt(e.position); c !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, H(e, "tab characters must not be used in indentation")), !(c !== 45 || (s = e.input.charCodeAt(e.position + 1), !ut(s)))); ) {
    ...
    if (r = e.line, si(e, t, rp, !1, !0), a.push(e.result), $e(e, !0, -1), c = e.input.charCodeAt(e.position), (e.line === r || e.lineIndent > t) && c !== 0)
...
function S_(e, t, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = h), $ = e.input.charCodeAt(e.position); $ !== 0; ) {
    if (!A && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, H(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, ($ === 63 || $ === 58) && ut(n))
      $ === 63 ? (A && (Qn(e, h, m, b, E, null, s, u, c), b = E = C = null), I = !0, A = !0, i = !0) : A ? (A = !1, i = !0) : H(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, $ = n;
    else {
      if (s = e.line, u = e.lineStart, c = e.position, !si(e, r, tp, !1, !0))
        break;
      if (e.line === a) {
        for ($ = e.input.charCodeAt(e.position); cn($); )
          $ = e.input.charCodeAt(++e.position);
        if ($ === 58)
          $ = e.input.charCodeAt(++e.position), ut($) || H(e, "a whitespace character is expected after the key-value separator within a block mapping"), A && (Qn(e, h, m, b, E, null, s, u, c), b = E = C = null), I = !0, A = !1, i = !1, b = e.tag, E = e.result;
        else if (I)
    ...
    if ((e.line === a || e.lineIndent > t) && (A && (s = e.line, u = e.lineStart, c = e.position), si(e, t, Qa, !0, i) && (A ? E = e.result : C = e.result), A || (Qn(e, h, m, b, E, C, s, u, c), b = E = C = null), $e(e, !0, -1), $ = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && $ !== 0)
      H(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return A && Qn(e, h, m, b, E, null, s, u, c), I && (e.tag = g, e.anchor = f, e.kind = "mapping", e.result = h), I;
}
function v_(e) {
  var t, r = !1, n = !1, i, a, s;
  ...
  return r ? e.tag = a : Lr.call(e.tagMap, i) ? e.tag = e.tagMap[i] + a : i === "!" ? e.tag = "!" + a : i === "!!" ? e.tag = "tag:yaml.org,2002:" + a : H(e, 'undeclared tag handle "' + i + '"'), !0;
}
function C_(e) {
  var t, r;
  if (r = e.input.charCodeAt(e.position), r !== 38) return !1;
  for (e.anchor !== null && H(e, "duplication of an anchor property"), r = e.input.charCodeAt(++e.position), t = e.position; r !== 0 && !ut(r) && !Xn(r); )
...
function R_(e) {
  ...
  for (n = e.input.charCodeAt(++e.position), t = e.position; n !== 0 && !ut(n) && !Xn(n); )
    n = e.input.charCodeAt(++e.position);
  return e.position === t && H(e, "name of an alias node must contain at least one character"), r = e.input.slice(t, e.position), Lr.call(e.anchorMap, r) || H(e, 'unidentified alias "' + r + '"'), e.result = e.anchorMap[r], $e(e, !0, -1), !0;
}
function si(e, t, r, n, i) {
  var a, s, u, c = 1, g = !1, f = !1, h, m, b, E, C, A;
  if (e.listener !== null && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, a = s = u = Qa === r || rp === r, n && $e(e, !0, -1) && (g = !0, e.lineIndent > t ? c = 1 : e.lineIndent === t ? c = 0 : e.lineIndent < t && (c = -1)), c === 1)
    for (; v_(e) || C_(e); )
      $e(e, !0, -1) ? (g = !0, u = a, e.lineIndent > t ? c = 1 : e.lineIndent === t ? c = 0 : e.lineIndent < t && (c = -1)) : u = !1;
  if (u && (u = g || i), (c === 1 || Qa === r) && (Xa === r || tp === r ? C = t : C = t + 1, A = e.position - e.lineStart, c === 1 ? u && (uf(e, A) || S_(e, A, C)) || __(e, C) ? f = !0 : (s && E_(e, C) || b_(e, C) || w_(e, C) ? f = !0 : R_(e) ? (f = !0, (e.tag !== null || e.anchor !== null) && H(e, "alias node should not have any properties")) : y_(e, C, Xa === r) && (f = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : c === 0 && (f = u && uf(e, A))), e.tag === null)
    ...
    if (Lr.call(e.typeMap[e.kind || "fallback"], e.tag))
...
function T_(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (s = e.input.charCodeAt(e.position)) !== 0 && ($e(e, !0, -1), s = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || s !== 37)); ) {
    ...
    s !== 0 && Cu(e), Lr.call(sf, n) ? sf[n](e, n, i) : Ka(e, 'unknown document directive "' + n + '"');
  }
  if ($e(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, $e(e, !0, -1)) : a && H(e, "directives end mark is expected"), si(e, e.lineIndent - 1, Qa, !1, !0), $e(e, !0, -1), e.checkLineBreaks && c_.test(e.input.slice(t, e.position)) && Ka(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && hs(e)) {
...
Eu.loadAll = A_;
Eu.load = P_;
var up = {}, ps = $t, _o = wo, I_ = vu, cp = Object.prototype.toString, fp = Object.prototype.hasOwnProperty, Tu = 65279, $_ = 9, to = 10, O_ = 13, D_ = 32, N_ = 33, F_ = 34, Vl = 35, k_ = 37, L_ = 38, x_ = 39, U_ = 42, dp = 44, B_ = 45, Ja = 58, M_ = 61, q_ = 62, j_ = 63, W_ = 64, hp = 91, pp = 93, H_ = 96, mp = 123, z_ = 124, gp = 125, Ge = {};
Ge[0] = "\\0";
Ge[7] = "\\a";
Ge[8] = "\\b";
Ge[9] = "\\t";
...
function df(e, t, r) {
  ...
  return (
    ...
    (r ? (
      // c = flow-in
      n
    ) : n && e !== dp && e !== hp && e !== pp && e !== mp && e !== gp) && e !== Vl && !(t === Ja && !i) || ff(t) && !Za(t) && e === Vl || t === Ja && i
  );
}
function Z_(e) {
  return no(e) && e !== Tu && !Za(e) && e !== B_ && e !== j_ && e !== Ja && e !== dp && e !== hp && e !== pp && e !== mp && e !== gp && e !== Vl && e !== L_ && e !== U_ && e !== N_ && e !== z_ && e !== M_ && e !== q_ && e !== x_ && e !== F_ && e !== k_ && e !== W_ && e !== H_;
}
function eE(e) {
  return !Za(e) && e !== Ja;
}
...
var bp = 1, Xl = 2, wp = 3, _p = 4, Yn = 5;
function tE(e, t, r, n, i, a, s, u) {
  var c, g = 0, f = null, h = !1, m = !1, b = n !== -1, E = -1, C = Z_(Mi(e, 0)) && eE(Mi(e, e.length - 1));
  if (t || s)
  ...
  return !h && !m ? C && !s && !i(e) ? bp : a === ro ? Yn : Xl : r > 9 && yp(e) ? Yn : s ? a === ro ? Yn : Xl : m ? _p : wp;
}
  ...
  e.dump = function() {
    ...
    switch (tE(
      ...
      case Xl:
        return "'" + t.replace(/'/g, "''") + "'";
      case wp:
        return "|" + hf(t, e.indent) + pf(cf(t, a));
      case _p:
        return ">" + hf(t, e.indent) + pf(cf(nE(t, s), a));
      case Yn:
        return '"' + iE(t) + '"';
      default:
...
function nE(e, t) {
  for (var r = /(\n+)([^\n]*)/g, n = function() {
    var g = e.indexOf(`
`);
    return g = g !== -1 ? g : e.length, r.lastIndex = g, mf(e.slice(0, g), t);
  }(), i = e[0] === `
` || e[0] === " ", a, s; s = r.exec(e); ) {
    var u = s[1], c = s[2];
    a = c[0] === " ", n += u + (!i && !a && c !== "" ? `
...
function iE(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = Mi(e, i), n = Ge[r], !n && no(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || X_(r);
  return t;
}
function oE(e, t, r) {
  var n = "", i = e.tag, a, s, u;
...
function gf(e, t, r, n) {
  ...
  for (s = 0, u = r.length; s < u; s += 1)
    c = r[s], e.replacer && (c = e.replacer.call(r, String(s), c)), (dr(e, t + 1, c, !0, !0, !1, !0) || typeof c > "u" && dr(e, t + 1, null, !0, !0, !1, !0)) && ((!n || i !== "") && (i += Yl(e, t)), e.dump && to === e.dump.charCodeAt(0) ? i += "-" : i += "- ", i += e.dump);
  e.tag = a, e.dump = i || "[]";
}
function aE(e, t, r) {
  var n = "", i = e.tag, a = Object.keys(r), s, u, c, g, f;
  for (s = 0, u = a.length; s < u; s += 1)
    f = "", n !== "" && (f += ", "), e.condenseFlow && (f += '"'), c = a[s], g = r[c], e.replacer && (g = e.replacer.call(r, c, g)), dr(e, t, c, !1, !1) && (e.dump.length > 1024 && (f += "? "), f += e.dump + (e.condenseFlow ? '"' : "") + ":" + (e.condenseFlow ? "" : " "), dr(e, t, g, !1, !1) && (f += e.dump, n += f));
  e.tag = i, e.dump = "{" + n + "}";
}
function sE(e, t, r, n) {
  ...
  for (u = 0, c = s.length; u < c; u += 1)
    m = "", (!n || i !== "") && (m += Yl(e, t)), g = s[u], f = r[g], e.replacer && (f = e.replacer.call(r, g, f)), dr(e, t + 1, g, !0, !0, !0) && (h = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, h && (e.dump && to === e.dump.charCodeAt(0) ? m += "?" : m += "? "), m += e.dump, h && (m += Yl(e, t)), dr(e, t + 1, f, !0, h) && (e.dump && to === e.dump.charCodeAt(0) ? m += ":" : m += ": ", m += e.dump, i += m));
  e.tag = a, e.dump = i || "{}";
}
function yf(e, t, r) {
  var n, i, a, s, u, c;
...
function dr(e, t, r, n, i, a, s) {
  e.tag = null, e.dump = r, yf(e, r, !1) || yf(e, r, !0);
  ...
  if (f && (h = e.duplicates.indexOf(r), m = h !== -1), (e.tag !== null && e.tag !== "?" || m || e.indent !== 2 && t > 0) && (i = !1), m && e.usedDuplicates[h])
    ...
    if (f && m && !e.usedDuplicates[h] && (e.usedDuplicates[h] = !0), u === "[object Object]")
      ...
      n && e.dump.length !== 0 ? (e.noArrayIndent && !s && t > 0 ? gf(e, t - 1, e.dump, i) : gf(e, t, e.dump, i), m && (e.dump = "&ref_" + h + e.dump)) : (oE(e, t, e.dump), m && (e.dump = "&ref_" + h + " " + e.dump));
...
je.Type = et;
je.Schema = Fh;
je.FAILSAFE_SCHEMA = Uh;
je.JSON_SCHEMA = Hh;
je.CORE_SCHEMA = zh;
je.DEFAULT_SCHEMA = vu;
je.load = Ep.load;
je.loadAll = Ep.loadAll;
je.dump = cE.dump;
je.YAMLException = wo;
je.types = {
  binary: Qh,
...
ms.Lazy = fE;
var Kl = { exports: {} };
const dE = "2.0.0", Sp = 256, hE = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, pE = 16, mE = Sp - 6, gE = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
const Sa = ys, { MAX_LENGTH: wf, MAX_SAFE_INTEGER: va } = gs, { safeRe: Ca, t: Ra } = Eo, SE = Pu, { compareIdentifiers: Wn } = Cp;
let vE = class Ht {
  constructor(t, r) {
    if (r = SE(r), t instanceof Ht) {
  ...
  compare(t) {
    if (Sa("SemVer.compare", this.version, this.options, t), !(t instanceof Ht)) {
  ...
  compareMain(t) {
    return t instanceof Ht || (t = new Ht(t, this.options)), Wn(this.major, t.major) || Wn(this.minor, t.minor) || Wn(this.patch, t.patch);
  }
  comparePre(t) {
  ...
  inc(t, r, n) {
    ...
    switch (t) {
      ...
      case "pre": {
        ...
        if (r) {
          let a = [r, i];
          n === !1 && (a = [r]), Wn(this.prerelease[0], r) === 0 ? isNaN(this.prerelease[1]) && (this.prerelease = a) : this.prerelease = a;
        }
        break;
      }
      default:
...
var $E = IE;
const Ef = tt, OE = (e, t, r, n, i) => {
  typeof r == "string" && (i = n, n = r, r = void 0);
  try {
    return new Ef(
      e instanceof Ef ? e.version : e,
      r
    ).inc(t, n, i).version;
  } catch {
    return null;
...
var DE = OE;
const Sf = fi, NE = (e, t) => {
  const r = Sf(e, null, !0), n = Sf(t, null, !0), i = r.compare(n);
  if (i === 0)
    return null;
...
var GE = zE;
const vf = tt, VE = (e, t, r) => new vf(e, r).compare(new vf(t, r));
var Ot = VE;
const YE = Ot, XE = (e, t, r) => YE(t, e, r);
var QE = XE;
const KE = Ot, JE = (e, t) => KE(e, t, !0);
var ZE = JE;
const Cf = tt, eS = (e, t, r) => {
  const n = new Cf(e, r), i = new Cf(t, r);
...
var aS = oS;
const sS = Ot, lS = (e, t, r) => sS(e, t, r) > 0;
var bs = lS;
const uS = Ot, cS = (e, t, r) => uS(e, t, r) < 0;
var $u = cS;
const fS = Ot, dS = (e, t, r) => fS(e, t, r) === 0;
var Rp = dS;
const hS = Ot, pS = (e, t, r) => hS(e, t, r) !== 0;
var Tp = pS;
const mS = Ot, gS = (e, t, r) => mS(e, t, r) >= 0;
var Ou = gS;
const yS = Ot, bS = (e, t, r) => yS(e, t, r) <= 0;
var Du = bS;
const wS = Rp, _S = Tp, ES = bs, SS = Ou, vS = $u, CS = Du, RS = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var Ap = RS;
const TS = tt, AS = fi, { safeRe: Ta, t: Aa } = Eo, PS = (e, t) => {
  if (e instanceof TS)
    return e;
...
function ws() {
  ...
  bl = t;
  const r = Pu, { safeRe: n, t: i } = Eo, a = Ap, s = ys, u = tt, c = Dt();
  return bl;
}
const DS = Dt(), NS = (e, t, r) => {
  try {
    t = new DS(t, r);
  } catch {
    return !1;
...
var _s = NS;
const FS = Dt(), kS = (e, t) => new FS(e, t).set.map((r) => r.map((n) => n.value).join(" ").trim().split(" "));
var LS = kS;
const xS = tt, US = Dt(), BS = (e, t, r) => {
...
var HS = WS;
const wl = tt, zS = Dt(), Af = bs, GS = (e, t) => {
  e = new zS(e, t);
  let r = new wl("0.0.0");
...
var QS = XS;
const KS = tt, Pp = ws(), { ANY: JS } = Pp, ZS = Dt(), ev = _s, Pf = bs, If = $u, tv = Du, rv = Ou, nv = (e, t, r, n) => {
  ...
  for (let g = 0; g < t.set.length; ++g) {
    ...
    let h = null, m = null;
    if (f.forEach((b) => {
      b.semver === JS && (b = new Pp(">=0.0.0")), h = h || b, m = m || b, i(b.semver, h.semver, n) ? h = b : s(b.semver, m.semver, n) && (m = b);
...
var uv = lv;
const $f = Dt(), cv = (e, t, r) => (e = new $f(e, r), t = new $f(t, r), e.intersects(t, r));
var fv = cv;
const dv = _s, hv = Ot;
var pv = (e, t, r) => {
  const n = [];
...
const Of = Dt(), Fu = ws(), { ANY: _l } = Fu, ki = _s, ku = Ot, mv = (e, t, r = {}) => {
  if (e === t)
    return !0;
  e = new Of(e, r), t = new Of(t, r);
  let n = !1;
  ...
  return !0;
}, gv = [new Fu(">=0.0.0-0")], Df = [new Fu(">=0.0.0")], yv = (e, t, r) => {
  if (e === t)
    return !0;
  if (e.length === 1 && e[0].semver === _l) {
    if (t.length === 1 && t[0].semver === _l)
      return !0;
    r.includePrerelease ? e = gv : e = Df;
  }
  if (t.length === 1 && t[0].semver === _l) {
  ...
  let i, a;
  for (const b of e)
    b.operator === ">" || b.operator === ">=" ? i = Nf(i, b, r) : b.operator === "<" || b.operator === "<=" ? a = Ff(a, b, r) : n.add(b.semver);
  if (n.size > 1)
    return null;
  let s;
  if (i && a) {
  ...
  for (const b of n) {
    if (i && !ki(b, String(i), r) || a && !ki(b, String(a), r))
      return null;
    for (const E of t)
      if (!ki(b, String(E), r))
        return !1;
  ...
  for (const b of t) {
    if (f = f || b.operator === ">" || b.operator === ">=", g = g || b.operator === "<" || b.operator === "<=", i) {
      if (m && b.semver.prerelease && b.semver.prerelease.length && b.semver.major === m.major && b.semver.minor === m.minor && b.semver.patch === m.patch && (m = !1), b.operator === ">" || b.operator === ">=") {
        if (u = Nf(i, b, r), u === b && u !== i)
          return !1;
      } else if (i.operator === ">=" && !ki(i.semver, String(b), r))
        return !1;
    }
    if (a) {
      if (h && b.semver.prerelease && b.semver.prerelease.length && b.semver.major === h.major && b.semver.minor === h.minor && b.semver.patch === h.patch && (h = !1), b.operator === "<" || b.operator === "<=") {
        if (c = Ff(a, b, r), c === b && c !== a)
          return !1;
      } else if (a.operator === "<=" && !ki(a.semver, String(b), r))
        return !1;
    }
...
var bv = mv;
const El = Eo, kf = gs, wv = tt, Lf = Cp, _v = fi, Ev = AE, Sv = $E, vv = DE, Cv = FE, Rv = xE, Tv = ME, Av = WE, Pv = GE, Iv = Ot, $v = QE, Ov = ZE, Dv = Iu, Nv = nS, Fv = aS, kv = bs, Lv = $u, xv = Rp, Uv = Tp, Bv = Ou, Mv = Du, qv = Ap, jv = IS, Wv = ws(), Hv = Dt(), zv = _s, Gv = LS, Vv = MS, Yv = HS, Xv = VS, Qv = QS, Kv = Nu, Jv = av, Zv = uv, eC = fv, tC = pv, rC = bv;
var Ip = {
  parse: _v,
  valid: Ev,
  clean: Sv,
  ...
  src: El.src,
  tokens: El.t,
  SEMVER_SPEC_VERSION: kf.SEMVER_SPEC_VERSION,
  RELEASE_TYPES: kf.RELEASE_TYPES,
  compareIdentifiers: Lf.compareIdentifiers,
  rcompareIdentifiers: Lf.rcompareIdentifiers
}, So = {}, es = { exports: {} };
es.exports;
(function(e, t) {
  ...
  var Is = Array.prototype, To = Function.prototype, Qt = Object.prototype, hi = p["__core-js_shared__"], pi = To.toString, ft = Qt.hasOwnProperty, Ao = function() {
    var _ = /[^.]+$/.exec(hi && hi.keys && hi.keys.IE_PROTO || "");
    return _ ? "Symbol(src)_1." + _ : "";
  }(), mi = Qt.toString, Po = RegExp(
    "^" + pi.call(ft).replace(ee, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), gi = se ? p.Buffer : void 0, mr = p.Symbol, yn = p.Uint8Array, bn = Qt.propertyIsEnumerable, Hr = Is.splice, Ft = mr ? mr.toStringTag : void 0, gt = Object.getOwnPropertySymbols, kt = gi ? gi.isBuffer : void 0, Io = Nt(Object.keys, Object), gr = _r(p, "DataView"), zr = _r(p, "Map"), Gr = _r(p, "Promise"), wn = _r(p, "Set"), yi = _r(p, "WeakMap"), Vr = _r(Object, "create"), $s = rr(gr), Os = rr(zr), $o = rr(Gr), bi = rr(wn), wi = rr(yi), Oo = mr ? mr.prototype : void 0, yt = Oo ? Oo.valueOf : void 0;
  function Lt(_) {
  ...
  function St(_) {
    var R = this.__data__;
    return Vr ? R[_] !== void 0 : ft.call(R, _);
  }
  function Jt(_, R) {
    var k = this.__data__;
    return this.size += this.has(_) ? 0 : 1, k[_] = Vr && R === void 0 ? n : R, this;
  }
  Lt.prototype.clear = Ds, Lt.prototype.delete = Ns, Lt.prototype.get = Kt, Lt.prototype.has = St, Lt.prototype.set = Jt;
  function dt(_) {
    var R = -1, k = _ == null ? 0 : _.length;
    for (this.clear(); ++R < k; ) {
      var W = _[R];
  ...
  function Do(_) {
    var R = this.__data__, k = er(R, _);
    if (k < 0)
      return !1;
    var W = R.length - 1;
    return k == W ? R.pop() : Hr.call(R, k, 1), --this.size, !0;
  }
  function _i(_) {
    var R = this.__data__, k = er(R, _);
  ...
  function No(_) {
    return er(this.__data__, _) > -1;
  }
  function _n(_, R) {
    var k = this.__data__, W = er(k, _);
    return W < 0 ? (++this.size, k.push([_, R])) : k[W][1] = R, this;
  }
  dt.prototype.clear = Zt, dt.prototype.delete = Do, dt.prototype.get = _i, dt.prototype.has = No, dt.prototype.set = _n;
  function xt(_) {
    var R = -1, k = _ == null ? 0 : _.length;
    for (this.clear(); ++R < k; ) {
      var W = _[R];
  ...
  function ko(_) {
    var R = Rn(this, _).delete(_);
    return this.size -= R ? 1 : 0, R;
  }
  function Lo(_) {
    return Rn(this, _).get(_);
  }
  function xo(_) {
    return Rn(this, _).has(_);
  }
  function Ei(_, R) {
    var k = Rn(this, _), W = k.size;
    return k.set(_, R), this.size += k.size == W ? 0 : 1, this;
  }
  xt.prototype.clear = Fo, xt.prototype.delete = ko, xt.prototype.get = Lo, xt.prototype.has = xo, xt.prototype.set = Ei;
  function yr(_) {
    var R = -1, k = _ == null ? 0 : _.length;
    for (this.__data__ = new xt(); ++R < k; )
      this.add(_[R]);
  }
  function Fs(_) {
  ...
  yr.prototype.add = yr.prototype.push = Fs, yr.prototype.has = ks;
  function Ut(_) {
  ...
  function En(_, R) {
    ...
    if (k instanceof dt) {
      ...
      k = this.__data__ = new xt(W);
    }
    return k.set(_, R), this.size = k.size, this;
  }
  Ut.prototype.clear = Ls, Ut.prototype.delete = Uo, Ut.prototype.get = br, Ut.prototype.has = xs, Ut.prototype.set = En;
  function Yr(_, R) {
    var k = qt(_), W = !k && Tn(_), he = !k && !W && Er(_), K = !k && !W && !he && Xo(_), de = k || W || he || K, Ee = de ? rt(_.length, String) : [], Pe = Ee.length;
    for (var _e in _)
  ...
  function nt(_, R, k) {
    var W = R(_);
    return qt(_) ? W : mt(W, k(_));
  }
  function wr(_) {
    return _ == null ? _ === void 0 ? S : I : Ft && Ft in Object(_) ? jo(_) : zo(_);
  }
  function Sn(_) {
    return Qr(_) && wr(_) == u;
  }
  function Si(_, R, k, W, he) {
    return _ === R ? !0 : _ == null || R == null || !Qr(_) && !Qr(R) ? _ !== _ && R !== R : vn(_, R, k, W, Si, he);
  }
  function vn(_, R, k, W, he, K) {
    var de = qt(_), Ee = qt(R), Pe = de ? c : Bt(_), _e = Ee ? c : Bt(R);
    ...
    if (Ie && !Me)
      return K || (K = new Ut()), de || Xo(_) ? Mo(_, R, k, W, he, K) : vi(_, R, Pe, k, W, he, K);
    if (!(k & i)) {
      var it = Me && ft.call(_, "__wrapped__"), ot = Ve && ft.call(R, "__wrapped__");
      if (it || ot) {
        var jt = it ? _.value() : _, vt = ot ? R.value() : R;
        return K || (K = new Ut()), he(jt, vt, k, W, K);
      }
    }
    return Ie ? (K || (K = new Ut()), Xr(_, R, k, W, he, K)) : !1;
  }
  function Cn(_) {
    if (!Yo(_) || Mt(_))
      return !1;
  ...
  function Bo(_) {
    return Qr(_) && Vo(_.length) && !!Y[wr(_)];
  }
  function Us(_) {
    if (!tr(_))
      return Io(_);
  ...
  function Mo(_, R, k, W, he, K) {
    ...
    if (_e && K.get(R))
      return _e == R;
    var Me = -1, Ve = !0, Ie = k & a ? new yr() : void 0;
    for (K.set(_, R), K.set(R, _); ++Me < Ee; ) {
      var it = _[Me], ot = R[Me];
      if (W)
        var jt = de ? W(ot, it, Me, R, _, K) : W(it, ot, Me, _, R, K);
      if (jt !== void 0) {
        if (jt)
          continue;
        Ve = !1;
      ...
      if (Ie) {
        if (!ye(R, function(vt, Fe) {
          if (!Xt(Ie, Fe) && (it === vt || he(it, vt, k, W, K)))
            return Ie.push(Fe);
        })) {
          Ve = !1;
          break;
  ...
  function vi(_, R, k, W, he, K, de) {
    switch (k) {
      ...
      case Z:
        return !(_.byteLength != R.byteLength || !K(new yn(_), new yn(R)));
      case f:
      case h:
      case A:
        return Ri(+_, +R);
  ...
  function Xr(_, R, k, W, he, K) {
    ...
    for (var jt = de; ++Ve < Pe; ) {
      ...
      jt || (jt = Ie == "constructor");
    }
    if (ot && !jt) {
      var Pn = _.constructor, In = R.constructor;
      Pn != In && "constructor" in _ && "constructor" in R && !(typeof Pn == "function" && Pn instanceof Pn && typeof In == "function" && In instanceof In) && (ot = !1);
    }
  ...
  function Rn(_, R) {
    var k = _.__data__;
    return Ci(R) ? k[typeof R == "string" ? "string" : "hash"] : k.map;
  }
  function _r(_, R) {
    var k = pr(_, R);
  ...
  function jo(_) {
    ...
    var he = mi.call(_);
    return W && (R ? _[Ft] = k : delete _[Ft]), he;
  }
  ...
  (gr && Bt(new gr(new ArrayBuffer(1))) != X || zr && Bt(new zr()) != C || Gr && Bt(Gr.resolve()) != M || wn && Bt(new wn()) != ae || yi && Bt(new yi()) != re) && (Bt = function(_) {
    var R = wr(_), k = R == $ ? _.constructor : void 0, W = k ? rr(k) : "";
    if (W)
      switch (W) {
        case $s:
          return X;
  ...
  function tr(_) {
    var R = _ && _.constructor, k = typeof R == "function" && R.prototype || Qt;
    return _ === k;
  }
  function zo(_) {
    return mi.call(_);
  ...
  var Tn = Sn(/* @__PURE__ */ function() {
    return arguments;
  }()) ? Sn : function(_) {
    return Qr(_) && ft.call(_, "callee") && !bn.call(_, "callee");
  }, qt = Array.isArray;
  function An(_) {
...
const iC = mo, oC = Br, xf = nC, nn = Mr, zi = ve;
class aC {
  constructor(t) {
  ...
  async validateDownloadedPath(t, r, n, i) {
    if (this.versionInfo != null && this.file === t && this.fileInfo != null)
      return xf(this.versionInfo, r) && xf(this.fileInfo.info, n.info) && await (0, nn.pathExists)(t) ? t : null;
...
class dC {
  ...
  get appUpdateConfigPath() {
    return this.isPackaged ? Uf.join(process.resourcesPath, "app-update.yml") : Uf.join(this.app.getAppPath(), "dev-app-update.yml");
  }
  get userDataPath() {
...
(function(e) {
  ...
  function r() {
    return dn.session.fromPartition(e.NET_SESSION_NAME, {
      cache: !1
    });
  }
...
var vo = {}, Et = {}, hC = "[object Symbol]", Op = /[\\^$.*+?()[\]{}|]/g, pC = RegExp(Op.source), mC = typeof Ue == "object" && Ue && Ue.Object === Object && Ue, gC = typeof self == "object" && self && self.Object === Object && self, yC = mC || gC || Function("return this")(), bC = Object.prototype, wC = bC.toString, Bf = yC.Symbol, Mf = Bf ? Bf.prototype : void 0, qf = Mf ? Mf.toString : void 0;
function _C(e) {
  if (typeof e == "string")
    return e;
  if (SC(e))
...
function CC(e) {
  return e = vC(e), e && pC.test(e) ? e.replace(Op, "\\$&") : e;
}
var RC = CC;
...
class OC {
  ...
  createRequestOptions(t, r) {
    const n = {};
    return this.requestHeaders == null ? r != null && (n.headers = r) : n.headers = r == null ? this.requestHeaders : { ...this.requestHeaders, ...r }, (0, xr.configureRequestUrl)(t, n), n;
  }
}
De.Provider = OC;
function DC(e, t, r) {
  if (e.length === 0)
    throw (0, xr.newError)("No files provided", "ERR_UPDATER_NO_FILES_PROVIDED");
  const n = e.find((i) => i.url.pathname.toLowerCase().endsWith(`.${t}`));
  return n ?? (r == null ? e[0] : e.find((i) => !r.some((a) => i.url.pathname.toLowerCase().endsWith(`.${a}`))));
}
function NC(e, t, r) {
  if (e == null)
    throw (0, xr.newError)(`Cannot parse update info from ${t} in the latest release artifacts (${r}): rawData: null`, "ERR_UPDATER_INVALID_UPDATE_INFO");
  let n;
  try {
    n = (0, $C.load)(e);
  } catch (i) {
    throw (0, xr.newError)(`Cannot parse update info from ${t} in the latest release artifacts (${r}): ${i.stack || i.message}, rawData: ${e}`, "ERR_UPDATER_INVALID_UPDATE_INFO");
  }
  return n;
}
function Np(e) {
  ...
  throw (0, xr.newError)(`No files provided: ${(0, xr.safeStringifyJson)(e)}`, "ERR_UPDATER_NO_FILES_PROVIDED");
}
function FC(e, t, r = (n) => n) {
  const i = Np(e).map((u) => {
    if (u.sha2 == null && u.sha512 == null)
      throw (0, xr.newError)(`Update info doesn't contain nor sha256 neither sha512 checksum: ${(0, xr.safeStringifyJson)(u)}`, "ERR_UPDATER_NO_CHECKSUM");
    return {
      url: (0, jf.newUrlFromBase)(r(u.url), t),
      info: u
    };
  }), a = e.packages, s = a == null ? null : a[process.arch] || a.ia32;
  return s != null && (i[0].packageInfo = {
    ...s,
    path: (0, jf.newUrlFromBase)(r(s.path), t).href
  }), i;
}
Object.defineProperty(vo, "__esModule", { value: !0 });
vo.GenericProvider = void 0;
const Wf = Be, vl = Et, Cl = De;
  ...
  async getLatestVersion() {
    ...
    for (let n = 0; ; n++)
      try {
        ...
        if (i instanceof Wf.HttpError && i.statusCode === 404)
          throw (0, Wf.newError)(`Cannot find channel "${t}" update info: ${i.stack || i.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND");
...
class LC extends Tl.Provider {
  ...
  async getLatestVersion() {
    const t = new Hf.CancellationToken(), r = (0, Rl.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Rl.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
      const i = await this.httpRequest(n, void 0, t);
      return (0, Tl.parseUpdateInfo)(i, r, n);
    } catch (i) {
      throw (0, Hf.newError)(`Unable to find latest version on ${this.toString()}, please ensure release exists: ${i.stack || i.message}`, "ERR_UPDATER_LATEST_VERSION_NOT_FOUND");
    }
  }
  resolveFiles(t) {
...
Ur.GitHubProvider = Ur.BaseGitHubProvider = void 0;
Ur.computeReleaseNotes = kp;
const lr = Be, Kn = Ip, xC = li, Jn = Et, Zl = De, Al = /\/tag\/([^/]+)$/;
class Fp extends Zl.Provider {
  constructor(t, r, n) {
    super({
      ...n,
      /* because GitHib uses S3 */
      isUseMultipleRangeRequest: !1
    }), this.options = t, this.baseUrl = (0, Jn.newBaseUrl)((0, lr.githubUrl)(t, r));
    const i = r === "github.com" ? "api.github.com" : r;
    this.baseApiUrl = (0, Jn.newBaseUrl)((0, lr.githubUrl)(t, i));
  }
...
class UC extends Fp {
  ...
  async getLatestVersion() {
    var t, r, n, i, a;
    const s = new lr.CancellationToken(), u = await this.httpRequest((0, Jn.newUrlFromBase)(`${this.basePath}.atom`, this.baseUrl), {
      accept: "application/xml, application/atom+xml, text/xml, */*"
    }, s), c = (0, lr.parseXml)(u);
    let g = c.element("entry", !1, "No published versions on GitHub"), f = null;
    try {
      if (this.updater.allowPrerelease) {
        const A = ((t = this.updater) === null || t === void 0 ? void 0 : t.channel) || ((r = Kn.prerelease(this.updater.currentVersion)) === null || r === void 0 ? void 0 : r[0]) || null;
        if (A === null)
          ...
          for (const I of c.getElements("entry")) {
            ...
            if ($ === null)
              continue;
            const M = $[1], x = ((n = Kn.prerelease(M)) === null || n === void 0 ? void 0 : n[0]) || null, te = !A || ["alpha", "beta"].includes(A), ae = x !== null && !["alpha", "beta"].includes(String(x));
...
${u}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    let h, m = "", b = "";
    const E = async (A) => {
      m = (0, Jn.getChannelFilename)(A), b = (0, Jn.newUrlFromBase)(this.getBaseDownloadPath(String(f), m), this.baseUrl);
      const I = this.createRequestOptions(b);
      try {
        return await this.executor.request(I, s);
      } catch ($) {
        throw $ instanceof lr.HttpError && $.statusCode === 404 ? (0, lr.newError)(`Cannot find ${m} in the latest release artifacts (${b}): ${$.stack || $.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : $;
      }
    };
    try {
      let A = this.channel;
      this.updater.allowPrerelease && (!((i = Kn.prerelease(f)) === null || i === void 0) && i[0]) && (A = this.getCustomChannelName(String((a = Kn.prerelease(f)) === null || a === void 0 ? void 0 : a[0]))), h = await E(A);
    } catch (A) {
      if (this.updater.allowPrerelease)
  ...
  async getLatestTagName(t) {
    const r = this.options, n = r.host == null || r.host === "github.com" ? (0, Jn.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl) : new xC.URL(`${this.computeGithubBasePath(`/repos/${r.owner}/${r.repo}/releases`)}/latest`, this.baseApiUrl);
    try {
...
function kp(e, t, r, n) {
  ...
  return i.sort((a, s) => Kn.rcompare(a.version, s.version));
}
var Cs = {};
Object.defineProperty(Cs, "__esModule", { value: !0 });
Cs.KeygenProvider = void 0;
const Gf = Be, Pl = Et, Il = De;
class BC extends Il.Provider {
  ...
  async getLatestVersion() {
    const t = new Gf.CancellationToken(), r = (0, Pl.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Pl.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
      ...
      throw (0, Gf.newError)(`Unable to find latest version on ${this.toString()}, please ensure release exists: ${i.stack || i.message}`, "ERR_UPDATER_LATEST_VERSION_NOT_FOUND");
    }
  }
  resolveFiles(t) {
...
const Hn = Be, MC = je, qC = ve, Vf = li, Yf = Et, jC = Ur, WC = De;
class HC extends jC.BaseGitHubProvider {
  ...
  async getLatestVersion() {
    const t = new Hn.CancellationToken(), r = (0, Yf.getChannelFilename)(this.getDefaultChannelName()), n = await this.getLatestVersionInfo(t), i = n.assets.find((u) => u.name === r);
    if (i == null)
      throw (0, Hn.newError)(`Cannot find ${r} in the release ${n.html_url || n.name}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND");
    const a = new Vf.URL(i.url);
    let s;
    try {
      s = (0, MC.load)(await this.httpRequest(a, this.configureHeaders("application/octet-stream"), t));
    } catch (u) {
      throw u instanceof Hn.HttpError && u.statusCode === 404 ? (0, Hn.newError)(`Cannot find ${r} in the latest release artifacts (${a}): ${u.stack || u.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : u;
    }
  ...
  async getLatestVersionInfo(t) {
    ...
    let n = this.basePath;
    r || (n = `${n}/latest`);
    const i = (0, Yf.newUrlFromBase)(n, this.baseUrl);
    try {
      ...
      throw (0, Hn.newError)(`Unable to find latest version on GitHub (${i}), please ensure a production release exists: ${a.stack || a.message}`, "ERR_UPDATER_LATEST_VERSION_NOT_FOUND");
    }
  }
  get basePath() {
  ...
  resolveFiles(t) {
    return (0, WC.getFileList)(t).map((r) => {
      ...
      if (i == null)
        throw (0, Hn.newError)(`Cannot find asset "${n}" in: ${JSON.stringify(t.assets, null, 2)}`, "ERR_UPDATER_ASSET_NOT_FOUND");
      return {
        url: new Vf.URL(i.url),
        info: r
      };
    });
  }
...
Ss.isUrlProbablySupportMultiRangeRequests = Lp;
Ss.createClient = XC;
const Pa = Be, zC = vs, Xf = vo, GC = Ur, VC = Cs, YC = Rs;
function Lp(e) {
...
function XC(e, t, r) {
  ...
  switch (n) {
    ...
    case "generic": {
      const i = e;
      return new Xf.GenericProvider(i, t, {
        ...r,
...
gn.OperationKind = void 0;
gn.computeOperations = QC;
var sn;
(function(e) {
  e[e.COPY = 0] = "COPY", e[e.DOWNLOAD = 1] = "DOWNLOAD";
})(sn || (gn.OperationKind = sn = {}));
function QC(e, t, r) {
  const n = Kf(e.files), i = Kf(t.files);
  let a = null;
  ...
  for (let C = 0; C < f.checksums.length; E += f.sizes[C], C++) {
    ...
    let $ = m.get(I);
    $ != null && b.get(I) !== A && (r.warn(`Checksum ("${I}") matches, but size differs (old: ${b.get(I)}, new: ${A})`), $ = void 0), $ === void 0 ? (h++, a != null && a.kind === sn.DOWNLOAD && a.end === E ? a.end += A : (a = {
      kind: sn.DOWNLOAD,
      start: E,
      end: E + A
      // oldBlocks: null,
    }, Qf(a, u, I, C))) : a != null && a.kind === sn.COPY && a.end === $ ? a.end += A : (a = {
      kind: sn.COPY,
      start: $,
      end: $ + A
      // oldBlocks: [checksum]
...
di.copyData = xp;
const Ia = Be, ZC = Br, eR = po, tR = gn, Jf = Buffer.from(`\r
\r
`);
var Pr;
(function(e) {
...
function iR(e, t, r, n, i) {
  ...
  for (let h = t.start; h < t.end; h++) {
    const m = t.tasks[h];
    m.kind === ed.OperationKind.DOWNLOAD && (a += `${m.start}-${m.end - 1}, `, u.set(s, h), s++, c.push(m.end - m.start));
  }
  if (s <= 1) {
    const h = (m) => {
      if (m >= t.end) {
      ...
      const b = t.tasks[m++];
      if (b.kind === ed.OperationKind.COPY)
        (0, Zf.copyData)(b, r, t.oldFileFd, i, () => h(m));
      else {
  ...
  const f = e.httpExecutor.createRequest(g, (h) => {
    ...
    const E = new Zf.DataSplitter(r, t, u, b[1] || b[2], c, n);
...
class aR extends oR.Transform {
  constructor(t, r, n) {
    super(), this.progressDifferentialDownloadInfo = t, this.cancellationToken = r, this.onProgress = n, this.start = Date.now(), this.transferred = 0, this.delta = 0, this.expectedBytes = 0, this.index = 0, this.operationType = Zn.COPY, this.nextUpdate = this.start + 1e3;
  }
  _transform(t, r, n) {
    if (this.cancellationToken.cancelled) {
      n(new Error("cancelled"), null);
  ...
  beginFileCopy() {
    this.operationType = Zn.COPY;
  }
  beginRangeDownload() {
    this.operationType = Zn.DOWNLOAD, this.expectedBytes += this.progressDifferentialDownloadInfo.expectedByteCounts[this.index++];
  }
  endRangeDownload() {
...
const Li = Be, $l = Mr, sR = Br, lR = di, uR = li, $a = gn, td = As, cR = Ps;
class fR {
  ...
  createRequestOptions() {
    ...
    return (0, Li.configureRequestUrl)(this.options.newUrl, t), (0, Li.configureRequestOptions)(t), t;
  }
  doDownload(t, r) {
    ...
    return n.info(`Full: ${rd(u)}, To download: ${rd(a)} (${Math.round(a / (u / 100))}%)`), this.downloadFile(i);
  }
  downloadFile(t) {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, u) => {
      ...
      const f = new Li.DigestTransform(this.blockAwareFileInfo.sha512);
      ...
      if (this.options.isUseMultipleRangeRequest) {
        b = (0, td.executeTasksUsingMultipleRangeRequests)(this, t, m, n, u), b(0);
        return;
      }
      let E = 0, C = null;
      ...
      A.redirect = "manual", b = (I) => {
        ...
        const ae = this.httpExecutor.createRequest(A, (Q) => {
          ...
          }), Q.statusCode >= 400 && u((0, Li.createHttpError)(Q)), Q.pipe(m, {
            end: !1
          }), Q.once("end", () => {
        ...
        ae.on("redirect", (Q, Ne, S) => {
          this.logger.info(`Redirect to ${dR(S)}`), C = S, (0, Li.configureRequestUrl)(new uR.URL(C), A), ae.followRedirect();
  ...
  request(t, r) {
    return new Promise((n, i) => {
      const a = this.httpExecutor.createRequest(t, (s) => {
        (0, td.checkIsRangesSupported)(s, i) && (s.on("error", i), s.on("aborted", () => {
...
Fr.NoOpLogger = Fr.AppUpdater = void 0;
const Xe = Be, mR = mo, gR = os, yR = Rd, zn = Mr, bR = je, Ol = ms, rn = ve, on = Ip, nd = So, wR = Es, id = $p, _R = vo, Dl = Ss, ER = Ad, SR = Et, vR = Ts, Gn = qr;
class xu extends yR.EventEmitter {
  ...
  dispatchUpdateDownloaded(t) {
    this.emit(Gn.UPDATE_DOWNLOADED, t);
  }
  async loadUpdateConfig() {
    return this._appUpdateConfigPath == null && (this._appUpdateConfigPath = this.app.appUpdateConfigPath), (0, bR.load)(await (0, zn.readFile)(this._appUpdateConfigPath, "utf-8"));
  }
  ...
  async getOrCreateStagingUserId() {
    const t = rn.join(this.app.userDataPath, ".updaterId");
    try {
      const n = await (0, zn.readFile)(t, "utf-8");
      if (Xe.UUID.check(n))
        return n;
  ...
  async getOrCreateDownloadHelper() {
    ...
    if (t == null) {
      ...
      const i = rn.join(this.app.baseCachePath, r || this.app.name);
      n.debug != null && n.debug(`updater cache dir: ${i}`), t = new nd.DownloadedUpdateHelper(i), this.downloadedUpdateHelper = t;
    }
    return t;
  }
  async executeDownload(t) {
    ...
    this.listenerCount(Gn.DOWNLOAD_PROGRESS) > 0 && (n.onProgress = ($) => this.emit(Gn.DOWNLOAD_PROGRESS, $));
    ...
    function u() {
      ...
      return $.endsWith(`.${t.fileExtension}`) ? rn.basename($) : t.fileInfo.info.url;
    }
    const c = await this.getOrCreateDownloadHelper(), g = c.cacheDirForPendingUpdate;
    await (0, zn.mkdir)(g, { recursive: !0 });
    const f = u();
    let h = rn.join(g, f);
    const m = s == null ? null : rn.join(g, `package-${a}${rn.extname(s.path) || ".7z"}`), b = async ($) => (await c.setDownloadedFile(h, m, i, r, f, $), await t.done({
      ...i,
      downloadedFile: h
    ...
    }), await (0, zn.unlink)(h).catch(() => {
    })), I = await (0, nd.createTempUpdateFile)(`temp-${f}`, g, E);
    try {
      await t.task(I, n, m, A), await (0, Xe.retry)(() => (0, zn.rename)(I, h), 60, 500, 0, 0, ($) => $ instanceof Error && /^EBUSY:/.test($.message));
    } catch ($) {
  ...
  async differentialDownloadInstaller(t, r, n, i, a) {
    try {
      ...
      const u = async (f) => {
        ...
        newUrl: t.url,
        oldFile: rn.join(this.downloadedUpdateHelper.cacheDir, a),
        logger: this._logger,
        newFile: n,
      ...
      this.listenerCount(Gn.DOWNLOAD_PROGRESS) > 0 && (c.onProgress = (f) => this.emit(Gn.DOWNLOAD_PROGRESS, f));
...
class TR extends RR.AppUpdater {
  ...
  quitAndInstall(t = !1, r = !1) {
    this._logger.info("Install on explicit quitAndInstall"), this.install(t, t ? r : this.autoRunAppAfterInstall) ? setImmediate(() => {
      dn.autoUpdater.emit("before-quit-for-update"), this.app.quit();
  ...
  async spawnLog(t, r = [], n = void 0, i = "ignore") {
    return this._logger.info(`Executing: ${t} with args: ${r}`), new Promise((a, s) => {
      try {
        const u = { stdio: i, env: n, detached: !0 }, c = (0, od.spawn)(t, r, u);
        c.on("error", (g) => {
          s(g);
...
async function $R(e) {
  ...
  try {
    ...
    return await (0, Vn.read)(t, i, 0, i.length, r - n.length - i.length), await (0, Vn.close)(t), Bp(i);
  } catch (r) {
...
const ad = Be, sd = is, OR = Mr, DR = Br, xi = ve, NR = hr, FR = Ro, kR = De, ld = qr;
class LR extends NR.BaseUpdater {
  ...
  doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      task: async (i, a) => {
        ...
        if (s == null)
          throw (0, ad.newError)("APPIMAGE env is not defined", "ERR_UPDATER_OLD_FILE_NOT_FOUND");
  ...
  async downloadDifferential(t, r, n, i, a) {
    try {
      ...
      return this.listenerCount(ld.DOWNLOAD_PROGRESS) > 0 && (s.onProgress = (u) => this.emit(ld.DOWNLOAD_PROGRESS, u)), await new FR.FileWithEmbeddedBlockMapDifferentialDownloader(t.info, this.httpExecutor, s).download(), !1;
    } catch (s) {
  ...
  doInstall(t) {
    ...
    (0, DR.unlinkSync)(r);
    let n;
    const i = xi.basename(r), a = this.installerPath;
    if (a == null)
      return this.dispatchError(new Error("No valid update available, can't quit and install")), !1;
    xi.basename(a) === i || !/\d+\.\d+\.\d+/.test(i) ? n = r : n = xi.join(xi.dirname(r), xi.basename(a)), (0, sd.execFileSync)("mv", ["-f", a, n]), n !== r && this.emit("appimage-filename-updated", n);
    const s = {
      ...process.env,
      APPIMAGE_SILENT_INSTALL: "true"
    };
    return t.isForceRunAfter ? this.spawnLog(n, [], s) : (s.APPIMAGE_EXIT_AFTER_INSTALL = "true", (0, sd.execFileSync)(n, [], { env: s })), !0;
  }
}
...
class BR extends xR.BaseUpdater {
  ...
  doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (i, a) => {
        this.listenerCount(ud.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(ud.DOWNLOAD_PROGRESS, s)), await this.httpExecutor.download(n.url, i, a);
      }
    });
  }
  get installerPath() {
...
const dd = Be, Nl = Mr, GR = Br, hd = ve, VR = Zm, YR = Fr, XR = De, pd = is, md = mo;
class QR extends YR.AppUpdater {
  constructor(t, r) {
    super(t, r), this.nativeUpdater = dn.autoUpdater, this.squirrelDownloadedUpdate = !1, this.nativeUpdater.on("error", (n) => {
  ...
  async doDownloadUpdate(t) {
    ...
    let a = !1;
    try {
      this.debug("Checking for macOS Rosetta environment"), a = (0, pd.execFileSync)("sysctl", [i], { encoding: "utf8" }).includes(`${i}: 1`), n.info(`Checked for macOS Rosetta environment (isRosetta=${a})`);
    } catch (h) {
    ...
    try {
      ...
      const m = (0, pd.execFileSync)("uname", ["-a"], { encoding: "utf8" }).includes("ARM");
    ...
    if (c == null)
      throw (0, dd.newError)(`ZIP file not provided: ${(0, dd.safeStringifyJson)(r)}`, "ERR_UPDATER_ZIP_FILE_NOT_FOUND");
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (h, m) => {
        const b = hd.join(this.downloadedUpdateHelper.cacheDir, f), E = () => (0, Nl.pathExistsSync)(b) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let C = !0;
        ...
        if (!t.disableDifferentialDownload)
          try {
            const m = hd.join(this.downloadedUpdateHelper.cacheDir, f);
  ...
  async updateDownloaded(t, r) {
    ...
    return await new Promise((g, f) => {
      const h = (0, md.randomBytes)(64).toString("base64").replace(/\//g, "_").replace(/\+/g, "-"), m = Buffer.from(`autoupdater:${h}`, "ascii"), b = `/${(0, md.randomBytes)(64).toString("hex")}.zip`;
  ...
  return new Promise((n, i) => {
    ...
    r.info(`Verifying signature ${a}`), (0, Mp.execFile)('set "PSModulePath=" & chcp 65001 >NUL & powershell.exe', ["-NoProfile", "-NonInteractive", "-InputFormat", "None", "-Command", `"Get-AuthenticodeSignature -LiteralPath '${a}' | ConvertTo-Json -Compress"`], {
      ...
      try {
        ...
        if (f.Status === 0) {
          try {
            const E = yd.normalize(f.Path), C = yd.normalize(t);
          ...
          const m = (0, gd.parseDn)(f.SignerCertificate.Subject);
          let b = !1;
          for (const E of e) {
            const C = (0, gd.parseDn)(E);
...
const Oa = Be, bd = ve, tT = hr, rT = Ro, wd = qr, nT = De, iT = Mr, oT = Uu, _d = li;
class aT extends tT.BaseUpdater {
    ...
    return this.executeDownload({
      ...
      task: async (i, a, s, u) => {
        ...
        if (g && await this.differentialDownloadWebPackage(t, c, s, r))
          try {
            await this.httpExecutor.download(new _d.URL(c.path), s, {
  ...
  doInstall(t) {
    ...
    const a = () => {
      this.spawnLog(bd.join(process.resourcesPath, "elevate.exe"), [r].concat(n)).catch((s) => this.dispatchError(s));
    };
    return t.isAdminRightsRequired ? (this._logger.info("isAdminRightsRequired is set to true, run installer using elevate.exe"), a(), !0) : (this.spawnLog(r, n).catch((s) => {
      const u = s.code;
      this._logger.info(`Cannot run installer: error code: ${u}, error message: "${s.message}", will be executed again using elevate if EACCES, and will try to use electron.shell.openItem if ENOENT`), u === "UNKNOWN" || u === "EACCES" ? a() : u === "ENOENT" ? dn.shell.openPath(r).catch((c) => this.dispatchError(c)) : this.dispatchError(s);
    }), !0);
  }
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      const a = {
        newUrl: new _d.URL(r.path),
        oldFile: bd.join(this.downloadedUpdateHelper.cacheDir, Oa.CURRENT_APP_PACKAGE_FILE_NAME),
        logger: this._logger,
        newFile: n,
      ...
      this.listenerCount(wd.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(wd.DOWNLOAD_PROGRESS, s)), await new rT.FileWithEmbeddedBlockMapDifferentialDownloader(r, this.httpExecutor, a).download();
    } catch (a) {
...
function sT() {
  if (It.isPackaged) {
    const e = ln.join(process.resourcesPath, "assets", "icon.ico");
    return kl.existsSync(e) ? e : (console.warn("[Tray] Not found:", e), "");
  } else {
    const e = ln.join(process.cwd(), "public", "icon.ico");
    return kl.existsSync(e) ? e : (console.warn("[Tray] Not found (dev):", e), "");
  }
}
function qp(e) {
  const t = sT();
  ...
  Ui = new zm(r), Ui.setToolTip("LoL Skin Picker");
  const n = () => {
    const s = e();
    ...
    Ir = !0, Nd.autoUpdater.checkForUpdates().catch((s) => {
      bc.showErrorBox("Update error", (s == null ? void 0 : s.message) ?? String(s)), Ir = !1;
    });
  }, a = () => {
    const s = e(), c = !!s && s.isVisible() ? "Hide App" : "Show App", g = vd.buildFromTemplate([
      { label: c, click: n },
      { type: "separator" },
  ...
  Ui.on("click", n), Ui.on("double-click", n), a(), qp.refresh = a;
}
function lT() {
...
const jp = Qm(It.getPath("userData"), "settings.json");
async function uT() {
  try {
...
if (!It.isPackaged) {
  const e = ln.join(It.getPath("appData"), "lol-skin-picker-dev");
  It.setPath("userData", e), It.commandLine.appendSwitch(
    "disk-cache-dir",
    ln.join(e, "Cache")
  ), It.commandLine.appendSwitch("disable-gpu-shader-disk-cache");
}
...
async function dT() {
  const e = await uT(), t = Oi.getAllDisplays(), r = 900, n = 645, i = t.find((f) => f.id === e.displayId) ?? Oi.getDisplayNearestPoint(Oi.getCursorScreenPoint()) ?? Oi.getPrimaryDisplay(), a = await Ng(), { x: s, y: u } = fT(i, r, n);
  a.setBounds({ x: s, y: u, width: r, height: n }), vd.setApplicationMenu(null), qp(ei);
  let c = null;
  const g = () => {
    const f = ei();
    if (!f) return;
    const h = Oi.getDisplayMatching(f.getBounds());
...
function hT() {
  ru.on("status", (e, t) => {
    var r, n, i;
    (r = ei()) == null || r.webContents.send("lcu-status", e), e === "connected" && t ? ((n = ei()) == null || n.show(), nu.setCreds(t), xa.setCreds(t), xa.start()) : (nu.stop(), xa.stop(), (i = ei()) == null || i.hide());
  });
}
It.whenReady().then(async () => {
  await dT(), Ug({ lcu: ru, gameflow: nu, skins: xa, getWin: ei }), hT(), lT(), ru.start();
});
It.on("window-all-closed", () => process.platform !== "darwin" && It.quit());
export {
  xl as F,
  ig as a
};
